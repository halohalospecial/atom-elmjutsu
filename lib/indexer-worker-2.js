...
(function() {
  ...
  var _elm_community$dict_extra$Dict_Extra$find = F2(function(predicate, dict) {
    return A3(
      _elm_lang$core$Dict$foldl,
      F3(function(k, v, acc) {
        var _p0 = acc;
        if (_p0.ctor === 'Just') {
          ...
          return A2(predicate, k, v)
            ? _elm_lang$core$Maybe$Just({ ctor: '_Tuple2', _0: k, _1: v })
  ...
  var _elm_community$dict_extra$Dict_Extra$filterMap = F2(function(f, dict) {
    return A3(
      _elm_lang$core$Dict$foldl,
      F3(function(k, v, acc) {
        var _p1 = A2(f, k, v);
  ...
  var _elm_community$dict_extra$Dict_Extra$mapKeys = F2(function(
    keyMapper,
    dict
  ) {
    return A3(
      _elm_lang$core$Dict$foldl,
      F3(function(k, v, acc) {
        return A3(_elm_lang$core$Dict$insert, keyMapper(k), v, acc);
      }),
      _elm_lang$core$Dict$empty,
      dict
    );
  });
  var _elm_community$dict_extra$Dict_Extra$keepOnly = F2(function(set, dict) {
    return A3(
  ...
  var _elm_community$dict_extra$Dict_Extra$removeMany = F2(function(set, dict) {
    return A3(_elm_lang$core$Set$foldl, _elm_lang$core$Dict$remove, dict, set);
  });
  var _elm_community$dict_extra$Dict_Extra$removeWhen = F2(function(
    pred,
    dict
  ) {
    return A2(
  ...
  var _elm_community$dict_extra$Dict_Extra$fromListBy = F2(function(keyfn, xs) {
    return A3(
      _elm_lang$core$List$foldl,
      F2(function(x, acc) {
        return A3(_elm_lang$core$Dict$insert, keyfn(x), x, acc);
      }),
      _elm_lang$core$Dict$empty,
      xs
    );
  });
  var _elm_community$dict_extra$Dict_Extra$groupBy = F2(function(keyfn, list) {
    return A3(
      _elm_lang$core$List$foldr,
      F2(function(x, acc) {
        return A3(
  ...
  var _user$project$Helper$last = function(list) {
    return _elm_lang$core$List$head(_elm_lang$core$List$reverse(list));
  };
  var _user$project$Helper$dropLast = function(list) {
    return _elm_lang$core$List$reverse(
      A2(
        _elm_lang$core$Maybe$withDefault,
        { ctor: '[]' },
        _elm_lang$core$List$tail(_elm_lang$core$List$reverse(list))
      )
    );
  };
  var _user$project$Helper$isCapitalized = function(str) {
    var firstChar = A3(_elm_lang$core$String$slice, 0, 1, str);
    return _elm_lang$core$Native_Utils.eq(firstChar, '')
      ? false
  ...
  var _user$project$Helper$isInfix = _elm_lang$core$Regex$contains(
    _user$project$Helper$infixRegex
  );
  ...
  var _user$project$Indexer$getModuleAndSymbolName = function(_p0) {
    ...
    if (_p2.ctor === 'KindModule') {
      ...
      return {
        ctor: '_Tuple2',
        _0: !_elm_lang$core$Native_Utils.eq(moduleName, '')
          ? moduleName
          : symbolName,
        _1: (function() {
  ...
  var _user$project$Indexer$isExposed = F2(function(name, exposed) {
    var _p5 = exposed;
    switch (_p5.ctor) {
      case 'None':
        return false;
  ...
  var _user$project$Indexer$getModuleLocalName = F3(function(
    moduleName,
    alias,
    name
  ) {
  ...
  var _user$project$Indexer$getTipeCaseTypeAnnotation = F2(function(
    tipeCase,
    tipe
  ) {
    return A2(
      _elm_lang$core$String$join,
      ' -> ',
      A2(_elm_lang$core$Basics_ops['++'], tipeCase.args, {
        ctor: '::',
        _0:
          _elm_lang$core$Native_Utils.cmp(
            ...
            ? A2(
                ...
                A2(
                  _elm_lang$core$Basics_ops['++'],
                  ' ',
                  A2(_elm_lang$core$String$join, ' ', tipe.args)
                )
              )
            : tipe.tipe,
        _1: { ctor: '[]' },
  ...
  var _user$project$Indexer$isTupleString = function(tipeString) {
    return (
      A2(_elm_lang$core$String$startsWith, '(', tipeString) &&
      A2(_elm_lang$core$String$endsWith, ')', tipeString)
    );
  };
  ...
  var _user$project$Indexer$getTuplePartsRecur = F4(function(
    str,
    acc,
    parts,
    _p11
  ) {
    getTuplePartsRecur: while (true) {
      var _p12 = _p11;
      var _p18 = _p12._0;
      var _p17 = _p12._1;
      var _p13 = str;
      if (_p13 === '') {
        return A2(_elm_lang$core$Basics_ops['++'], parts, {
          ctor: '::',
        ...
        if (
          _elm_lang$core$Native_Utils.eq(_p18, 0) &&
          (_elm_lang$core$Native_Utils.eq(_p17, 0) &&
            _elm_lang$core$Native_Utils.eq(thisChar, ','))
        ) {
          var _v10 = thisRest,
            _v11 = '',
            _v12 = A2(_elm_lang$core$Basics_ops['++'], parts, {
              ctor: '::',
              _0: _elm_lang$core$String$trim(acc),
              _1: { ctor: '[]' },
            }),
          ...
          if (
            _elm_lang$core$Native_Utils.cmp(updatedOpenParentheses, 0) < 0 ||
            _elm_lang$core$Native_Utils.cmp(updatedOpenBraces, 0) < 0
          ) {
            return { ctor: '[]' };
          } else {
            var _v15 = thisRest,
              ...
              _v18 = {
                ctor: '_Tuple2',
                _0: updatedOpenParentheses,
                _1: updatedOpenBraces,
              };
            str = _v15;
            acc = _v16;
            parts = _v17;
  ...
  var _user$project$Indexer$getRecordTipePartsRecur = F5(function(
    str,
    _p21,
    lookingForTipe,
    parts,
    ...
    getRecordTipePartsRecur: while (true) {
      var _p22 = _p21;
      var _p32 = _p22._1;
      var _p31 = _p22._0;
      var _p23 = _p20;
      ...
      if (_p24 === '') {
        ...
        if (
          _elm_lang$core$Native_Utils.eq(_p30, 0) &&
          (_elm_lang$core$Native_Utils.eq(_p29, 0) &&
            _elm_lang$core$Native_Utils.eq(thisChar, ','))
        ) {
          var _v23 = thisRest,
            _v24 = { ctor: '_Tuple2', _0: '', _1: '' },
            _v25 = false,
            _v26 = A2(_elm_lang$core$Basics_ops['++'], parts, {
              ctor: '::',
              _0: {
                ctor: '_Tuple2',
                _0: _elm_lang$core$String$trim(_p31),
  ...
  var _user$project$Indexer$getTipePartsRecur = F4(function(
    str,
    acc,
    parts,
    _p34
  ) {
    getTipePartsRecur: while (true) {
      var _p35 = _p34;
      var _p41 = _p35._0;
      var _p40 = _p35._1;
      if (_elm_lang$core$Native_Utils.eq(str, '')) {
        ...
        if (
          _elm_lang$core$Native_Utils.eq(_p41, 0) &&
          (_elm_lang$core$Native_Utils.eq(_p40, 0) &&
            (_elm_lang$core$Native_Utils.eq(thisChar, '-') &&
              _elm_lang$core$Native_Utils.eq(nextChar, '>')))
        ) {
          var _v41 = nextRest,
            _v42 = '',
            _v43 = A2(_elm_lang$core$Basics_ops['++'], parts, {
              ctor: '::',
              _0: _elm_lang$core$String$trim(acc),
              _1: { ctor: '[]' },
            }),
  ...
  var _user$project$Indexer$getArgsPartsRecur = F4(function(
    str,
    acc,
    parts,
    _p42
  ) {
    getArgsPartsRecur: while (true) {
      var _p43 = _p42;
      var _p49 = _p43._0;
      var _p48 = _p43._1;
      var _p44 = str;
      if (_p44 === '') {
        ...
        if (
          _elm_lang$core$Native_Utils.eq(_p49, 0) &&
          (_elm_lang$core$Native_Utils.eq(_p48, 0) &&
            _elm_lang$core$Native_Utils.eq(thisChar, ' '))
        ) {
          var _v52 = thisRest,
            _v53 = '',
            _v54 = A2(_elm_lang$core$Basics_ops['++'], parts, {
              ctor: '::',
              _0: _elm_lang$core$String$trim(acc),
              _1: { ctor: '[]' },
            }),
  ...
  var _user$project$Indexer$isFunctionTypeString = function(tipeString) {
    var tipe = _user$project$Indexer$isTupleString(tipeString)
      ? A2(
          _elm_lang$core$Maybe$withDefault,
          '',
      ...
      : tipeString;
    return (
      !_elm_lang$core$Native_Utils.eq(tipe, '') &&
      (!_user$project$Indexer$isRecordString(tipe) &&
        (!_user$project$Indexer$isTupleString(tipe) &&
          (A2(_elm_lang$core$String$contains, '->', tipe) &&
            _elm_lang$core$Native_Utils.eq(
  ...
  var _user$project$Indexer$getTipeParts = function(tipeString) {
    ...
    if (_p52 === '') {
      ...
      var _p53 = _p52;
      var tipe = _user$project$Indexer$isFunctionTypeString(_p53)
        ? _user$project$Indexer$isTupleString(_p53)
          ? A3(_elm_lang$core$String$slice, 1, -1, _p53)
          : _p53
        : _p53;
      return A4(
  ...
  var _user$project$Indexer$getReturnTipe = function(tipeString) {
    return A2(
      _elm_lang$core$Maybe$withDefault,
      '',
      _user$project$Helper$last(_user$project$Indexer$getTipeParts(tipeString))
    );
  };
  ...
  var _user$project$Indexer$packageDocsPrefix =
  ...
  var _user$project$Indexer$formatSourcePath = F2(function(_p60, valueName) {
    var _p61 = _p60;
    var _p62 = _p61.sourcePath;
    var anchor = _elm_lang$core$Native_Utils.eq(valueName, '')
      ? ''
      : A2(_elm_lang$core$Basics_ops['++'], '#', valueName);
    return _user$project$Indexer$isPackageSourcePath(_p62)
      ? A2(
          _elm_lang$core$Basics_ops['++'],
          _p62,
          A2(
  ...
  var _user$project$Indexer$nameToHints = F5(function(
    moduleDocs,
    _p64,
    activeFilePath,
    kind,
    ...
    var moduleLocalName = A3(
      _user$project$Indexer$getModuleLocalName,
      moduleDocs.name,
      _p65.alias,
      _p68
    );
    ...
    var isInActiveModule = _elm_lang$core$Native_Utils.eq(
      activeFilePath,
      hint.sourcePath
    );
  ...
  var _user$project$Indexer$getFileContentsOfProject = F2(function(
    projectDirectory,
  ...
  var _user$project$Indexer$getProjectModuleDocs = F2(function(
    projectDirectory,
    projectFileContentsDict
  ) {
    return A2(
      ...
      _elm_lang$core$Dict$values(
        A2(
          _user$project$Indexer$getFileContentsOfProject,
          projectDirectory,
          projectFileContentsDict
        )
      )
  ...
  var _user$project$Indexer$argSeparatorRegex = _elm_lang$core$Regex$regex(
    '\\s+|\\(|\\)|\\.|,|-|>'
  );
      ...
      _elm_lang$core$String$concat(
        _elm_lang$core$List$reverse(
          A3(
            ...
            _user$project$Indexer$argSeparatorRegex,
            tipeString
          )
        )
      )
  ...
  var _user$project$Indexer$getFunctionArgNameRecur = F2(function(
    argString,
    argNameCounters
  ) {
    var updatePartNameAndArgNameCounters = F2(function(
      partName2,
      argNameCounters2
    ) {
      ...
      if (_p71.ctor === 'Just') {
        ...
        return {
          ...
          _0: A2(
            _elm_lang$core$Basics_ops['++'],
            partName2,
            _elm_lang$core$Basics$toString(_p73 + 1)
          ),
          _1: A3(
            _elm_lang$core$Dict$update,
            partName2,
            function(_p72) {
              return _elm_lang$core$Maybe$Just(_p73 + 1);
            },
            argNameCounters2
          ),
        };
    ...
    if (_user$project$Indexer$isRecordString(argString)) {
      ...
      if (_user$project$Indexer$isTupleString(argString)) {
        var _p74 = A3(
          _elm_lang$core$List$foldl,
          F2(function(part, _p75) {
            var _p76 = _p75;
            var _p77 = A2(
              _user$project$Indexer$getFunctionArgNameRecur,
              part,
              _p76._1
            );
            var partName = _p77._0;
            var updateArgNameCounters2 = _p77._1;
            return {
              ctor: '_Tuple2',
              _0: A2(_elm_lang$core$Basics_ops['++'], _p76._0, {
                ctor: '::',
                _0: partName,
                _1: { ctor: '[]' },
              }),
        ...
        var partNames = _p74._0;
        var updateArgNameCounters = _p74._1;
        return {
          ctor: '_Tuple2',
  ...
  var _user$project$Indexer$getTipeCaseAlignedArgTipes = F3(function(
    tipeArgs,
    tipeAnnotationArgs,
    tipeCaseArgs
  ) {
    ...
    return A2(
      _elm_lang$core$List$map,
      function(argTipe) {
        var _p78 = A2(_elm_lang$core$Dict$get, argTipe, tipeArgsDict);
        if (_p78.ctor === 'Just') {
          return _p78._0;
        } else {
          return argTipe;
  ...
  var _user$project$Indexer$typeConstructorToNameAndArgs = function(
    tipeString
  ) {
  ...
  var _user$project$Indexer$getDefaultArgNames = function(args) {
    var _p79 = A3(
      ...
      F2(function(part, _p80) {
        ...
        var partName = _p82._0;
        var updatedArgNameCounters = _p82._1;
        return {
          ctor: '_Tuple2',
          _0: A2(_elm_lang$core$Basics_ops['++'], _p81._0, {
            ctor: '::',
            _0: partName,
            _1: { ctor: '[]' },
          }),
    ...
    var argNames = _p79._0;
    return argNames;
  };
  var _user$project$Indexer$getSuggestionsForImport = F5(function(
    partial,
    isFiltered,
    maybeActiveFile,
    projectFileContentsDict,
    ...
    var _p83 = maybeActiveFile;
    if (_p83.ctor === 'Just') {
      var suggestions = A2(
        _elm_lang$core$List$map,
        function(_p84) {
          var _p85 = _p84;
          var _p87 = _p85.sourcePath;
          var _p86 = _p85.name;
          return {
            name: _p86,
            comment: _p85.comment,
            sourcePath: _user$project$Indexer$isPackageSourcePath(_p87)
              ? A2(
                  _elm_lang$core$Basics_ops['++'],
                  _p87,
                  _user$project$Indexer$dotToHyphen(_p86)
                )
              : '',
          };
        },
        A2(
          _elm_lang$core$Basics_ops['++'],
          A2(
            _user$project$Indexer$getProjectModuleDocs,
            _p83._0.projectDirectory,
            projectFileContentsDict
          ),
          projectPackageDocs
        )
      ...
      return isFiltered
        ? A2(
            ...
            A2(
              ...
              function(_p88) {
                var _p89 = _p88;
                return A2(_elm_lang$core$String$startsWith, partial, _p89.name);
              },
              suggestions
            )
          )
  ...
  var _user$project$Indexer$lastParameterTipe = function(tipeString) {
    ...
    var _p90 = _elm_lang$core$List$tail(parts);
    if (_p90.ctor === 'Just') {
      return A2(
        _elm_lang$core$Maybe$withDefault,
        '',
        _user$project$Helper$last(_user$project$Helper$dropLast(parts))
      );
    } else {
      return '';
    }
  ...
  var _user$project$Indexer$compressTipeRegex = _elm_lang$core$Regex$regex(
    '\\s*(->|:|,)\\s*|(\\{|\\()\\s*|\\s*(\\}|\\))'
  );
  var _user$project$Indexer$compressTipeString = A3(
    ...
    function(_p91) {
      var _p92 = _p91;
      return _elm_lang$core$String$trim(_p92.match);
    }
  );
  var _user$project$Indexer$filterHintsFunction = F5(function(
    isRegex,
    isTypeSignature,
    testString,
    name,
    ...
    if (
      (isRegex && A2(_elm_lang$core$String$startsWith, '/', testString)) ||
      (isTypeSignature && A2(_elm_lang$core$String$startsWith, ':', testString))
    ) {
      var formattedFieldValue = isTypeSignature
        ? _user$project$Indexer$compressTipeString(fieldValue)
        : fieldValue;
      var strippedTestString = A2(
          ...
          var _p94 = (function() {
            ...
            if (
              ...
              return {
                ctor: '_Tuple2',
                _0: _p95._1._0,
                _1: _elm_lang$core$Maybe$Just(_p95._0),
              };
            } else {
              return {
                ctor: '_Tuple2',
                _0: strippedTestString,
                _1: _elm_lang$core$Maybe$Nothing,
              };
            }
          })();
          var testString1 = _p94._0;
          var maybeTestString2 = _p94._1;
          return {
            ctor: '_Tuple2',
      ...
      var fieldValueExpression = _p93._0;
      var nameExpression = _p93._1;
      return _elm_lang$core$Native_Utils.eq(fieldValueExpression, '')
        ? startsWithName
        : startsWithName ||
            (A2(
  ...
  var _user$project$Indexer$filterTypeIncompatibleHints = F4(function(
    partial,
    isFiltered,
    isRegex,
    hints
  ) {
    return _elm_lang$core$Native_Utils.eq(partial, '')
      ? { ctor: '[]' }
      : isFiltered || isRegex
        ? A2(
            _elm_lang$core$List$filter,
            function(_p97) {
              ...
              var _p99 = _p98.name;
              return A5(
                _user$project$Indexer$filterHintsFunction,
                isRegex,
                false,
                partial,
                _p99,
  ...
  var _user$project$Indexer$filterHintsByPartial = F6(function(
    partial,
    maybeInferredTipe,
    isFiltered,
    isRegex,
    ...
    if (isFiltered || (isRegex || isTypeSignature)) {
      var filter = _elm_lang$core$List$filter(function(hint) {
  ...
  var _user$project$Indexer$isAppendableTipe = function(tipeString) {
    return A2(
      _elm_lang$core$List$member,
      _elm_lang$core$List$head(_user$project$Indexer$getArgsParts(tipeString)),
      {
        ctor: '::',
  ...
  var _user$project$Indexer$isNumberTipe = function(tipeString) {
    return A2(_elm_lang$core$List$member, tipeString, {
      ctor: '::',
      _0: 'Int',
      _1: {
        ctor: '::',
  ...
  var _user$project$Indexer$areTipesCompatibleRecur = F2(function(
    tipe1,
    tipe2
  ) {
    areTipesCompatibleRecur: while (true) {
      if (_elm_lang$core$Native_Utils.eq(tipe1, tipe2)) {
        return true;
      } else {
        if (
          _elm_lang$core$Native_Utils.eq(tipe1, '') ||
          _elm_lang$core$Native_Utils.eq(tipe2, '')
        ) {
          return false;
        } else {
          ...
          if (
            (_user$project$Indexer$isFunctionTypeString(tipe1) &&
              !_user$project$Indexer$isFunctionTypeString(tipe2)) ||
            (_user$project$Indexer$isFunctionTypeString(tipe2) &&
              !_user$project$Indexer$isFunctionTypeString(tipe1))
          ) {
            return false;
            ...
            if (
              _elm_lang$core$Native_Utils.eq(numParts1, 1) &&
              _elm_lang$core$Native_Utils.eq(numParts2, 1)
            ) {
              return (
                (_user$project$Indexer$isTipeVariable(tipe1) &&
                  _user$project$Indexer$isTipeVariable(tipe2)) ||
                ((_user$project$Helper$isCapitalized(tipe1) &&
                  (_user$project$Indexer$isTipeVariable(tipe2) &&
                    !_user$project$Indexer$isSuperTipe(tipe2))) ||
                  ((_user$project$Indexer$isNumberTipe(tipe1) &&
                    _elm_lang$core$Native_Utils.eq(tipe2, 'number')) ||
                    ((_user$project$Indexer$isAppendableTipe(tipe1) &&
                      _elm_lang$core$Native_Utils.eq(tipe2, 'appendable')) ||
                      (_user$project$Indexer$isComparableTipe(tipe1) &&
                        _elm_lang$core$Native_Utils.eq(tipe2, 'comparable')))))
              );
            } else {
              if (
                _elm_lang$core$Native_Utils.eq(numParts2, 1) &&
                ...
                if (
                  ...
                  if (
                    _elm_lang$core$Native_Utils.eq(_p101._0._0, _p101._1._0)
                  ) {
                    var _v86 = A2(
                        _elm_lang$core$String$join,
                        '',
  ...
  var _user$project$Indexer$partitionByTipe = F3(function(
    tipeString,
    preceedingToken,
    hint
  ) {
    ...
    return (
      _elm_lang$core$Native_Utils.cmp(
        ...
        _elm_lang$core$List$length(
          _user$project$Indexer$getTipeParts(hint.tipe)
        )
      ) < 1 &&
      ((A2(
        _user$project$Indexer$areTipesCompatibleRecur,
        returnTipe1,
        returnTipe2
      ) ||
        A2(
        ...
        (function() {
          var _p102 = preceedingToken;
          if (_p102.ctor === 'Just') {
            var _p103 = _p102._0;
            if (_p103 === '|>') {
              var parameterTipe2 = _user$project$Indexer$lastParameterTipe(
                hint.tipe
              );
              var parameterTipe1 = _user$project$Indexer$lastParameterTipe(
                tipeString
              );
              return (
                A2(
  ...
  var _user$project$Indexer$getTipeDistance = F2(function(tipe1, tipe2) {
    if (_elm_lang$core$Native_Utils.eq(tipe1, tipe2)) {
      return 0;
    } else {
      var parts2 = _user$project$Indexer$getArgsParts(tipe2);
      ...
      var genericTipePenalty =
        ...
        (_user$project$Indexer$isTipeVariable(tipe2) &&
          ...
          : 0;
      return (
        (_elm_lang$core$Native_Utils.eq(numParts1, numParts2)
          ? _elm_lang$core$List$sum(
              A3(
                _elm_lang$core$List$map2,
                F2(function(part1, part2) {
          ...
          : A2(_elm_lang$core$Basics$max, numParts1, numParts2)) +
        genericTipePenalty
      );
    }
  });
  var _user$project$Indexer$sortHintsByScore = F3(function(
    tipeString,
    preceedingToken,
    hints
  ) {
                  ...
                  return {
                    ...
                    distance:
                      A2(
                        ...
                        _user$project$Indexer$getReturnTipe(hint.tipe)
                      ) +
                      (function() {
                        var _p104 = preceedingToken;
                        if (_p104.ctor === 'Just') {
                          var _p105 = _p104._0;
                          if (_p105 === '|>') {
                            return A2(
                              _user$project$Indexer$getTipeDistance,
                              _user$project$Indexer$lastParameterTipe(
                                tipeString
                              ),
  ...
  var _user$project$Indexer$getHintsForToken = F2(function(maybeToken, tokens) {
    var _p106 = maybeToken;
    if (_p106.ctor === 'Just') {
      return A2(
        _elm_lang$core$Maybe$withDefault,
        { ctor: '[]' },
        A2(_elm_lang$core$Dict$get, _p106._0, tokens)
      );
    } else {
      return { ctor: '[]' };
    }
  });
  var _user$project$Indexer$getImportersForToken = F6(function(
    token,
    ...
    if (_p107.ctor === 'Just') {
      ...
      if (isImportAlias) {
        ...
        var fileContentsDict = A2(
          _user$project$Indexer$getFileContentsOfProject,
          _p107._0.projectDirectory,
          projectFileContentsDict
        );
        var hints = A2(
        ...
        return A2(
          ...
          function(_p108) {
            var _p109 = _p108;
            var _p115 = _p109.moduleDocs;
            var _p114 = _p109.imports;
            var getSourcePathAndLocalNames = function(hint) {
              var isHintAModule = function(hint) {
                return (
                  _elm_lang$core$Native_Utils.eq(hint.moduleName, '') &&
                  _user$project$Helper$isCapitalized(hint.name)
                );
              };
              var isHintThisModule =
                isHintAModule(hint) &&
                _elm_lang$core$Native_Utils.eq(hint.name, _p115.name);
              var isHintAnImport =
                isHintAModule(hint) &&
                !_elm_lang$core$Native_Utils.eq(
                  A2(_elm_lang$core$Dict$get, token, _p114),
                  _elm_lang$core$Maybe$Nothing
                );
              if (isHintThisModule) {
                return _elm_lang$core$Maybe$Just({
                ...
                if (isHintAnImport) {
                  ...
                  if (_p110.ctor === 'Just') {
                    ...
                    var isHintInThisModule = _elm_lang$core$Native_Utils.eq(
                      hint.moduleName,
                      _p115.name
                    );
                    return isHintInThisModule
                      ? _elm_lang$core$Maybe$Just({
                          ctor: '_Tuple4',
                          _0: _p115.sourcePath,
                          _1: false,
  ...
  var _user$project$Indexer$constructCaseOf = F2(function(
    token,
    activeFileTokens
  ) {
    ...
    if (_p116.ctor === 'Just') {
      var _p124 = _p116._0;
      var _p117 = (function() {
        var _p118 = _user$project$Indexer$typeConstructorToNameAndArgs(
          _p124.tipe
        );
        var name = _p118._0;
        var args = _p118._1;
        var _p119 = _elm_lang$core$List$head(args);
        if (_p119.ctor === 'Just') {
          if (_p119._0 === '->') {
            return {
              ctor: '_Tuple2',
              _0: _user$project$Indexer$getReturnTipe(_p124.tipe),
              _1: { ctor: '[]' },
            };
          } else {
      ...
      var tokenTipeName = _p117._0;
      var tokenTipeArgs = _p117._1;
      var _p120 = (function() {
        var _p121 = tokenTipeName;
        if (_p121 === 'Bool') {
          return {
            ctor: '_Tuple2',
            _0: {
          ...
          if (
            A2(_elm_lang$core$List$member, tokenTipeName, {
              ctor: '::',
              _0: 'Int',
              _1: {
                ctor: '::',
            ...
            if (
              ...
              if (_p122.ctor === 'Just') {
                var _p123 = _p122._0;
                return { ctor: '_Tuple2', _0: _p123.cases, _1: _p123.args };
              } else {
                return {
                  ctor: '_Tuple2',
                  _0: { ctor: '[]' },
      ...
      var tipeCases = _p120._0;
      var tipeArgs = _p120._1;
        ...
        ? _elm_lang$core$Maybe$Just(
            A2(
              ...
              A2(
                ...
                function(tipeCase) {
                  var alignedArgs = A3(
                    _user$project$Indexer$getTipeCaseAlignedArgTipes,
                    tipeArgs,
                    tokenTipeArgs,
                    tipeCase.args
                  );
  ...
  var _user$project$Indexer$getProjectPackageDocs = F3(function(
    maybeActiveFile,
    projectDependencies,
    packageDocs
  ) {
    var _p125 = maybeActiveFile;
    if (_p125.ctor === 'Just') {
      var _p126 = A2(
        _elm_lang$core$Dict$get,
        _p125._0.projectDirectory,
        projectDependencies
      );
      if (_p126.ctor === 'Just') {
        var packageUris = A2(
  ...
  var _user$project$Indexer$truncateModuleComment = function(moduleDocs) {
    ...
    return _elm_lang$core$Native_Utils.update(moduleDocs, {
      comment: truncatedComment,
    });
  };
  var _user$project$Indexer$updateFileContents = F4(function(
    filePath,
    projectDirectory,
    fileContents,
    projectFileContentsDict
  ...
  var _user$project$Indexer$constructFromTypeAnnotationSub = _elm_lang$core$Native_Platform.incomingPort(
    'constructFromTypeAnnotationSub',
    _elm_lang$core$Json_Decode$string
  );
  var _user$project$Indexer$constructCaseOfSub = _elm_lang$core$Native_Platform.incomingPort(
    'constructCaseOfSub',
    _elm_lang$core$Json_Decode$string
  );
  var _user$project$Indexer$constructDefaultValueForTypeSub = _elm_lang$core$Native_Platform.incomingPort(
    'constructDefaultValueForTypeSub',
    _elm_lang$core$Json_Decode$string
  );
  var _user$project$Indexer$constructDefaultArgumentsSub = _elm_lang$core$Native_Platform.incomingPort(
  ...
  var _user$project$Indexer$getAliasesOfTypeSub = _elm_lang$core$Native_Platform.incomingPort(
    'getAliasesOfTypeSub',
    _elm_lang$core$Json_Decode$string
  );
  ...
  var _user$project$Indexer$dependenciesNotFoundCmd = _elm_lang$core$Native_Platform.outgoingPort(
    ...
    function(v) {
      return [
        _elm_lang$core$Native_List.toArray(v._0).map(function(v) {
          return v;
        }),
        _elm_lang$core$Native_List.toArray(v._1).map(function(v) {
          return [v._0, v._1];
        }),
      ];
    }
    ...
    function(v) {
      return [
        v._0.ctor === 'Nothing'
          ? null
          : {
              filePath: v._0._0.filePath,
              projectDirectory: v._0._0.projectDirectory,
            },
        {
    ...
    function(v) {
      return [
        ...
        v._1.ctor === 'Nothing'
          ? null
          : {
              filePath: v._1._0.filePath,
              projectDirectory: v._1._0.projectDirectory,
            },
        _elm_lang$core$Native_List.toArray(v._2).map(function(v) {
          return {
            fullName: v.fullName,
  ...
  var _user$project$Indexer$activeFileChangedCmd = _elm_lang$core$Native_Platform.outgoingPort(
    ...
    function(v) {
      return v.ctor === 'Nothing'
        ? null
        : { filePath: v._0.filePath, projectDirectory: v._0.projectDirectory };
    }
  );
    ...
    function(v) {
      return _elm_lang$core$Native_List.toArray(v).map(function(v) {
        return {
          ...
          comment: v.comment,
          tipe: v.tipe,
          args: _elm_lang$core$Native_List.toArray(v.args).map(function(v) {
            return v;
          }),
          caseTipe: v.caseTipe.ctor === 'Nothing' ? null : v.caseTipe._0,
          cases: _elm_lang$core$Native_List.toArray(v.cases).map(function(v) {
            return {
              name: v.name,
              args: _elm_lang$core$Native_List.toArray(v.args).map(function(v) {
                return v;
          ...
          associativity:
            v.associativity.ctor === 'Nothing' ? null : v.associativity._0,
          precedence: v.precedence.ctor === 'Nothing' ? null : v.precedence._0,
          kind: v.kind,
          isImported: v.isImported,
          aliasesOfTipe: _elm_lang$core$Native_List
            .toArray(v.aliasesOfTipe)
            .map(function(v) {
              return v;
            }),
        };
  ...
  var _user$project$Indexer$doUpdateProjectDependencies = F3(function(
    projectDirectory,
    dependencies,
    model
  ) {
    ...
    return {
      ...
      _1: _elm_lang$core$Platform_Cmd$batch({
        ctor: '::',
        _0: _user$project$Indexer$readingPackageDocsCmd({ ctor: '_Tuple0' }),
        _1: {
          ctor: '::',
        ...
        _elm_lang$core$Native_List.toArray(v._1).map(function(v) {
          return {
            ...
            cases: _elm_lang$core$Native_List.toArray(v.cases).map(function(v) {
              return {
                name: v.name,
                args: _elm_lang$core$Native_List
                  .toArray(v.args)
                  .map(function(v) {
                    return v;
                  }),
            ...
            associativity:
              v.associativity.ctor === 'Nothing' ? null : v.associativity._0,
            precedence:
              v.precedence.ctor === 'Nothing' ? null : v.precedence._0,
            kind: v.kind,
            isImported: v.isImported,
            aliasesOfTipe: _elm_lang$core$Native_List
              .toArray(v.aliasesOfTipe)
  ...
  var _user$project$Indexer$doGetSuggestionsForImport = F3(function(
    partial,
    isFiltered,
    model
  ) {
    return {
      ...
      _1: _user$project$Indexer$suggestionsForImportReceivedCmd({
        ...
        _1: A5(
          ...
          A3(
            _user$project$Indexer$getProjectPackageDocs,
            model.activeFile,
            model.projectDependencies,
            model.packageDocs
          )
  ...
  var _user$project$Indexer$importersForTokenReceivedCmd = _elm_lang$core$Native_Platform.outgoingPort(
    ...
    function(v) {
      return [
        ...
        v._2,
        v._3,
        _elm_lang$core$Native_List.toArray(v._4).map(function(v) {
          return [
            v._0,
            v._1,
            v._2,
            _elm_lang$core$Native_List.toArray(v._3).map(function(v) {
              return v;
            }),
          ];
        }),
  ...
  var _user$project$Indexer$showAddImportViewCmd = _elm_lang$core$Native_Platform.outgoingPort(
    ...
    function(v) {
      return [
        ...
        _elm_lang$core$Native_List.toArray(v._2).map(function(v) {
          return [v._0, v._1.ctor === 'Nothing' ? null : v._1._0];
        }),
      ];
    }
  );
  ...
  var _user$project$Indexer$doConstructCaseOf = F2(function(token, model) {
    return {
      ctor: '_Tuple2',
      _0: model,
  ...
  var _user$project$Indexer$ActiveFile = F2(function(a, b) {
    return { filePath: a, projectDirectory: b };
  });
  var _user$project$Indexer$FileContents = F2(function(a, b) {
    return { moduleDocs: a, imports: b };
  });
  var _user$project$Indexer$Inference = F2(function(a, b) {
    return { name: a, tipe: b };
  });
  var _user$project$Indexer$HintsCache = F2(function(a, b) {
    return { external: a, local: b };
  });
  var _user$project$Indexer$ExternalHints = F2(function(a, b) {
    return { importedHints: a, unimportedHints: b };
  });
  var _user$project$Indexer$LocalHints = F2(function(a, b) {
    return { topLevelHints: a, variableHints: b };
  });
  var _user$project$Indexer$ModuleDocs = F4(function(a, b, c, d) {
    return { sourcePath: a, name: b, values: c, comment: d };
  });
  var _user$project$Indexer$Values = F3(function(a, b, c) {
    return { aliases: a, tipes: b, values: c };
  });
  var _user$project$Indexer$Tipe = F5(function(a, b, c, d, e) {
    return { name: a, comment: b, tipe: c, args: d, cases: e };
  });
  var _user$project$Indexer$TipeCase = F2(function(a, b) {
    return { name: a, args: b };
  });
  var _user$project$Indexer$Value = F6(function(a, b, c, d, e, f) {
    return {
      name: a,
      comment: b,
      tipe: c,
  ...
  var _user$project$Indexer$EncodedModuleDocs = F4(function(a, b, c, d) {
    return { sourcePath: a, name: b, values: c, comment: d };
  });
  var _user$project$Indexer$EncodedValues = F3(function(a, b, c) {
    return { aliases: a, tipes: b, values: c };
  });
  var _user$project$Indexer$EncodedValue = F6(function(a, b, c, d, e, f) {
    return {
      name: a,
      comment: b,
      tipe: c,
  ...
  var _user$project$Indexer$Symbol = F4(function(a, b, c, d) {
    return { fullName: a, sourcePath: b, caseTipe: c, kind: d };
  });
  var _user$project$Indexer$EncodedSymbol = F4(function(a, b, c, d) {
    return { fullName: a, sourcePath: b, caseTipe: c, kind: d };
  });
  ...
  var _user$project$Indexer$ImportSuggestion = F3(function(a, b, c) {
    return { name: a, comment: b, sourcePath: c };
  });
  var _user$project$Indexer$RawImport = F3(function(a, b, c) {
    return { name: a, alias: b, exposed: c };
  });
  var _user$project$Indexer$Import = F2(function(a, b) {
    return { alias: a, exposed: b };
  });
  var _user$project$Indexer_ops = _user$project$Indexer_ops || {};
  _user$project$Indexer_ops['=>'] = F2(function(name, exposed) {
    return {
      ctor: '_Tuple2',
      _0: name,
      _1: A2(
  ...
  var _user$project$Indexer$ClearLocalHintsCache = {
    ctor: 'ClearLocalHintsCache',
  };
  ...
  var _user$project$Indexer$UpdateFileContents = F3(function(a, b, c) {
  ...
  var _user$project$Indexer$MaybeDocsDownloaded = F2(function(a, b) {
  ...
  var _user$project$Indexer$decodeAssociativity = function(maybeString) {
    var _p131 = maybeString;
    _v105_3: do {
      if (_p131.ctor === 'Just') {
        switch (_p131._0) {
          case 'left':
            return _elm_lang$core$Maybe$Just(
              _user$project$Indexer$LeftAssociative
            );
          case 'right':
            return _elm_lang$core$Maybe$Just(
              _user$project$Indexer$RightAssociative
            );
          case 'non':
            return _elm_lang$core$Maybe$Just(
              _user$project$Indexer$NonAssociative
            );
          default:
            break _v105_3;
        }
  ...
  var _user$project$Indexer$downloadPackageDocs = function(dependency) {
    ...
    return A2(
      ...
      _elm_lang$http$Http$toTask(_elm_lang$http$Http$getString(url))
    );
  };
  var _user$project$Indexer$downloadPackageDocsList = function(dependencies) {
    return _user$project$Indexer$optionalTaskSequence(
      A2(
        _elm_lang$core$List$map,
        _user$project$Indexer$downloadPackageDocs,
        dependencies
      )
    );
  };
  var _user$project$Indexer$doDownloadMissingPackageDocs = F2(function(
    dependencies,
    model
  ) {
    return {
  ...
  var _user$project$Indexer$toModuleDocs = F2(function(packageUri, jsonString) {
    return A2(
      _elm_lang$core$Maybe$withDefault,
      { ctor: '[]' },
      _elm_lang$core$Result$toMaybe(
  ...
  var _user$project$Indexer$moduleToHints = F2(function(moduleDocs, _p132) {
    var _p133 = _p132;
    var _p134 = moduleDocs;
    var name = _p134.name;
    var comment = _p134.comment;
    var sourcePath = _p134.sourcePath;
    var hint = {
      name: name,
      moduleName: '',
    ...
    if (_p135.ctor === 'Just') {
      return {
        ...
        _1: {
          ctor: '::',
          _0: { ctor: '_Tuple2', _0: _p135._0, _1: hint },
          _1: { ctor: '[]' },
        },
      };
    } else {
  ...
  var _user$project$Indexer$unionTagsToHints = F4(function(
    moduleDocs,
    _p136,
    activeFilePath,
    tipe
    ...
    var _p137 = _p136;
    var _p138 = _p137.exposed;
    var addHints = F2(function(tipeCase, hints) {
      var tag = tipeCase.name;
      var hint = (function() {
        var hintTipe = A2(
          _user$project$Indexer$getTipeCaseTypeAnnotation,
          tipeCase,
          tipe
        );
        return {
          ...
          moduleName: moduleDocs.name,
          sourcePath: A2(
            _user$project$Indexer$formatSourcePath,
            moduleDocs,
            tipe.name
          ),
      ...
      return A2(
        ...
        isInActiveModule
          ...
          : A2(_user$project$Indexer$isExposed, tag, _p138) ||
            A2(_user$project$Indexer$isExposed, tipe.name, _p138)
            ? {
                ctor: '::',
                _0: { ctor: '_Tuple2', _0: moduleLocalName, _1: hint },
                _1: {
    ...
    return A3(_elm_lang$core$List$foldl, addHints, { ctor: '[]' }, tipe.cases);
  });
  var _user$project$Indexer$KindType = { ctor: 'KindType' };
  var _user$project$Indexer$KindTypeAlias = { ctor: 'KindTypeAlias' };
  var _user$project$Indexer$normalizeTipeRecur = F3(function(
    tokens,
    visitedTipeAliases,
    tipeString
  ) {
    normalizeTipeRecur: while (true) {
      if (_user$project$Indexer$isPrimitiveTipe(tipeString)) {
        ...
        if (_user$project$Indexer$isRecordString(tipeString)) {
          var fieldAndValues = A2(
            ...
            _elm_lang$core$Dict$values(
              A2(
                ...
                F2(function(fieldName, fieldTipeString) {
                  return A2(
                    _elm_lang$core$Basics_ops['++'],
                    fieldName,
                    A2(
                      ...
                      ' : ',
                      A3(
                        _user$project$Indexer$normalizeTipeRecur,
                        tokens,
                        visitedTipeAliases,
                        fieldTipeString
                      )
          ...
          if (_user$project$Indexer$isTupleString(tipeString)) {
            ...
            var _p139 = _elm_lang$core$List$head(
              A2(
                _user$project$Indexer$getHintsForToken,
            ...
            if (_p139.ctor === 'Just') {
              var _p140 = _p139._0;
              if (
                A2(_elm_lang$core$Set$member, _p140.tipe, visitedTipeAliases)
              ) {
                return tipeString;
              } else {
                if (
                  _elm_lang$core$Native_Utils.eq(
                    _p140.kind,
                    _user$project$Indexer$KindTypeAlias
                  )
                ) {
                  var _v110 = tokens,
                    _v111 = A2(
  ...
  var _user$project$Indexer$normalizeTipe = F2(function(tokens, tipeString) {
    return A3(
      _user$project$Indexer$normalizeTipeRecur,
      tokens,
      _elm_lang$core$Set$empty,
  ...
  var _user$project$Indexer$getAliasesOfType = F3(function(
    tokens,
    name,
    tipeString
  ) {
    if (_elm_lang$core$Native_Utils.eq(tipeString, '')) {
      ...
      var normalizedTipeString = A2(
        _user$project$Indexer$normalizeTipe,
        tokens,
        tipeString
      );
      return A2(
        ...
        A2(
          ...
          function(primitiveTipe) {
            return (
              !_elm_lang$core$Native_Utils.eq(tipeString, primitiveTipe) &&
              _elm_lang$core$Native_Utils.eq(
        ...
        A2(
          ...
          A2(
            _elm_lang$core$List$filter,
            function(hint) {
              var normalizedHintTipe = A2(
                _user$project$Indexer$normalizeTipe,
                tokens,
                hint.tipe
              );
              return (
                !_elm_lang$core$Native_Utils.eq(hint.tipe, '') &&
                (_elm_lang$core$Native_Utils.eq(
                  hint.kind,
                  _user$project$Indexer$KindTypeAlias
                ) &&
                  (!_elm_lang$core$Native_Utils.eq(tipeString, hint.name) &&
                    (!_elm_lang$core$Native_Utils.eq(name, hint.name) &&
                      (_elm_lang$core$Native_Utils.eq(
                        name,
                        normalizedHintTipe
                      ) ||
            ...
            _elm_lang$core$List$concat(_elm_lang$core$Dict$values(tokens))
          )
        )
      );
    }
  });
  var _user$project$Indexer$doGetAliasesOfType = F2(function(token, model) {
    return {
      ctor: '_Tuple2',
      _0: model,
      _1: _user$project$Indexer$aliasesOfTypeReceivedCmd(
        A3(
          _user$project$Indexer$getAliasesOfType,
  ...
  var _user$project$Indexer$encodeHint = F3(function(
    showAliasesOfType,
    tokens,
    hint
  ) {
  ...
  var _user$project$Indexer$getDefaultValueForTypeRecur = F3(function(
    activeFileTokens,
    visitedTypes,
    tipeString
  ) {
    getDefaultValueForTypeRecur: while (true) {
      if (
        _elm_lang$core$Native_Utils.eq(
        ...
        if (_user$project$Indexer$isRecordString(tipeString)) {
          ...
          if (_user$project$Indexer$isTupleString(tipeString)) {
            ...
            if (_user$project$Indexer$isFunctionTypeString(tipeString)) {
              ...
              var _p143 = _elm_lang$core$List$head(
                ...
                switch (_p144) {
                  ...
                  default:
                    var _p145 = _elm_lang$core$List$head(
                      A2(
                        _user$project$Indexer$getHintsForToken,
                        _elm_lang$core$Maybe$Just(_p150),
                        activeFileTokens
                      )
                    );
                    if (_p145.ctor === 'Just') {
                      ...
                      if (
                        ...
                        (!_elm_lang$core$Native_Utils.eq(_p149.tipe, _p150) &&
                          (!_elm_lang$core$Native_Utils.eq(
                            _p149.kind,
                            _user$project$Indexer$KindTypeAlias
                          ) ||
                            (_elm_lang$core$Native_Utils.eq(
                              ...
                              _elm_lang$core$Native_Utils.eq(
                                _elm_lang$core$List$length(_p149.args),
                                0
                              ))))
                      ) {
                        if (
                        ...
                        if (
                          ...
                          var _p146 = _elm_lang$core$List$head(_p149.cases);
                          if (_p146.ctor === 'Just') {
                            var _p148 = _p146._0;
                            if (
                              A2(
                              ...
                              var _p147 = _user$project$Indexer$typeConstructorToNameAndArgs(
                                tipeString
                              );
                              var annotatedTipeArgs = _p147._1;
                              var alignedArgs = A3(
                                _user$project$Indexer$getTipeCaseAlignedArgTipes,
                                _p149.args,
                                annotatedTipeArgs,
  ...
  var _user$project$Indexer$getDefaultValueForType = F2(function(
    activeFileTokens,
    tipeString
  ) {
    return A3(
  ...
  var _user$project$Indexer$constructFromTypeAnnotation = F2(function(
    typeAnnotation,
    activeFileTokens
  ) {
      ...
      A2(
        ...
        A2(
          ...
          A2(
            ...
            ' =\n    ',
            A2(
              _user$project$Indexer$getDefaultValueForType,
              activeFileTokens,
              returnTipe
            )
          )
  ...
  var _user$project$Indexer$doConstructFromTypeAnnotation = F2(function(
    typeAnnotation,
    model
  ) {
    return {
      ...
      _1: _user$project$Indexer$fromTypeAnnotationConstructedCmd(
        A2(
          _user$project$Indexer$constructFromTypeAnnotation,
          typeAnnotation,
          model.activeFileTokens
        )
      ),
  ...
  var _user$project$Indexer$constructDefaultArguments = F2(function(
    token,
    activeFileTokens
  ) {
    var _p151 = _elm_lang$core$List$head(
      A2(
        _user$project$Indexer$getHintsForToken,
        _elm_lang$core$Maybe$Just(token),
        activeFileTokens
    ...
    if (_p151.ctor === 'Just') {
      var _p152 = _p151._0;
      var parts = _user$project$Indexer$isRecordString(_p152.tipe)
        ? _user$project$Indexer$getRecordTipeFieldTipes(_p152.tipe)
        : _user$project$Helper$dropLast(
            _user$project$Indexer$getTipeParts(_p152.tipe)
          );
      return _elm_lang$core$Maybe$Just(
        A2(
          _elm_lang$core$List$map,
          function(tipeString) {
            ...
            return A2(_elm_lang$core$String$contains, ' ', value) &&
              (!_user$project$Indexer$isRecordString(value) &&
                !_user$project$Indexer$isTupleString(value))
              ? A2(
                  _elm_lang$core$Basics_ops['++'],
                  '(',
  ...
  var _user$project$Indexer$doConstructDefaultArguments = F2(function(
    token,
    model
  ) {
    return {
      ...
      _1: _user$project$Indexer$defaultArgumentsConstructedCmd(
        A2(
          _user$project$Indexer$constructDefaultArguments,
          token,
          model.activeFileTokens
        )
      ),
  ...
  var _user$project$Indexer$constructDefaultValueForType = F2(function(
    token,
    activeFileTokens
  ) {
    return _elm_lang$core$Native_Utils.cmp(
  ...
  var _user$project$Indexer$doConstructDefaultValueForType = F2(function(
    token,
    model
  ) {
    return {
      ...
      _1: _user$project$Indexer$defaultValueForTypeConstructedCmd(
        A2(
          _user$project$Indexer$constructDefaultValueForType,
          token,
          model.activeFileTokens
        )
      ),
  ...
  var _user$project$Indexer$getModuleSymbols = function(moduleDocs) {
    var _p153 = moduleDocs;
    var sourcePath = _p153.sourcePath;
    var values = _p153.values;
    var moduleDocsSymbol = {
    ...
    var valueSymbols = A2(
      _elm_lang$core$List$map,
      function(value) {
        var kind = _user$project$Helper$isCapitalized(value.name)
          ? _user$project$Indexer$KindTypeAlias
          : _user$project$Indexer$KindDefault;
        return {
          fullName: A2(
            _elm_lang$core$Basics_ops['++'],
            moduleDocs.name,
    ...
    return A2(
      ...
      A2(
        ...
        A2(
          _elm_lang$core$Basics_ops['++'],
          tipeSymbols,
          A2(_elm_lang$core$Basics_ops['++'], tipeCaseSymbols, {
            ctor: '::',
            _0: moduleDocsSymbol,
            _1: { ctor: '[]' },
          })
  ...
  var _user$project$Indexer$getProjectFileSymbols = F2(function(
    projectDirectory,
    projectFileContentsDict
  ) {
    var fileContentsDict = A2(
    ...
    var allFileSymbols = A2(
      ...
      function(_p154) {
        var _p155 = _p154;
        return _user$project$Indexer$getModuleSymbols(_p155.moduleDocs);
      },
      _elm_lang$core$Dict$values(fileContentsDict)
    );
    return A2(
      ...
      function(_p156) {
        var _p157 = _p156;
        return _user$project$Indexer$isProjectSourcePath(_p157.sourcePath);
      },
      allFileSymbols
    );
  });
  var _user$project$Indexer$doShowGoToSymbolView = F3(function(
    maybeProjectDirectory,
    maybeToken,
    model
  ) {
    var _p158 = maybeProjectDirectory;
    if (_p158.ctor === 'Just') {
      var hints = A2(
        _user$project$Indexer$getHintsForToken,
        maybeToken,
      ...
      var defaultSymbolName = (function() {
        var _p159 = _elm_lang$core$List$head(hints);
        if (_p159.ctor === 'Just') {
          var _p161 = _p159._0;
          var _p160 = model.activeFile;
          if (_p160.ctor === 'Just') {
            return _elm_lang$core$Native_Utils.eq(
              _p160._0.filePath,
              _p161.sourcePath
              ...
              ? _elm_lang$core$Maybe$Just(
                  _user$project$Indexer$getLastName(_p161.name)
                )
              : _elm_lang$core$Maybe$Just(_p161.name);
          } else {
            return _elm_lang$core$Maybe$Just(_p161.name);
          }
        } else {
          return maybeToken;
        }
      ...
      return {
        ...
        _1: _user$project$Indexer$showGoToSymbolViewCmd({
          ...
          _2: A2(
            ...
            A2(
              _user$project$Indexer$getProjectFileSymbols,
              _p158._0,
              model.projectFileContentsDict
            )
          ),
  ...
  var _user$project$Indexer$getProjectDependencySymbols = F3(function(
    maybeActiveFile,
    projectDependencies,
    packageDocs
  ) {
  ...
  var _user$project$Indexer$getProjectSymbols = F4(function(
    maybeActiveFile,
    projectFileContentsDict,
    projectDependencies,
    packageDocs
  ) {
    var _p162 = maybeActiveFile;
    if (_p162.ctor === 'Just') {
      return A2(
        _elm_lang$core$List$append,
        A2(
          _user$project$Indexer$getProjectFileSymbols,
          _p162._0.projectDirectory,
          projectFileContentsDict
        ),
        A3(
          _user$project$Indexer$getProjectDependencySymbols,
          maybeActiveFile,
          projectDependencies,
          packageDocs
        )
  ...
  var _user$project$Indexer$doShowAddImportView = F3(function(
    filePath,
    maybeToken,
    model
  ) {
    var defaultSymbolName = (function() {
      var _p163 = maybeToken;
      if (_p163.ctor === 'Just') {
        var _p165 = _p163._0;
        var _p164 = _user$project$Indexer$getModuleName(_p165);
        if (_p164 === '') {
          return _elm_lang$core$Maybe$Just(
            _user$project$Indexer$getLastName(_p165)
          );
        } else {
          return _elm_lang$core$Maybe$Just(
            _user$project$Indexer$getModuleName(_p165)
          );
        }
      } else {
        return _elm_lang$core$Maybe$Nothing;
    ...
    var moduleAndSymbols = A2(
      ...
      A2(
        ...
        function(_p166) {
          var _p167 = _p166;
          return (
            !_elm_lang$core$Native_Utils.eq(_p167.sourcePath, filePath) &&
            !_elm_lang$core$Native_Utils.eq(
              _user$project$Indexer$getLastName(_p167.fullName),
              ''
            )
          );
        },
        A4(
          _user$project$Indexer$getProjectSymbols,
          model.activeFile,
          model.projectFileContentsDict,
          model.projectDependencies,
          model.packageDocs
    ...
    var moduleAndSymbolsAndAllExposed = A2(
      _elm_lang$core$List$sortWith,
      F2(function(_p172, _p171) {
        var _p173 = _p172;
        var _p174 = _p171;
        var filterKey = F2(function(moduleName, symbolName) {
          return A2(
            _elm_lang$core$Basics_ops['++'],
            moduleName,
            (function() {
              var _p175 = symbolName;
              if (_p175.ctor === 'Just') {
                return A2(_elm_lang$core$Basics_ops['++'], ' ', _p175._0);
              } else {
                return '';
              }
            })()
        ...
        return A2(
          _elm_lang$core$Basics$compare,
          A2(filterKey, _p173._0, _p173._1),
          A2(filterKey, _p174._0, _p174._1)
        );
      }),
      A2(
        _elm_lang$core$List$append,
    ...
    return {
      ...
      _1: _user$project$Indexer$showAddImportViewCmd({
        ...
        _0: defaultSymbolName,
        _1: model.activeFile,
        _2: moduleAndSymbolsAndAllExposed,
      }),
    };
  });
  var _user$project$Indexer$getHintsForUnexposedNames = F3(function(
    includeQualified,
    moduleDocs,
    unexposedNames
  ) {
    var filter = function(_p178) {
      var _p179 = _p178;
      return A2(_elm_lang$core$Set$member, _p179.name, unexposedNames);
    };
    var qualifiedAndUnqualified = function(hint) {
      return includeQualified
        ? {
            ctor: '::',
            _0: _elm_lang$core$Native_Utils.update(hint, {
              name: A2(
                _elm_lang$core$Basics_ops['++'],
                moduleDocs.name,
                A2(_elm_lang$core$Basics_ops['++'], '.', hint.name)
    ...
    var valueToHints = F2(function(kind, value) {
      return qualifiedAndUnqualified({
        ...
        tipe: value.tipe,
        args: A2(_elm_lang$core$Maybe$withDefault, { ctor: '[]' }, value.args),
        caseTipe: _elm_lang$core$Maybe$Nothing,
        cases: { ctor: '[]' },
  ...
  var _user$project$Indexer$inferenceToHints = function(inference) {
    return {
      ctor: '::',
      _0: _elm_lang$core$Native_Utils.update(_user$project$Indexer$emptyHint, {
        name: inference.name,
        tipe: inference.tipe,
      }),
      _1: { ctor: '[]' },
        ...
        _1: {
          ...
          _0: _elm_lang$core$Native_Utils.update(
            _user$project$Indexer$emptyHint,
            {
              name: 'comparable',
              comment:
                'This includes numbers, characters, strings, lists of comparable things, and tuples of comparable things. Note that tuples with 7 or more elements are not comparable.',
            }
          ),
          _1: { ctor: '[]' },
        },
  ...
  var _user$project$Indexer$getFilteredHints = F3(function(
    activeFilePath,
    moduleDocs,
    importData
  ) {
    return A2(
      ...
      A2(
        _elm_lang$core$List$concatMap,
        A3(
          _user$project$Indexer$unionTagsToHints,
          moduleDocs,
          importData,
          activeFilePath
        ),
      ...
      A2(
        ...
        A2(
          _elm_lang$core$List$concatMap,
          A4(
            _user$project$Indexer$nameToHints,
            moduleDocs,
            importData,
            activeFilePath,
            _user$project$Indexer$KindTypeAlias
          ...
          A2(
            _elm_lang$core$List$map,
            _user$project$Indexer$valueToHintable,
        ...
        A2(
          ...
          A2(
            ...
            A2(
              _elm_lang$core$List$map,
              _user$project$Indexer$tipeToHintable,
              moduleDocs.values.tipes
            )
          ),
          A2(
  ...
  var _user$project$Indexer$getExposedAndUnexposedHints = F4(function(
    includeUnexposed,
    activeFilePath,
    imports,
    moduleDocsList
      ...
      F2(function(moduleDocs, _p181) {
        ...
        var aliasesTipesAndValues = A2(
          ...
          A2(
            ...
            A2(
              _elm_lang$core$List$map,
              _user$project$Indexer$tipeToValue,
              moduleDocs.values.tipes
            ),
            moduleDocs.values.values
          )
        ...
        var _p183 = (function() {
          var _p184 = A2(_elm_lang$core$Dict$get, moduleDocs.name, imports);
          if (_p184.ctor === 'Just') {
            var exposed = A2(
              _elm_lang$core$List$map,
              function(_p185) {
                var _p186 = _p185;
                var _p187 = _p186._1;
                var moduleNameToShow =
                  _elm_lang$core$Native_Utils.eq(_p187.moduleName, '') ||
                  _elm_lang$core$Native_Utils.eq(
                    activeFilePath,
                    _p187.sourcePath
                  )
                    ? ''
                    : _p187.moduleName;
                return _elm_lang$core$Native_Utils.update(_p187, {
                  moduleName: moduleNameToShow,
                  name: _p186._0,
                });
              },
              A3(
                _user$project$Indexer$getFilteredHints,
                activeFilePath,
                moduleDocs,
                _p184._0
              )
        ...
        var exposedHints = _p183._0;
        var unexposedHints = _p183._1;
        return {
          ctor: '_Tuple2',
          _0: { ctor: '::', _0: exposedHints, _1: _p182._0 },
          _1: { ctor: '::', _0: unexposedHints, _1: _p182._1 },
        };
      }),
      {
        ctor: '_Tuple2',
    ...
    var exposedLists = _p180._0;
    var unexposedLists = _p180._1;
    return {
      ctor: '_Tuple2',
  ...
  var _user$project$Indexer$getExternalHints = F4(function(
    isGlobal,
    filePath,
    activeFileContents,
    allModuleDocs
  ) {
    var moduleDocsToCheck = isGlobal
      ? A2(
          _elm_lang$core$List$filter,
          function(moduleDocs) {
            return !_elm_lang$core$Native_Utils.eq(
          ...
          function(moduleDocs) {
            return (
              A2(
                _elm_lang$core$List$member,
                moduleDocs.name,
                _elm_lang$core$Dict$keys(activeFileContents.imports)
              ) &&
              !_elm_lang$core$Native_Utils.eq(moduleDocs.sourcePath, filePath)
            );
          },
          allModuleDocs
        );
    var _p188 = A4(
      ...
      isGlobal,
      filePath,
      activeFileContents.imports,
      moduleDocsToCheck
    );
    var importedHints = _p188._0;
    var unimportedHints = _p188._1;
    return { importedHints: importedHints, unimportedHints: unimportedHints };
  });
  var _user$project$Indexer$All = { ctor: 'All' };
  var _user$project$Indexer$getLocalHints = F3(function(
    filePath,
    activeFileContents,
    activeFileTokens
  ) {
    ...
    return {
      ...
      variableHints: A2(
        ...
        _elm_lang$core$List$concat(_elm_lang$core$Dict$values(activeFileTokens))
      ),
    };
  });
  var _user$project$Indexer$getImportsPlusActiveModule = function(
    fileContents
  ) {
    return A3(
      _elm_lang$core$Dict$update,
  ...
  var _user$project$Indexer$toImport = function(_p190) {
    var _p191 = _p190;
    var exposedSet = (function() {
      var _p192 = _p191.exposed;
      if (_p192.ctor === 'Just') {
        if (
          _p192._0.ctor === '::' &&
          _p192._0._0 === '..' &&
          ...
          return _user$project$Indexer$Some(
            _elm_lang$core$Set$fromList(_p192._0)
          );
        }
      } else {
    ...
    return {
      ctor: '_Tuple2',
      _0: _p191.name,
      _1: A2(_user$project$Indexer$Import, _p191.alias, exposedSet),
    };
  };
      ...
      _1: {
        ...
        _1: {
          ...
          _0: A2(
            _user$project$Indexer_ops['=>'],
            'Maybe',
            _user$project$Indexer$Some(_elm_lang$core$Set$singleton('Maybe'))
          ),
          _1: {
            ctor: '::',
            _0: A2(
              _user$project$Indexer_ops['=>'],
              'Result',
              _user$project$Indexer$Some(_elm_lang$core$Set$singleton('Result'))
            ),
            _1: {
              ctor: '::',
              _0: A2(
  ...
  var _user$project$Indexer$emptyFileContents = {
    moduleDocs: _user$project$Indexer$emptyModuleDocs,
    imports: _user$project$Indexer$defaultImports,
  };
  var _user$project$Indexer$getActiveFileContents = F2(function(
    maybeActiveFile,
    fileContentsDict
  ) {
  ...
  var _user$project$Indexer$doGetImporterSourcePathsForToken = F4(function(
    maybeProjectDirectory,
    maybeToken,
    maybeIsCursorAtLastPartOfToken,
    model
  ) {
    var _p195 = {
      ctor: '_Tuple3',
      _0: maybeProjectDirectory,
      _1: maybeToken,
      _2: maybeIsCursorAtLastPartOfToken,
    };
    if (
      _p195.ctor === '_Tuple3' &&
      _p195._0.ctor === 'Just' &&
      ...
      var _p199 = _p195._1._0;
      var _p198 = _p195._0._0;
      var _p197 = _p195._2._0;
      var fileContentsDict = A2(
        _user$project$Indexer$getFileContentsOfProject,
        _p198,
        model.projectFileContentsDict
      );
      var activeFileContents = A2(
        _user$project$Indexer$getActiveFileContents,
        model.activeFile,
        fileContentsDict
      );
      var _p196 = _elm_lang$core$Native_Utils.eq(
        _p199,
        activeFileContents.moduleDocs.name
      )
        ? { ctor: '_Tuple2', _0: _p199, _1: true }
        : !_elm_lang$core$Native_Utils.eq(
            A2(_elm_lang$core$Dict$get, _p199, activeFileContents.imports),
            _elm_lang$core$Maybe$Nothing
          )
          ? { ctor: '_Tuple2', _0: _p199, _1: true }
          : _p197
            ? { ctor: '_Tuple2', _0: _p199, _1: false }
            : {
                ctor: '_Tuple2',
                _0: _user$project$Indexer$getModuleName(_p199),
                _1: false,
              };
      var token = _p196._0;
      var willUseFullToken = _p196._1;
      return {
        ctor: '_Tuple2',
        _0: model,
        _1: _user$project$Indexer$importersForTokenReceivedCmd({
          ...
          _3: _p197,
          _4: A6(
            _user$project$Indexer$getImportersForToken,
            token,
            _p197,
            model.activeFile,
            model.activeFileTokens,
  ...
  var _user$project$Indexer$getExternalAndLocalHints = F8(function(
    isGlobal,
    maybeActiveFile,
    projectFileContentsDict,
    projectDependencies,
    ...
    var _p200 = maybeActiveFile;
    if (_p200.ctor === 'Just') {
      var _p204 = _p200._0.projectDirectory;
      var _p203 = _p200._0.filePath;
      var fileContentsDict = A2(
        _user$project$Indexer$getFileContentsOfProject,
        _p204,
        projectFileContentsDict
      ...
      var local = (function() {
        var _p201 = maybeCachedLocal;
        if (_p201.ctor === 'Just') {
          return _p201._0;
        } else {
          return A3(
            _user$project$Indexer$getLocalHints,
            _p203,
            activeFileContents,
            activeFileTokens
          );
      ...
      var external = (function() {
        var _p202 = maybeCachedExternal;
        if (_p202.ctor === 'Just') {
          return _p202._0;
        } else {
          return A4(
            _user$project$Indexer$getExternalHints,
            isGlobal,
            _p203,
            activeFileContents,
            allModuleDocs
                      ...
                      return function(packageDocs) {
                        return function(maybeHintsCache) {
                          return function(activeFileTokens) {
                            var _p205 = maybeActiveFile;
                            if (_p205.ctor === 'Just') {
                              var filterByPartial = A5(
                                _user$project$Indexer$filterHintsByPartial,
                                partial,
                                maybeInferredTipe,
                                isFiltered,
                                isRegex,
                              ...
                              var filteredDefaultHints = filterByPartial(
                                _user$project$Indexer$defaultSuggestions
                              );
                              var _p206 = (function() {
                                var _p207 = maybeHintsCache;
                                if (_p207.ctor === 'Just') {
                                  var _p209 = _p207._0;
                                  var _p208 = {
                                    ctor: '_Tuple2',
                                  ...
                                  if (
                                    ...
                                    return A8(
                                      _user$project$Indexer$getExternalAndLocalHints,
                                      isGlobal,
                                      maybeActiveFile,
                                      projectFileContentsDict,
                                      projectDependencies,
                              ...
                              var external = _p206.external;
                              var local = _p206.local;
                              var _p210 = (function() {
                                var _p211 = {
                                  ctor: '_Tuple2',
                                  _0: external,
                                ...
                                if (
                                  ...
                                  return {
                                    ...
                                    _1: _p212.unimportedHints,
                                    _2: _p213.variableHints,
                                  };
                                } else {
                                  return {
                                    ctor: '_Tuple3',
                              ...
                              var exposedAndTopLevelHints = _p210._0;
                              var unexposedHints = _p210._1;
                              var variableHints = _p210._2;
                              var filteredExposedHints = filterByPartial(
                                exposedAndTopLevelHints
                              );
                              var filteredUnexposedHints = filterByPartial(
                                unexposedHints
                              );
                              var filteredVariableHints = filterByPartial(
                                variableHints
                              );
                              var hints = (function() {
                                var _p214 = maybeInferredTipe;
                                if (_p214.ctor === 'Just') {
                                  var _p219 = _p214._0;
                                  var partitionHints = function(hints) {
                                    return A2(
                                      ...
                                      A2(
                                        _user$project$Indexer$partitionByTipe,
                                        _p219,
                                        preceedingToken
                                      ),
                                      hints
                                  ...
                                  var _p215 = partitionHints(
                                    filteredVariableHints
                                  );
                                  var variableHintsCompatible = _p215._0;
                                  var variableHintsNotCompatible = _p215._1;
                                  var _p216 = partitionHints(
                                    filteredDefaultHints
                                  );
                                  var defaultHintsCompatible = _p216._0;
                                  var defaultHintsNotCompatible = _p216._1;
                                  var _p217 = partitionHints(
                                    filteredExposedHints
                                  );
                                  var exposedHintsCompatible = _p217._0;
                                  var exposedHintsNotCompatible = _p217._1;
                                  var _p218 = partitionHints(
                                    filteredUnexposedHints
                                  );
                                  var unexposedHintsCompatible = _p218._0;
                                  var unexposedHintsNotCompatible = _p218._1;
                                  return A2(
                                    _elm_lang$core$Basics_ops['++'],
                                    A3(
                                      _user$project$Indexer$sortHintsByScore,
                                      _p219,
                                      preceedingToken,
                                      variableHintsCompatible
                                    ),
                                    A2(
                                      _elm_lang$core$Basics_ops['++'],
                                      A3(
                                          ...
                                          A2(
                                            ...
                                            _user$project$Indexer$sortHintsByName(
                                              A2(
                                                _elm_lang$core$Basics_ops['++'],
                                                A4(
                                                  _user$project$Indexer$filterTypeIncompatibleHints,
                                                  partial,
                                                  isFiltered,
                                                  isRegex,
                                                  variableHintsNotCompatible
                                                ),
                                                A2(
                                                  _elm_lang$core$Basics_ops[
                                                    '++'
  ...
  var _user$project$Indexer$doGetHintsForPartial = F8(function(
    partial,
    maybeInferredTipe,
    preceedingToken,
    isRegex,
    ...
    var _p220 = _user$project$Indexer$getHintsForPartial(partial)(
      maybeInferredTipe
    )(preceedingToken)(isRegex)(isTypeSignature)(isFiltered)(isGlobal)(
      model.activeFile
    )(model.projectFileContentsDict)(model.projectDependencies)(
      model.packageDocs
    )(model.hintsCache)(model.activeFileTokens);
    var hints = _p220._0;
    var updatedHintsCache = _p220._1;
    return {
      ctor: '_Tuple2',
      _0: _elm_lang$core$Native_Utils.update(model, {
  ...
  var _user$project$Indexer$getActiveFileTokens = F5(function(
    maybeActiveFile,
    maybeActiveTopLevel,
    projectFileContentsDict,
    projectDependencies,
    ...
    var _p221 = maybeActiveFile;
    if (_p221.ctor === 'Just') {
      var _p228 = _p221._0.projectDirectory;
      var _p227 = _p221._0.filePath;
      var insert = F2(function(_p222, dict) {
        var _p223 = _p222;
        return A3(
          _elm_lang$core$Dict$update,
          _p223._0,
          function(value) {
            return _elm_lang$core$Maybe$Just({
              ctor: '::',
              _0: _p223._1,
              _1: A2(_elm_lang$core$Maybe$withDefault, { ctor: '[]' }, value),
            });
          },
          dict
        );
      ...
      var getHints = function(moduleDocs) {
        return A2(
          _elm_lang$core$Maybe$map,
          A2(_user$project$Indexer$getFilteredHints, _p227, moduleDocs),
          A2(
            _elm_lang$core$Dict$get,
            moduleDocs.name,
            A2(
      ...
      var topLevelArgTipePairs = A2(
        ...
        function(_p224) {
          ...
          return A3(
            ...
            _p225.args,
            _user$project$Indexer$getTipeParts(_p225.tipe)
          );
        },
        A2(
          _user$project$Indexer$getHintsForToken,
          ...
          return A2(
            ...
            A3(
              ...
              _p227,
              {
                ctor: '_Tuple4',
                _0: maybeActiveFile,
                _1: projectFileContentsDict,
                _2: projectDependencies,
                _3: packageDocs,
              },
              topLevelTokens
            ),
  ...
  var _user$project$Indexer$topLevelArgToHints = F4(function(
    parentSourcePath,
    _p230,
    topLevelTokens,
    _p229
      ...
      var getRecordFields = function(tipeString) {
        return _elm_lang$core$List$concat(
          A2(
            ...
            _user$project$Indexer$getRecordArgParts(_p238)
          )
        );
      };
      var _p233 = {
        ctor: '_Tuple2',
        _0: _user$project$Indexer$isRecordString(_p238),
        _1: _user$project$Indexer$isRecordString(_p239),
      };
      if (_p233._0 === true) {
        if (_p233._1 === true) {
          return getRecordFields(_p239);
        } else {
          var _p234 = _elm_lang$core$List$head(
            A2(
              _user$project$Indexer$getHintsForToken,
              _elm_lang$core$Maybe$Just(_p239),
              topLevelTokens
            )
          );
          if (_p234.ctor === 'Just') {
            return getRecordFields(_p234._0.tipe);
          } else {
            return { ctor: '[]' };
          }
        }
        ...
        return A5(
          ...
          _p239,
          parentSourcePath,
          { ctor: '_Tuple4', _0: _p240, _1: _p243, _2: _p242, _3: _p241 },
          topLevelTokens
        );
      }
    })();
    var getHint = function(_p235) {
      var _p236 = _p235;
      var _p237 = _p236._0;
      var hint = {
        name: _p237,
      ...
      return {
        ctor: '::',
        _0: { ctor: '_Tuple2', _0: _p237, _1: hint },
        _1: { ctor: '[]' },
      };
    };
    return A2(_elm_lang$core$List$concatMap, getHint, tipes);
  });
  var _user$project$Indexer$getRecordFieldTokens = F5(function(
    name,
    tipeString,
    parentSourcePath,
    _p244,
  ...
  var _user$project$Indexer$getRecordFieldTokensRecur = F8(function(
    name,
    tipeString,
    parentSourcePath,
    _p246,
      ...
      (function() {
        if (_user$project$Indexer$isRecordString(name)) {
          ...
          if (_user$project$Indexer$isRecordString(tipeString)) {
            ...
            var _p248 = _elm_lang$core$List$head(
              A2(
                _user$project$Indexer$getHintsForToken,
                _elm_lang$core$Maybe$Just(tipeString),
                topLevelTokens
            ...
            if (_p248.ctor === 'Just') {
              return getRecordFields(_p248._0.tipe);
            } else {
              return { ctor: '[]' };
            }
          }
          ...
          if (_user$project$Indexer$isRecordString(tipeString)) {
              ...
              function(_p249) {
                ...
                return A8(
                  ...
                  A2(
                    _elm_lang$core$Basics_ops['++'],
                    name,
                    A2(_elm_lang$core$Basics_ops['++'], '.', _p250._0)
                  ),
                  _p250._1,
                  parentSourcePath,
                  {
            ...
            if (
              _user$project$Indexer$isTupleString(name) &&
              _user$project$Indexer$isTupleString(tipeString)
            ) {
              return _elm_lang$core$List$concat(
                A2(
                  _elm_lang$core$List$map,
              ...
              var _p254 = _elm_lang$core$List$head(
                A2(
              ...
              if (_p254.ctor === 'Just') {
                ...
                if (
                  ...
                  (!_elm_lang$core$Native_Utils.eq(_p258.tipe, tipeString) &&
                    !A2(
                      _elm_lang$core$Set$member,
                      _p258.sourcePath,
                      visitedSourcePaths
                  ...
                  var maybeNewActiveFile = (function() {
                    ...
                    if (_p255.ctor === 'Just') {
                      return _elm_lang$core$Maybe$Just(
                        _elm_lang$core$Native_Utils.update(_p255._0, {
                          filePath: _p258.sourcePath,
                        })
                      );
                    } else {
                      return _elm_lang$core$Maybe$Nothing;
                  ...
                  var _p256 = {
                    ...
                    _1:
                      ...
                      _user$project$Indexer$isProjectSourcePath(
                        _p258.sourcePath
                      )
                        ? A5(
                  ...
                  var newParentSourcePath = _p256._0;
                  var newTokens = _p256._1;
                  var _p257 = maybeRootTipeString;
                  if (_p257.ctor === 'Just') {
                    return !_elm_lang$core$Native_Utils.eq(_p258.name, _p257._0)
                      ? A8(
                          _user$project$Indexer$getRecordFieldTokensRecur,
                          name,
                          _p258.tipe,
                          ...
                          newTokens,
                          false,
                          _elm_lang$core$Maybe$Just(_p258.name),
  ...
  var _user$project$Indexer$doUpdateActiveTokenHints = F3(function(
    maybeActiveTopLevel,
    maybeToken,
    model
  ) {
    var updatedActiveFileTokens = !_elm_lang$core$Native_Utils.eq(
      ...
      : model.activeFileTokens;
    var updatedActiveTokenHints = A2(
      _user$project$Indexer$getHintsForToken,
      maybeToken,
  ...
  var _user$project$Indexer$doGetTokenInfo = F5(function(
    maybeProjectDirectory,
    maybeFilePath,
    maybeActiveTopLevel,
    maybeToken,
    ...
    if (
      ...
      var _p266 = _p263._0._0;
      var _p265 = _p263._1._0;
      var fileTokens = (function() {
        var _p264 = model.activeFile;
        if (_p264.ctor === 'Just') {
          return _elm_lang$core$Native_Utils.eq(_p264._0.filePath, _p265) &&
            _elm_lang$core$Native_Utils.eq(
              model.activeTopLevel,
              maybeActiveTopLevel
            )
      ...
      return {
        ctor: '_Tuple2',
        _0: model,
        _1: _user$project$Indexer$tokenInfoReceivedCmd({ ctor: '[]' }),
      };
    }
  });
  var _user$project$Indexer$doUpdateActiveFile = F4(function(
    maybeActiveFile,
    maybeActiveTopLevel,
    maybeToken,
    model
  ) {
    var updatedActiveFileTokens =
      !_elm_lang$core$Native_Utils.eq(model.activeFile, maybeActiveFile) ||
      !_elm_lang$core$Native_Utils.eq(model.activeTopLevel, maybeActiveTopLevel)
        ? A5(
            _user$project$Indexer$getActiveFileTokens,
            maybeActiveFile,
            maybeActiveTopLevel,
  ...
  var _user$project$Indexer$doUpdateFileContents = F4(function(
    filePath,
    projectDirectory,
    fileContents,
    model
  ) {
    var updatedProjectFileContentsDict = A4(
    ...
    var updatedActiveFileTokens = A5(
      _user$project$Indexer$getActiveFileTokens,
      model.activeFile,
      model.activeTopLevel,
    ...
    var updatedHintsCache = (function() {
      var _p267 = model.hintsCache;
      if (_p267.ctor === 'Just') {
        var _p271 = _p267._0;
        var _p268 = _p271.external;
        if (_p268.ctor === 'Just') {
          var _p269 = model.activeFile;
          if (_p269.ctor === 'Just') {
            var _p270 = _p269._0;
            var newFileContentsDict = A2(
              _user$project$Indexer$getFileContentsOfProject,
              _p270.projectDirectory,
              updatedProjectFileContentsDict
            );
            var newActiveFileContents = A2(
              _user$project$Indexer$getActiveFileContents,
              model.activeFile,
              newFileContentsDict
            );
            var oldFileContentsDict = A2(
              _user$project$Indexer$getFileContentsOfProject,
              _p270.projectDirectory,
              model.projectFileContentsDict
            );
            var oldActiveFileContents = A2(
              _user$project$Indexer$getActiveFileContents,
              model.activeFile,
              oldFileContentsDict
            );
            ...
            return _elm_lang$core$Native_Utils.eq(_p270.filePath, filePath) &&
              !_elm_lang$core$Native_Utils.eq(
                oldActiveFileContents.imports,
                newActiveFileContents.imports
              )
              ? _elm_lang$core$Maybe$Just(
                  _elm_lang$core$Native_Utils.update(_p271, {
                    external: _elm_lang$core$Maybe$Nothing,
                  })
                )
              : model.hintsCache;
          } else {
  ...
  var _user$project$Indexer$doRemoveFileContents = F3(function(
    filePath,
    projectDirectory,
    model
  ) {
    var updatedProjectFileContentsDict = (function() {
      ...
      var updatedFileContentsDict = A2(
  ...
  var _user$project$Indexer$addLoadedPackageDocs = F2(function(
    loadedPackageDocs,
    model
  ) {
    var existingPackages = A2(
    ...
    var updatedPackageDocs = A2(
      ...
      A2(
        _elm_lang$core$List$map,
        _user$project$Indexer$truncateModuleComment,
        missingPackageDocs
      ),
      model.packageDocs
    );
  ...
  var _user$project$Indexer$getSourcePathOfRecordFieldTokenRecur = F7(function(
    parentPartName,
    parentName,
    parentSourcePath,
    tailParts,
    ...
    getSourcePathOfRecordFieldTokenRecur: while (true) {
      var _p276 = _p275;
      var _p295 = _p276._1;
      var _p294 = _p276._2;
      var _p293 = _p276._3;
      var _p292 = _p276._0;
      var _p277 = _elm_lang$core$List$head(tailParts);
      if (_p277.ctor === 'Just') {
        var _p291 = _p277._0;
        var doDefault = function(parentHint) {
          return _elm_lang$core$Native_Utils.eq(parentHint.sourcePath, '')
            ? A2(
                _elm_lang$core$Basics_ops['++'],
                parentSourcePath,
                A2(
                  _elm_lang$core$Basics_ops['++'],
                  _user$project$Indexer$filePathSeparator,
                  parentHint.tipe
                )
              )
            : A2(
        ...
        var newPrefixSourcePath = (function() {
          var _p278 = _elm_lang$core$List$head(
            A2(
              _user$project$Indexer$getHintsForToken,
          ...
          if (_p278.ctor === 'Just') {
            var _p281 = _p278._0;
            if (_user$project$Indexer$isRecordString(_p281.tipe)) {
              return A2(
                _elm_lang$core$Basics_ops['++'],
                parentSourcePath,
                A2(
              ...
              var _p279 = _elm_lang$core$List$head(
                A2(
                  _user$project$Indexer$getHintsForToken,
                  _elm_lang$core$Maybe$Just(_p281.tipe),
                  tokens
                )
              );
              if (_p279.ctor === 'Just') {
            ...
            if (_p282.ctor === 'Just') {
              var _p285 = _p282._0;
              var _p283 = _elm_lang$core$List$head(
                A2(
                  _user$project$Indexer$getHintsForToken,
                  _elm_lang$core$Maybe$Just(_p285.tipe),
                  tokens
                )
              );
              if (_p283.ctor === 'Just') {
        ...
        var _p286 = (function() {
          ...
          if (
            ...
            var _p290 = _p287._1._0;
            var maybeNewActiveFile = (function() {
              var _p288 = _p292;
              if (_p288.ctor === 'Just') {
                return _elm_lang$core$Maybe$Just(
                  _elm_lang$core$Native_Utils.update(_p288._0, {
                    filePath: _p290,
                  })
                );
              } else {
            ...
            var _p289 = maybeNewActiveFile;
            if (_p289.ctor === 'Just') {
              return !_elm_lang$core$Native_Utils.eq(_p287._0._0, _p290) &&
                _user$project$Indexer$isProjectSourcePath(_p290)
                ? {
                    ctor: '_Tuple2',
                    _0: maybeNewActiveFile,
                    _1: A5(
                ...
                : { ctor: '_Tuple2', _0: _p292, _1: tokens };
            } else {
              return { ctor: '_Tuple2', _0: _p292, _1: tokens };
            }
          } else {
            return { ctor: '_Tuple2', _0: _p292, _1: tokens };
          }
        })();
        var updatedActiveFile = _p286._0;
        var updatedTokens = _p286._1;
        var _v186 = _p291,
          _v187 = A2(
            _elm_lang$core$Basics_ops['++'],
            parentName,
            A2(_elm_lang$core$Basics_ops['++'], '.', _p291)
          ),
          _v188 = newPrefixSourcePath,
          _v189 = A2(
            _elm_lang$core$Maybe$withDefault,
            { ctor: '[]' },
          ...
          _v191 = rootTokens,
          _v192 = updatedTokens;
        parentPartName = _v186;
        parentName = _v187;
        parentSourcePath = _v188;
        tailParts = _v189;
        _p275 = _v190;
        rootTokens = _v191;
        tokens = _v192;
  ...
  var _user$project$Indexer$getSourcePathOfRecordFieldToken = F5(function(
    name,
    filePath,
    maybeActiveTopLevel,
    _p296,
    ...
    if (_elm_lang$core$Native_Utils.eq(_elm_lang$core$List$length(parts), 1)) {
      var _p298 = maybeActiveTopLevel;
      if (_p298.ctor === 'Just') {
        return A2(
          _elm_lang$core$Basics_ops['++'],
          filePath,
      ...
      var _p299 = _elm_lang$core$List$head(parts);
      if (_p299.ctor === 'Just') {
        var _p300 = _p299._0;
        return A7(
  ...
  var _user$project$Indexer$computeVariableSourcePaths = F2(function(
    _p301,
    tokens
  ) {
    var _p302 = _p301;
    ...
    if (_p303.ctor === 'Just') {
      return A2(
        _elm_lang$core$Dict$map,
        F2(function(_p304, hints) {
          return A2(
            _elm_lang$core$List$map,
            function(hint) {
              return _elm_lang$core$Native_Utils.eq(
                hint.kind,
                _user$project$Indexer$KindVariable
              )
                ? _elm_lang$core$Native_Utils.update(hint, {
                    sourcePath: A5(
  ...
  var _user$project$Indexer$doGoToDefinition = F3(function(
    maybeActiveTopLevel,
    maybeToken,
    model
  ) {
    var activeFileTokens = A2(
      _user$project$Indexer$computeVariableSourcePaths,
      {
        ctor: '_Tuple5',
        _0: model.activeFile,
        _1: maybeActiveTopLevel,
        _2: model.projectFileContentsDict,
        _3: model.projectDependencies,
        _4: model.packageDocs,
      },
      A5(
        _user$project$Indexer$getActiveFileTokens,
        model.activeFile,
  ...
  var _user$project$Indexer$doAskCanGoToDefinition = F3(function(
    maybeActiveTopLevel,
    token,
    model
  ) {
  ...
  var _user$project$Indexer$importsToString = F2(function(imports, tokens) {
    return A2(
      _elm_lang$core$String$join,
      '\n',
      A2(
        ...
        function(_p306) {
          ...
          var formatExposedSymbol = function(token) {
            ...
            var formatSymbol = function(token) {
              return !_elm_lang$core$Native_Utils.eq(token, '..') &&
                _user$project$Helper$isInfix(token)
                ? A2(
                    _elm_lang$core$Basics_ops['++'],
                    '(',
            ...
            var _p309 = _elm_lang$core$List$head(hints);
            if (_p309.ctor === 'Just') {
              var _p310 = _p309._0.caseTipe;
              if (_p310.ctor === 'Just') {
                return A2(
                  _elm_lang$core$Basics_ops['++'],
                  _p310._0,
            ...
            if (_p314.ctor === 'Just') {
              return A2(
                ...
                A2(
                  _elm_lang$core$Basics_ops['++'],
                  _p315,
                  A2(_elm_lang$core$Basics_ops['++'], ' as ', _p314._0)
                )
              );
            } else {
              return A2(_elm_lang$core$Basics_ops['++'], 'import ', _p315);
            }
          })();
  ...
  var _user$project$Indexer$doAddImport = F5(function(
    filePath,
    projectDirectory,
    moduleName,
    maybeSymbolName,
    ...
    var updatedImports = A2(
      _elm_lang$core$Dict$filter,
      F2(function(moduleName, moduleImport) {
        return !A2(
          _elm_lang$core$List$member,
      ...
      (function() {
        ...
        if (_p316.ctor === 'Just') {
          var _p323 = _p316._0;
          var _p317 = maybeSymbolName;
          if (_p317.ctor === 'Just') {
            var _p322 = _p317._0;
            var _p318 = _p323.exposed;
            switch (_p318.ctor) {
              case 'All':
                return fileContents.imports;
              case 'Some':
                return _elm_lang$core$Native_Utils.eq(_p322, '..')
                  ? A3(
                      _elm_lang$core$Dict$update,
                      moduleName,
                      function(_p319) {
                        return _elm_lang$core$Maybe$Just(
                          _elm_lang$core$Native_Utils.update(_p323, {
                            exposed: _user$project$Indexer$All,
                          })
                        );
                      },
                        ...
                        return _elm_lang$core$Maybe$Just(
                          _elm_lang$core$Native_Utils.update(_p323, {
                            exposed: _user$project$Indexer$Some(
                              A2(_elm_lang$core$Set$insert, _p322, _p318._0)
                            ),
                          })
                        );
                      },
                ...
                return A3(
                  ...
                  function(_p321) {
                    return _elm_lang$core$Maybe$Just(
                      _elm_lang$core$Native_Utils.update(_p323, {
                        exposed: _user$project$Indexer$Some(
                          _elm_lang$core$Set$singleton(_p322)
                        ),
                      })
                    );
                  },
          ...
          var importToAdd = (function() {
            var _p324 = maybeSymbolName;
            if (_p324.ctor === 'Just') {
              return {
                alias: _elm_lang$core$Maybe$Nothing,
                exposed: _user$project$Indexer$Some(
                  _elm_lang$core$Set$singleton(_p324._0)
                ),
              };
            } else {
              return {
                alias: _elm_lang$core$Maybe$Nothing,
                exposed: _user$project$Indexer$None,
              };
            }
          })();
          return A3(
    ...
    var updatedFileContents = _elm_lang$core$Native_Utils.update(fileContents, {
      imports: updatedImports,
    });
    return {
      ctor: '_Tuple2',
      _0: _elm_lang$core$Native_Utils.update(model, {
        projectFileContentsDict: A4(
          _user$project$Indexer$updateFileContents,
          filePath,
          projectDirectory,
          updatedFileContents,
      ...
      _1: _user$project$Indexer$updateImportsCmd({
        ...
        _0: filePath,
        _1: A2(
          _user$project$Indexer$importsToString,
          updatedImports,
          model.activeFileTokens
        ),
      }),
  ...
  var _user$project$Indexer$update = F2(function(msg, model) {
    var _p325 = msg;
    switch (_p325.ctor) {
      case 'MaybeDocsDownloaded':
        if (_p325._1.ctor === 'Err') {
          return {
            ctor: '_Tuple2',
            _0: model,
            _1: _user$project$Indexer$downloadDocsFailedCmd(
              _elm_lang$core$Basics$toString(_p325._1._0)
            ),
          };
        } else {
          var _p326 = A3(
            _elm_lang$core$List$foldl,
            F2(function(_p328, _p327) {
              var _p329 = _p328;
              var _p337 = _p329._0;
              var _p330 = _p327;
              var _p336 = _p330._0;
              ...
              if (_p331.ctor === 'Ok') {
                return {
                  ctor: '_Tuple2',
                  _0: A2(_elm_lang$core$Basics_ops['++'], _p336, {
                    ctor: '::',
                    _0: {
                      ctor: '_Tuple2',
                      _0: _p331._0._1,
                      _1: { ctor: '_Tuple2', _0: _p337, _1: _p331._0._0 },
                    },
                    _1: { ctor: '[]' },
                  }),
                  _1: _p335,
                ...
                var errorDetails = (function() {
                  ...
                  switch (_p332.ctor) {
                    ...
                    case 'NetworkError':
                      return 'NetworkError';
                    case 'BadStatus':
                      var _p333 = _p332._0.status;
                      return A2(
                        _elm_lang$core$Basics_ops['++'],
                        'BadStatus ',
                        A2(
                          _elm_lang$core$Basics_ops['++'],
                          _elm_lang$core$Basics$toString(_p333.code),
                          A2(
                            _elm_lang$core$Basics_ops['++'],
                            ' ',
                            _p333.message
                    ...
                    default:
                      var _p334 = _p332._1.status;
                      return A2(
                        _elm_lang$core$Basics_ops['++'],
                        'BadPayload ',
                        A2(
                          _elm_lang$core$Basics_ops['++'],
                          _elm_lang$core$Basics$toString(_p334.code),
                          A2(
                            _elm_lang$core$Basics_ops['++'],
                            ' ',
                            _p334.message
                ...
                return {
                  ctor: '_Tuple2',
                  _0: _p336,
                  _1: A2(_elm_lang$core$Basics_ops['++'], _p335, {
                    ctor: '::',
                    _0: { ctor: '_Tuple2', _0: _p337, _1: errorDetails },
                    _1: { ctor: '[]' },
                  }),
                };
              }
          ...
          var successes = _p326._0;
          var failures = _p326._1;
          ...
          return {
            ctor: '_Tuple2',
            _0: A2(
              _user$project$Indexer$addLoadedPackageDocs,
              loadedPackageDocs,
              model
            ),
            _1: _elm_lang$core$Platform_Cmd$batch(
              A2(
                ...
                _elm_lang$core$Native_Utils.cmp(
                  ...
                  ? A2(
                      ...
                      (function() {
                        var projectDirectories = _elm_lang$core$Dict$keys(
                          model.projectFileContentsDict
                        );
                        ...
                        return _elm_lang$core$Native_Utils.cmp(
                          ...
                          ? {
                              ...
                              _0: _user$project$Indexer$dependenciesNotFoundCmd(
                                {
                                  ctor: '_Tuple2',
                                  _0: projectDirectories,
                                  _1: notFoundDependencies,
                                }
                              ),
                              _1: { ctor: '[]' },
                            }
      ...
      case 'DocsRead':
        var loadedPackageDocs = A2(
          ...
          function(_p342) {
            ...
            return A2(
              ...
              _user$project$Indexer$toPackageUri(_p343._0),
              _p343._1
            );
          },
          _p325._0
        ...
        return {
          ...
          _1: _user$project$Indexer$docsReadCmd({ ctor: '_Tuple0' }),
        };
      case 'UpdateActiveTokenHints':
        return A3(
          _user$project$Indexer$doUpdateActiveTokenHints,
          _p325._0._0,
          _p325._0._1,
          model
        );
      case 'UpdateActiveFile':
        return A4(
          _user$project$Indexer$doUpdateActiveFile,
          _p325._0._0,
          _p325._0._1,
          _p325._0._2,
          model
      ...
      case 'UpdateFileContents':
        return A4(
          _user$project$Indexer$doUpdateFileContents,
          _p325._0,
          _p325._1,
          _p325._2,
          model
      ...
      case 'RemoveFileContents':
        return A3(
          _user$project$Indexer$doRemoveFileContents,
          _p325._0._0,
          _p325._0._1,
          model
        );
      case 'UpdateProjectDependencies':
        return A3(
          _user$project$Indexer$doUpdateProjectDependencies,
          _p325._0._0,
          _p325._0._1,
          model
        );
      case 'DownloadMissingPackageDocs':
        return A2(
          _user$project$Indexer$doDownloadMissingPackageDocs,
          _p325._0,
          model
        );
      case 'GoToDefinition':
        return A3(
          _user$project$Indexer$doGoToDefinition,
          _p325._0._0,
          _p325._0._1,
          model
        );
      case 'AskCanGoToDefinition':
        return A3(
          _user$project$Indexer$doAskCanGoToDefinition,
          _p325._0._0,
          _p325._0._1,
          model
        );
      case 'ShowGoToSymbolView':
        return A3(
          _user$project$Indexer$doShowGoToSymbolView,
          _p325._0._0,
          _p325._0._1,
          model
        );
      case 'GetHintsForPartial':
        return A8(
          _user$project$Indexer$doGetHintsForPartial,
          _p325._0._0,
          _p325._0._1,
          _p325._0._2,
          _p325._0._3,
      ...
      case 'GetSuggestionsForImport':
        return A3(
          _user$project$Indexer$doGetSuggestionsForImport,
          _p325._0._0,
          _p325._0._1,
          model
        );
      case 'GetImporterSourcePathsForToken':
        return A4(
          _user$project$Indexer$doGetImporterSourcePathsForToken,
          _p325._0._0,
          _p325._0._1,
          _p325._0._2,
          model
      ...
      case 'ShowAddImportView':
        return A3(
          _user$project$Indexer$doShowAddImportView,
          _p325._0._0,
          _p325._0._1,
          model
        );
      case 'AddImport':
        return A5(
          _user$project$Indexer$doAddImport,
          _p325._0._0,
          _p325._0._1,
          _p325._0._2,
          _p325._0._3,
      ...
      case 'ConstructFromTypeAnnotation':
        return A2(
          _user$project$Indexer$doConstructFromTypeAnnotation,
          _p325._0,
          model
        );
      case 'ConstructCaseOf':
        return A2(_user$project$Indexer$doConstructCaseOf, _p325._0, model);
      case 'ConstructDefaultValueForType':
        return A2(
          _user$project$Indexer$doConstructDefaultValueForType,
          _p325._0,
          model
        );
      case 'ConstructDefaultArguments':
        return A2(
          _user$project$Indexer$doConstructDefaultArguments,
          _p325._0,
          model
        );
      case 'InferenceEntered':
        return {
          ...
          _1: _user$project$Indexer$activeTokenHintsChangedCmd(
            A2(
              ...
              _user$project$Indexer$inferenceToHints(_p325._0)
            )
          ),
        };
      case 'ConfigChanged':
        return {
          ctor: '_Tuple2',
          _0: _elm_lang$core$Native_Utils.update(model, { config: _p325._0 }),
          _1: _elm_lang$core$Platform_Cmd$none,
        };
      case 'GetAliasesOfType':
        return A2(_user$project$Indexer$doGetAliasesOfType, _p325._0, model);
      case 'ClearLocalHintsCache':
        return {
          ctor: '_Tuple2',
          _0: _elm_lang$core$Native_Utils.update(model, {
            hintsCache: (function() {
              var _p344 = model.hintsCache;
              if (_p344.ctor === 'Just') {
                return _elm_lang$core$Maybe$Just(
                  _elm_lang$core$Native_Utils.update(_p344._0, {
      ...
      default:
        return A5(
          _user$project$Indexer$doGetTokenInfo,
          _p325._0._0,
          _p325._0._1,
          _p325._0._2,
          _p325._0._3,
  ...
  var _user$project$Indexer$subscriptions = function(model) {
    return _elm_lang$core$Platform_Sub$batch({
      ctor: '::',
      _0: _user$project$Indexer$activeTokenChangedSub(
        _user$project$Indexer$UpdateActiveTokenHints
      ),
      _1: {
        ctor: '::',
        _0: _user$project$Indexer$activeFileChangedSub(
          _user$project$Indexer$UpdateActiveFile
        ),
        _1: {
          ctor: '::',
          _0: _user$project$Indexer$fileContentsChangedSub(function(_p345) {
            var _p346 = _p345;
            var _p347 = _p346._2;
            var encodedValues = _p347.values;
            var decodeValue = function(encoded) {
              return _elm_lang$core$Native_Utils.update(encoded, {
                associativity: _user$project$Indexer$decodeAssociativity(
                  encoded.associativity
                ),
              });
            };
            var moduleDocs = _elm_lang$core$Native_Utils.update(_p347, {
              values: _elm_lang$core$Native_Utils.update(encodedValues, {
                values: A2(
                  _elm_lang$core$List$map,
                  decodeValue,
            ...
            return A3(
              ...
              A2(
                ...
                moduleDocs,
                _user$project$Indexer$toImportDict(_p346._3)
              )
            );
          }),
          _1: {
            ctor: '::',
            _0: _user$project$Indexer$fileContentsRemovedSub(
              _user$project$Indexer$RemoveFileContents
            ),
            _1: {
              ctor: '::',
              _0: _user$project$Indexer$projectDependenciesChangedSub(
                _user$project$Indexer$UpdateProjectDependencies
              ),
              _1: {
                ctor: '::',
                _0: _user$project$Indexer$downloadMissingPackageDocsSub(
                  _user$project$Indexer$DownloadMissingPackageDocs
                ),
                _1: {
                  ctor: '::',
                  _0: _user$project$Indexer$docsReadSub(
                    _user$project$Indexer$DocsRead
                  ),
                  _1: {
                    ctor: '::',
                    _0: _user$project$Indexer$goToDefinitionSub(
                      _user$project$Indexer$GoToDefinition
                    ),
                    _1: {
                      ctor: '::',
                      _0: _user$project$Indexer$askCanGoToDefinitionSub(
                        _user$project$Indexer$AskCanGoToDefinition
                      ),
                      _1: {
                        ctor: '::',
                        _0: _user$project$Indexer$showGoToSymbolViewSub(
                          _user$project$Indexer$ShowGoToSymbolView
                        ),
                        _1: {
                          ctor: '::',
                          _0: _user$project$Indexer$getHintsForPartialSub(
                            _user$project$Indexer$GetHintsForPartial
                          ),
                          _1: {
                            ctor: '::',
                            _0: _user$project$Indexer$getSuggestionsForImportSub(
                              _user$project$Indexer$GetSuggestionsForImport
                            ),
                            _1: {
                              ctor: '::',
                              _0: _user$project$Indexer$getImportersForTokenSub(
                                _user$project$Indexer$GetImporterSourcePathsForToken
                              ),
                              _1: {
                                ctor: '::',
                                _0: _user$project$Indexer$showAddImportViewSub(
                                  _user$project$Indexer$ShowAddImportView
                                ),
                                _1: {
                                  ctor: '::',
                                  _0: _user$project$Indexer$addImportSub(
                                    _user$project$Indexer$AddImport
                                  ),
                                  _1: {
                                    ctor: '::',
                                    _0: _user$project$Indexer$constructFromTypeAnnotationSub(
                                      _user$project$Indexer$ConstructFromTypeAnnotation
                                    ),
                                    _1: {
                                      ctor: '::',
                                      _0: _user$project$Indexer$constructCaseOfSub(
                                        _user$project$Indexer$ConstructCaseOf
                                      ),
                                      _1: {
                                        ctor: '::',
                                        _0: _user$project$Indexer$constructDefaultValueForTypeSub(
                                          _user$project$Indexer$ConstructDefaultValueForType
                                        ),
                                        _1: {
                                          ctor: '::',
                                          _0: _user$project$Indexer$constructDefaultArgumentsSub(
                                            _user$project$Indexer$ConstructDefaultArguments
                                          ),
                                          _1: {
                                            ctor: '::',
                                            _0: _user$project$Indexer$inferenceEnteredSub(
                                              _user$project$Indexer$InferenceEntered
                                            ),
                                            _1: {
                                              ctor: '::',
                                              _0: _user$project$Indexer$configChangedSub(
                                                _user$project$Indexer$ConfigChanged
                                              ),
                                              _1: {
                                                ctor: '::',
                                                _0: _user$project$Indexer$getAliasesOfTypeSub(
                                                  _user$project$Indexer$GetAliasesOfType
                                                ),
                                                _1: {
                                                  ctor: '::',
                                                  ...
                                                  _1: {
                                                    ctor: '::',
                                                    _0: _user$project$Indexer$getTokenInfoSub(
                                                      _user$project$Indexer$GetTokenInfo
                                                    ),
                                                    _1: { ctor: '[]' },
                                                  },
                                                },
