...
export default {
  sendFileContentsChanged(indexer, filePath) {
    ...
    console.log('sendFileContentsChanged', performance.now() - startTime); // // //
  },

  sendFileContentsRemoved(indexer, filePath, projectDirectory) {
    const startTime = performance.now(); // // //
    indexer.fileContentsRemoved([filePath, projectDirectory]);
    console.log('sendFileContentsRemoved', performance.now() - startTime); // // //
  },
  ...
  sendActiveFile(indexer, editor) {
    ...
    console.log('sendActiveFile', performance.now() - startTime); // // //
  },
  ...
  sendActiveEditorContents(indexer, editor) {
    ...
    console.log('sendActiveEditorContents', performance.now() - startTime); // // //
  },
  ...
  sendActiveTextAndToken(indexer, editor) {
    ...
    console.log('sendActiveTextAndToken', performance.now() - startTime); // // //
  },
  ...
  sendActiveToken(indexer, editor) {
    ...
    console.log('sendActiveToken', performance.now() - startTime); // // //
  },
  ...
  sendToken(indexer, editor, position, token) {
    ...
    console.log('sendToken', performance.now() - startTime); // // //
  },

  sendEnteredInference(indexer, inference) {
    const startTime = performance.now(); // // //
    indexer.inferenceEntered(inference);
    console.log('sendEnteredInference', performance.now() - startTime); // // //
  },
  ...
  sendProjectDependencies(indexer, projectDirectory, workDirectory) {
    ...
    if (exactDependenciesJson && exactDependenciesJson instanceof Object) {
      ...
      updatedDependencies = _.pairs(elmPackageJson.dependencies).map(
    ...
    console.log('sendProjectDependencies', performance.now() - startTime); // // //
  },
