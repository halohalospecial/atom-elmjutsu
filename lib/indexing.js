...
export default {
  sendFileContentsChanged(indexer, filePath) {
    ...
    helper.debugLog(
      'sendFileContentsChanged ' + (performance.now() - startTime) + ' ms'
    );
  },
  ...
  sendFileContentsRemoved(indexer, filePath, projectDirectory) {
    ...
    helper.debugLog(
      'sendFileContentsRemoved ' + (performance.now() - startTime) + ' ms'
    );
  },
  ...
  sendActiveFile(indexer, editor) {
    ...
    helper.debugLog(
      'sendActiveFile ' + (performance.now() - startTime) + ' ms'
    );
  },
  ...
  sendActiveEditorContents(indexer, editor) {
    ...
    helper.debugLog(
      'sendActiveEditorContents ' + (performance.now() - startTime) + ' ms'
    );
  },
  ...
  sendActiveTextAndToken(indexer, editor) {
    ...
    helper.debugLog(
      'sendActiveTextAndToken ' + (performance.now() - startTime) + ' ms'
    );
  },
  ...
  sendActiveToken(indexer, editor) {
    ...
    helper.debugLog(
      'sendActiveToken ' + (performance.now() - startTime) + ' ms'
    );
  },
  ...
  sendToken(indexer, editor, position, token) {
    ...
    helper.debugLog('sendToken ' + (performance.now() - startTime) + ' ms');
  },
  ...
  sendEnteredInference(indexer, inference) {
    ...
    helper.debugLog(
      'sendEnteredInference ' + (performance.now() - startTime) + ' ms'
    );
  },
  ...
  sendProjectDependencies(indexer, projectDirectory, workDirectory) {
    ...
    helper.debugLog(
      'sendProjectDependencies ' + (performance.now() - startTime) + ' ms'
    );
  },
