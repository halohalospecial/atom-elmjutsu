...
export default class Sidekick {
  ...
  constructor(indexer) {
    ...
    this.subscriptions.add(atom.config.observe('elmjutsu.showTypesInSidekick', () => {
      this.view.updateConfig(getConfig());
    }));
    this.subscriptions.add(atom.config.observe('elmjutsu.showDocCommentsInSidekick', () => {
      this.view.updateConfig(getConfig());
    }));
    this.subscriptions.add(atom.config.observe('elmjutsu.showSourcePathsInSidekick', () => {
      this.view.updateConfig(getConfig());
    }));
  }
