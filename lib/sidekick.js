...
export default class Sidekick {
  ...
  constructor(indexer) {
    ...
    this.subscriptions.add(atom.workspace.observeActivePaneItem((item) => {
      if (item && (helper.isElmEditor(item) || item.getURI() === helper.usagesViewURI() )) {
...
function getConfig() {
  return {
    showTypes: atom.config.get('elmjutsu.showTypesInSidekick'),
    showTypeCases: atom.config.get('elmjutsu.showTypeCasesInSidekick'),
    showDocComments: atom.config.get('elmjutsu.showDocCommentsInSidekick'),
    showAssociativities: atom.config.get('elmjutsu.showAssociativitiesInSidekick'),
    showPrecedences: atom.config.get('elmjutsu.showPrecedencesInSidekick'),
    showAliasesOfType: atom.config.get('elmjutsu.showAliasesOfTypesInSidekick'),
    showSourcePaths: atom.config.get('elmjutsu.showSourcePathsInSidekick'),
  };
}
