...
export default {
  ...
  insertHtmlProgramCompletionEnabled: {
    title: 'Enable `Insert Html program` special completion',
    description:
      'This will activate by typing `program` or `Html.program` in an empty editor.',
    type: 'boolean',
    default: true,
    order: 10,
  },
