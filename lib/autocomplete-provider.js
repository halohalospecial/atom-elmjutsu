    ...
    getSuggestions({editor, bufferPosition}) {
      ...
      return new Promise(resolve => {
        ...
        const getHintsForPartialPromise = new Promise((resolve) => {
          ...
          return getHintsForPartial(partial, suffix, typeAwareAutocompleteEnabled && inferredType ? inferredType : null , preceedingToken, succeedingToken, isRegex, indexer, editor, bufferPosition, resolve);
        });
...
function getHintsForPartial(partial, suffix, inferredType, preceedingToken, succeedingToken, isRegex, indexer, editor, triggerPosition, resolve) {
  ...
  const hintsForPartialReceived = ([partial, hints]) => {
    ...
    if (autocompleteFuzzyFilteringEnabled && !isRegex && (!inferredType || (inferredType && partial !== ''))) {
