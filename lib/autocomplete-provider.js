...
export function provide(indexer, shouldGetSuggestionsFunction) {
    ...
    getSuggestions({editor, bufferPosition}) {
      ...
      return new Promise(resolve => {
        ...
        const getHintsForPartialPromise = new Promise((resolve) => {
          ...
          return getHintsForPartial(helper.getToken(editor), preceedingToken, succeedingToken, indexer, editor, bufferPosition, resolve);
        });
...
function getHintsForPartial(partial, preceedingToken, succeedingToken, indexer, editor, triggerPosition, resolve) {
