...
function getSuggestionsForImport(prefix, partial, indexer, resolve) {
  ...
  indexer.ports.getSuggestionsForImportSub.send([partial, !atom.config.get('elmjutsu.autocompleteFuzzyFilteringEnabled')]);
}
...
function getHintsForPartial(partial, suffix, inferredType, preceedingToken, succeedingToken, isRegex, indexer, editor, triggerPosition, resolve) {
  ...
  indexer.ports.getHintsForPartialSub.send([partial, inferredType, preceedingToken, isRegex, !atom.config.get('elmjutsu.autocompleteFuzzyFilteringEnabled'), atom.config.get('elmjutsu.globalAutocompleteEnabled')]);
}
