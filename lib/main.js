...
export default {
  ...
  activate() {
    ...
    this.subscriptions.add(atom.commands.add('atom-text-editor:not([mini])[data-grammar^="source elm"]', {
      ...
      'elmjutsu:watch-selection': () => this.liveDebug.watchSelectionCommand(),
      'elmjutsu:unwatch-selection': () => this.liveDebug.unwatchSelectionCommand(),
      'elmjutsu:unwatch-all': () => this.liveDebug.unwatchAllCommand(),
      'elmjutsu:compile-with-watches': () => this.liveDebug.compileWithWatchesCommand(),
    }));
