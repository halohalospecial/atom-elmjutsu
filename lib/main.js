...
export default {
  ...
  activate() {
    ...
    this.subscriptions.add(atom.commands.add('atom-text-editor:not([mini])[data-grammar^="source elm"]', {
      ...
      'elmjutsu:infer-hole-types': () => this.inferTypes.inferHoleTypesCommand(), // Detonate type bombs.
  ...
  provideAutocomplete() {
    ...
    return require('./autocomplete-provider').provide(this.core.getIndexer(), shouldGetSuggestions);
  },
