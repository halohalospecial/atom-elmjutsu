...
export default {
  ...
  htmlEncode(html) {
    // TODO: Find better way to encode html.
    return document.createElement('a').appendChild(document.createTextNode(html.replace(/ /g, '%20'))).parentNode.innerHTML.replace(/%20/g, '&nbsp;');
  }
