...
export default {
  getToken(editor) {
    ...
    const token = editor
      ...
      .trim();
    console.log('getToken', performance.now() - startTime); // // //
  ...
  getActiveTopLevel(editor, position) {
    ...
    console.log('getActiveTopLevel', performance.now() - startTime); // // //
  ...
  getActiveRecordVariable(editor, position) {
    ...
    console.log('getActiveRecordVariable', performance.now() - startTime); // // //
