...
export default {
  ...
  // // If the token is "A.B.C.foo" and the cursor is after the last period, return "foo".
  ...
  //   const startPoint = cursor.getBeginningOfCurrentWordBufferPosition({wordRegex: this.tokenRegex()});
  //   if (!startPoint) {
  //     return '';
  //   }
