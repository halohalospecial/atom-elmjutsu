...
(function() {
  ...
  var _user$project$Indexer$doUpdateFileContents = F4(function(
    ...
    var updatedHintsCache = (function() {
      var _p263 = model.hintsCache;
      if (_p263.ctor === 'Just') {
        var _p267 = _p263._0;
        var _p264 = _p267.external;
        if (_p264.ctor === 'Just') {
          var _p265 = model.activeFile;
          if (_p265.ctor === 'Just') {
            var _p266 = _p265._0;
            var newFileContentsDict = A2(
              _user$project$Indexer$getFileContentsOfProject,
              _p266.projectDirectory,
              updatedProjectFileContentsDict
            );
            ...
            return _elm_lang$core$Native_Utils.eq(_p266.filePath, filePath) &&
              !_elm_lang$core$Native_Utils.eq(
                oldActiveFileContents.imports,
                newActiveFileContents.imports
              )
              ? _elm_lang$core$Maybe$Just(
                  _elm_lang$core$Native_Utils.update(_p267, {
  ...
  var _user$project$Indexer$getSourcePathOfRecordFieldTokenRecur = F7(function(
    ...
    getSourcePathOfRecordFieldTokenRecur: while (true) {
      ...
      var _p289 = _p272._3;
      var _p288 = _p272._0;
      var _p273 = _elm_lang$core$List$head(tailParts);
      if (_p273.ctor === 'Just') {
        var _p287 = _p273._0;
        ...
        var newPrefixSourcePath = (function() {
          var _p274 = _elm_lang$core$List$head(
            A2(
              _user$project$Indexer$getHintsForToken,
          ...
          if (_p274.ctor === 'Just') {
            var _p277 = _p274._0;
            if (_user$project$Indexer$isRecordString(_p277.tipe)) {
              return A2(
                _elm_lang$core$Basics_ops['++'],
                parentSourcePath,
                A2(
              ...
              var _p275 = _elm_lang$core$List$head(
                A2(
                  _user$project$Indexer$getHintsForToken,
                  _elm_lang$core$Maybe$Just(_p277.tipe),
                  tokens
                )
              );
              if (_p275.ctor === 'Just') {
        ...
        var _p282 = (function() {
          ...
          if (
            ...
            var _p286 = _p283._1._0;
            var maybeNewActiveFile = (function() {
              var _p284 = _p288;
              if (_p284.ctor === 'Just') {
                return _elm_lang$core$Maybe$Just(
                  _elm_lang$core$Native_Utils.update(_p284._0, {
                    filePath: _p286,
                  })
                );
              } else {
            ...
            var _p285 = maybeNewActiveFile;
            if (_p285.ctor === 'Just') {
              return !_elm_lang$core$Native_Utils.eq(_p283._0._0, _p286) &&
                _user$project$Indexer$isProjectSourcePath(_p286)
                ? {
                    ctor: '_Tuple2',
                    _0: maybeNewActiveFile,
                    _1: A5(
                ...
                : { ctor: '_Tuple2', _0: _p288, _1: tokens };
            } else {
              return { ctor: '_Tuple2', _0: _p288, _1: tokens };
            }
          } else {
            return { ctor: '_Tuple2', _0: _p288, _1: tokens };
          }
        })();
        var updatedActiveFile = _p282._0;
        var updatedTokens = _p282._1;
        var _v184 = _p287,
          _v185 = A2(
            _elm_lang$core$Basics_ops['++'],
            parentName,
            A2(_elm_lang$core$Basics_ops['++'], '.', _p287)
          ),
          _v186 = newPrefixSourcePath,
          _v187 = A2(
            _elm_lang$core$Maybe$withDefault,
            { ctor: '[]' },
          ...
          _v189 = rootTokens,
          _v190 = updatedTokens;
        parentPartName = _v184;
        parentName = _v185;
        parentSourcePath = _v186;
        tailParts = _v187;
        _p271 = _v188;
        rootTokens = _v189;
        tokens = _v190;
  ...
  var _user$project$Indexer$getSourcePathOfRecordFieldToken = F5(function(
    ...
    if (_elm_lang$core$Native_Utils.eq(_elm_lang$core$List$length(parts), 1)) {
      ...
      var _p295 = _elm_lang$core$List$head(parts);
      if (_p295.ctor === 'Just') {
        var _p296 = _p295._0;
        return A7(
      ...
      A2(
        ...
        function(_p302) {
          ...
          var formatExposedSymbol = function(token) {
            ...
            var _p305 = _elm_lang$core$List$head(hints);
            if (_p305.ctor === 'Just') {
              var _p306 = _p305._0.caseTipe;
              if (_p306.ctor === 'Just') {
                return A2(
                  _elm_lang$core$Basics_ops['++'],
                  _p306._0,
            ...
            if (_p310.ctor === 'Just') {
              return A2(
                ...
                A2(
                  _elm_lang$core$Basics_ops['++'],
                  _p311,
                  A2(_elm_lang$core$Basics_ops['++'], ' as ', _p310._0)
                )
              );
            } else {
              return A2(_elm_lang$core$Basics_ops['++'], 'import ', _p311);
            }
          })();
  ...
  var _user$project$Indexer$doAddImport = F5(function(
    ...
    var updatedImports = A2(
      ...
      (function() {
        ...
        if (_p312.ctor === 'Just') {
          var _p319 = _p312._0;
          var _p313 = maybeSymbolName;
          if (_p313.ctor === 'Just') {
            var _p318 = _p313._0;
            var _p314 = _p319.exposed;
            switch (_p314.ctor) {
              case 'All':
                return fileContents.imports;
              case 'Some':
                return _elm_lang$core$Native_Utils.eq(_p318, '..')
                  ? A3(
                      _elm_lang$core$Dict$update,
                      moduleName,
                      function(_p315) {
                        return _elm_lang$core$Maybe$Just(
                          _elm_lang$core$Native_Utils.update(_p319, {
                            exposed: _user$project$Indexer$All,
                          })
                        );
                      },
                        ...
                        return _elm_lang$core$Maybe$Just(
                          _elm_lang$core$Native_Utils.update(_p319, {
                            exposed: _user$project$Indexer$Some(
                              A2(_elm_lang$core$Set$insert, _p318, _p314._0)
                            ),
                          })
                        );
                      },
                ...
                return A3(
                  ...
                  function(_p317) {
                    return _elm_lang$core$Maybe$Just(
                      _elm_lang$core$Native_Utils.update(_p319, {
                        exposed: _user$project$Indexer$Some(
                          _elm_lang$core$Set$singleton(_p318)
                        ),
                      })
                    );
                  },
          ...
          var importToAdd = (function() {
            var _p320 = maybeSymbolName;
            if (_p320.ctor === 'Just') {
              return {
                alias: _elm_lang$core$Maybe$Nothing,
                exposed: _user$project$Indexer$Some(
                  _elm_lang$core$Set$singleton(_p320._0)
                ),
              };
            } else {
              return {
  ...
  var _user$project$Indexer$update = F2(function(msg, model) {
    ...
    switch (_p321.ctor) {
      case 'MaybeDocsDownloaded':
        if (_p321._1.ctor === 'Err') {
          return {
            ctor: '_Tuple2',
            _0: model,
            _1: _user$project$Indexer$downloadDocsFailedCmd(
              _elm_lang$core$Basics$toString(_p321._1._0)
            ),
          };
        } else {
          var _p322 = A3(
            _elm_lang$core$List$foldl,
            F2(function(_p324, _p323) {
              var _p325 = _p324;
              var _p333 = _p325._0;
              var _p326 = _p323;
              var _p332 = _p326._0;
              ...
              if (_p327.ctor === 'Ok') {
                return {
                  ctor: '_Tuple2',
                  _0: A2(_elm_lang$core$Basics_ops['++'], _p332, {
                    ctor: '::',
                    _0: {
                      ctor: '_Tuple2',
                      _0: _p327._0._1,
                      _1: { ctor: '_Tuple2', _0: _p333, _1: _p327._0._0 },
                    },
                    _1: { ctor: '[]' },
                  }),
                  _1: _p331,
                ...
                var errorDetails = (function() {
                  ...
                  switch (_p328.ctor) {
                    ...
                    case 'NetworkError':
                      return 'NetworkError';
                    case 'BadStatus':
                      var _p329 = _p328._0.status;
                      return A2(
                        _elm_lang$core$Basics_ops['++'],
                        'BadStatus ',
                        A2(
                          _elm_lang$core$Basics_ops['++'],
                          _elm_lang$core$Basics$toString(_p329.code),
                          A2(
                            _elm_lang$core$Basics_ops['++'],
                            ' ',
                            _p329.message
                    ...
                    default:
                      var _p330 = _p328._1.status;
                      return A2(
                        _elm_lang$core$Basics_ops['++'],
                        'BadPayload ',
                        A2(
                          _elm_lang$core$Basics_ops['++'],
                          _elm_lang$core$Basics$toString(_p330.code),
                          A2(
                            _elm_lang$core$Basics_ops['++'],
                            ' ',
                            _p330.message
                ...
                return {
                  ctor: '_Tuple2',
                  _0: _p332,
                  _1: A2(_elm_lang$core$Basics_ops['++'], _p331, {
                    ctor: '::',
          ...
          var successes = _p322._0;
          var failures = _p322._1;
      ...
      case 'ConstructCaseOf':
        return A2(_user$project$Indexer$doConstructCaseOf, _p321._0, model);
      case 'ConstructDefaultValueForType':
        return A2(
        ...
        return {
          ...
          _1: _user$project$Indexer$activeTokenHintsChangedCmd(
            A2(
              ...
              _user$project$Indexer$inferenceToHints(_p321._0)
            )
          ),
        };
      case 'ConfigChanged':
        return {
          ctor: '_Tuple2',
          _0: _elm_lang$core$Native_Utils.update(model, { config: _p321._0 }),
          _1: _elm_lang$core$Platform_Cmd$none,
        };
      case 'GetAliasesOfType':
        return A2(_user$project$Indexer$doGetAliasesOfType, _p321._0, model);
      default:
        return {
          ctor: '_Tuple2',
          _0: _elm_lang$core$Native_Utils.update(model, {
            hintsCache: (function() {
              ...
              if (_p340.ctor === 'Just') {
                return _elm_lang$core$Maybe$Just(
                  _elm_lang$core$Native_Utils.update(_p340._0, {
  ...
  var _user$project$Indexer$subscriptions = function(model) {
    return _elm_lang$core$Platform_Sub$batch({
      ...
      _1: {
        ...
        _1: {
          ctor: '::',
          _0: _user$project$Indexer$fileContentsChangedSub(function(_p341) {
            var _p342 = _p341;
            var _p343 = _p342._2;
            ...
            var moduleDocs = _elm_lang$core$Native_Utils.update(_p343, {
