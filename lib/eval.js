...
// TODO: Use just one `elm-repl` process per project directory to make succeeding requests faster.  Also, use "readline"?
    ...
    if (helper.isElmEditor(editor)) {
      ...
      const proc = this.executeInRepl(projectDirectory, numOutputsToIgnore, (errString, outString) => {
        ...
        editor.transact(() => {
          ...
          selection.insertText(value, {select: true});
          // TODO: Maybe add a tooltip over the selection that displays the type?
        });
      });
