...
var _user$project$Sidekick$activeFileChangedSub = _elm_lang$core$Native_Platform.incomingPort(
...
var _user$project$Sidekick$docsReadSub = _elm_lang$core$Native_Platform.incomingPort(
	'docsReadSub',
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}));
var _user$project$Sidekick$docsDownloadedSub = _elm_lang$core$Native_Platform.incomingPort(
	'docsDownloadedSub',
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}));
...
var _user$project$Sidekick$readingPackageDocsSub = _elm_lang$core$Native_Platform.incomingPort(
	...
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}));
var _user$project$Sidekick$downloadingPackageDocsSub = _elm_lang$core$Native_Platform.incomingPort(
		...
		switch (_p2.ctor) {
			...
			case 'ReadingPackageDocs':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{note: 'Reading package docs...'}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'DownloadingPackageDocs':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
	...
	if (_p5.ctor === 'Nothing') {
		...
		var sourcePathView = function (hint) {
			return A2(
				...
				A2(_elm_lang$core$Basics_ops['++'], _user$project$Sidekick$packageDocsPrefix, '/'),
				hint.sourcePath) ? _elm_lang$core$Native_List.fromArray(
				[
					A2(
					_elm_lang$html$Html$span,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('icon-link-external')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							A2(_user$project$Sidekick$removePrefix, _user$project$Sidekick$packageDocsPrefix, hint.sourcePath))
						]))
				]) : _elm_lang$core$Native_List.fromArray(
				[
					A2(
	...
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Sidekick$activeFileChangedSub(_user$project$Sidekick$ActiveFileChanged),
				_user$project$Sidekick$docsReadSub(
				function (_p6) {
					return _user$project$Sidekick$DocsRead;
				}),
				_user$project$Sidekick$docsDownloadedSub(
				function (_p7) {
					return _user$project$Sidekick$DocsDownloaded;
				}),
				_user$project$Sidekick$downloadDocsFailedSub(
				function (_p8) {
					return _user$project$Sidekick$DownloadDocsFailed;
				}),
				_user$project$Sidekick$readingPackageDocsSub(
				function (_p9) {
					return _user$project$Sidekick$ReadingPackageDocs;
				}),
				_user$project$Sidekick$downloadingPackageDocsSub(
				function (_p10) {
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['Sidekick'], 'Sidekick', typeof _user$project$Sidekick$main === 'undefined' ? null : _user$project$Sidekick$main);
