		...
		var sourcePathView = function (hint) {
			return A2(
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('icon-link-external'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$a,
						{
							...
							_0: _elm_lang$html$Html_Attributes$title(
								A2(_elm_lang$core$Basics_ops['++'], 'Open in browser:\n', hint.sourcePath)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$href(hint.sourcePath),
								_1: {ctor: '[]'}
							}
						},
						{
				...
				_0: A2(
					_elm_lang$html$Html$a,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$title(
							A2(_elm_lang$core$Basics_ops['++'], 'Go to definition in\n', hint.sourcePath)),
						_1: {
							ctor: '::',
...
if (typeof _user$project$Sidekick$main !== 'undefined') {
    _user$project$Sidekick$main(Elm['Sidekick'], 'Sidekick', undefined);
}
