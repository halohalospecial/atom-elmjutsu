	...
	function (maybeToken, maybeActiveFile, tokens, fileContentsDict) {
		...
		if (((_p23.ctor === '_Tuple2') && (_p23._0.ctor === 'Just')) && (_p23._1.ctor === 'Just')) {
			...
			return A2(
				...
				function (_p24) {
					var _p25 = _p24;
					var _p30 = _p25.moduleDocs;
					var getSourcePathAndLocalNames = function (hint) {
						var _p26 = A2(_elm_lang$core$Dict$get, hint.moduleName, _p25.imports);
						if (_p26.ctor === 'Nothing') {
							return _elm_lang$core$Native_Utils.eq(hint.moduleName, _p30.name) ? _elm_lang$core$Maybe$Just(
								{
									ctor: '_Tuple2',
									_0: _p30.sourcePath,
									_1: _elm_lang$core$Native_List.fromArray(
							...
							var uniqueLocalNames = _elm_lang$core$Set$toList(
								_elm_lang$core$Set$fromList(localNames));
							var _p28 = uniqueLocalNames;
							if (_p28.ctor === '[]') {
								return _elm_lang$core$Maybe$Nothing;
							} else {
								return _elm_lang$core$Maybe$Just(
									{ctor: '_Tuple2', _0: _p30.sourcePath, _1: uniqueLocalNames});
							}
						}
					};
...
var _user$project$Indexer$moduleToHints = F2(
	function (_p32, _p31) {
		...
		var _p36 = _p33.name;
		var _p34 = _p31;
		var hint = {name: _p36, moduleName: '', sourcePath: _p33.sourcePath, comment: _p33.comment, tipe: '', caseTipe: _elm_lang$core$Maybe$Nothing, kind: _user$project$Indexer$KindModule};
		var _p35 = _p34.alias;
		if (_p35.ctor === 'Nothing') {
			return _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: _p36, _1: hint}
				]);
		} else {
			return _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: _p36, _1: hint},
					{ctor: '_Tuple2', _0: _p35._0, _1: hint}
				]);
		}
	});
var _user$project$Indexer$KindTypeCase = {ctor: 'KindTypeCase'};
var _user$project$Indexer$unionTagsToHints = F3(
	function (moduleDocs, _p38, _p37) {
		var _p39 = _p38;
		var _p40 = _p37;
		var _p41 = _p40.name;
		var addHints = F2(
			function (tag, hints) {
				var localName = A3(_user$project$Indexer$getLocalName, moduleDocs.name, _p39.alias, tag);
				var hint = {
					name: tag,
					moduleName: moduleDocs.name,
					sourcePath: A2(_user$project$Indexer$formatSourcePath, moduleDocs, _p41),
					comment: _p40.comment,
					tipe: _p40.tipe,
					caseTipe: _elm_lang$core$Maybe$Just(_p41),
				...
				return (A2(_elm_lang$core$Set$member, _p41, _user$project$Indexer$defaultTypes) || A2(_user$project$Indexer$isExposed, tag, _p39.exposed)) ? A2(
					_elm_lang$core$List_ops['::'],
...
var _user$project$Indexer$getProjectSymbols = F2(
	function (projectDirectory, fileContentsDict) {
		var allFileSymbols = A2(
			...
			function (_p42) {
				var _p43 = _p42;
				var _p45 = _p43.moduleDocs;
				var _p44 = _p45;
				var sourcePath = _p44.sourcePath;
				var values = _p44.values;
				var moduleDocsSymbol = {fullName: _p45.name, sourcePath: sourcePath, caseTipe: _elm_lang$core$Maybe$Nothing, kind: _user$project$Indexer$KindModule};
				var valueSymbols = A2(
					_elm_lang$core$List$map,
					function (value) {
						...
						return {
							...
							sourcePath: A2(_user$project$Indexer$formatSourcePath, _p45, value.name),
							caseTipe: _elm_lang$core$Maybe$Nothing,
							kind: kind
						};
					},
				...
				var tipeSymbols = A2(
					...
					function (tipe) {
						return {
							...
							sourcePath: A2(_user$project$Indexer$formatSourcePath, _p45, tipe.name),
							caseTipe: _elm_lang$core$Maybe$Nothing,
						...
						return A2(
							...
							function (caseName) {
								return {
									...
									sourcePath: A2(_user$project$Indexer$formatSourcePath, _p45, caseName),
		...
		return A2(
			...
			function (_p46) {
				var _p47 = _p46;
				var _p48 = _p47.sourcePath;
				return _elm_lang$core$Basics$not(
					A2(_elm_lang$core$String$startsWith, _user$project$Indexer$packageDocsPrefix, _p48)) && A2(_user$project$Indexer$isSourcePathInProjectDirectory, projectDirectory, _p48);
			},
			allFileSymbols);
	});
...
var _user$project$Indexer$toImport = function (_p49) {
	var _p50 = _p49;
	var exposedSet = function () {
		var _p51 = _p50.exposed;
		if (_p51.ctor === 'Nothing') {
			return _user$project$Indexer$None;
		} else {
			if (((_p51._0.ctor === '::') && (_p51._0._0 === '..')) && (_p51._0._1.ctor === '[]')) {
				return _user$project$Indexer$All;
			} else {
				return _user$project$Indexer$Some(
					_elm_lang$core$Set$fromList(_p51._0));
			}
		}
	}();
	return {
		ctor: '_Tuple2',
		_0: _p50.name,
		_1: A2(_user$project$Indexer$Import, _p50.alias, exposedSet)
	};
};
...
var _user$project$Indexer$getActiveFileContents = F2(
	function (maybeActiveFile, fileContentsDict) {
		var _p52 = maybeActiveFile;
		if (_p52.ctor === 'Nothing') {
			return _user$project$Indexer$emptyFileContents;
		} else {
			var _p53 = A2(_elm_lang$core$Dict$get, _p52._0.filePath, fileContentsDict);
			if (_p53.ctor === 'Just') {
				return _p53._0;
			} else {
				return _user$project$Indexer$emptyFileContents;
		...
		if (_p54.ctor === 'Nothing') {
			...
			var importedModuleDocs = A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					packageDocs,
					A2(_user$project$Indexer$getProjectModuleDocs, _p54._0.projectDirectory, fileContentsDict)));
				...
				A2(
					...
					function (moduleDocs) {
						var exposed = function () {
							var _p55 = A2(_elm_lang$core$Dict$get, moduleDocs.name, importsPlusActiveModule);
							if (_p55.ctor === 'Nothing') {
								return _user$project$Indexer$None;
							} else {
								return _p55._0.exposed;
							}
						}();
						return A2(
							_elm_lang$core$List$map,
							...
							A2(
								...
								A2(
									...
									A2(
										...
										function (_p56) {
											var _p57 = _p56;
											return A2(_user$project$Indexer$isExposed, _p57.name, exposed);
										},
										A2(
											_elm_lang$core$Basics_ops['++'],
											moduleDocs.values.aliases,
								...
								A2(
									...
									function (_p58) {
										...
										return A2(
											_elm_lang$core$List$filter,
											function (kase) {
												return A2(_elm_lang$core$Set$member, _p59.name, _user$project$Indexer$defaultTypes) || A2(_user$project$Indexer$isExposed, kase, exposed);
											},
											_p59.cases);
									},
									moduleDocs.values.tipes)));
...
var _user$project$Indexer$getHintsForPartial = F5(
	function (partial, activeFile, fileContentsDict, packageDocs, tokens) {
		var defaultHints = A2(
			...
			function (_p60) {
				var _p61 = _p60;
				return A2(_elm_lang$core$String$startsWith, partial, _p61.name);
			},
		...
		var importAliases = A2(
			...
			function (_p62) {
				...
				if (_p64.ctor === 'Nothing') {
					...
					var _p65 = _p64._0;
					return A2(_elm_lang$core$String$startsWith, partial, _p65) ? _elm_lang$core$Maybe$Just(
						_elm_lang$core$Native_Utils.update(
							_user$project$Indexer$emptyHint,
							{name: _p65})) : _elm_lang$core$Maybe$Nothing;
				}
			},
					...
					if (_elm_lang$core$Native_Utils.eq(hint.moduleName, '')) {
						...
						if (A2(
							...
							var moduleNamePrefix = function () {
								var _p66 = A2(_elm_lang$core$Dict$get, hint.moduleName, activeFileContents.imports);
								if (_p66.ctor === 'Nothing') {
									return '';
								} else {
									var _p67 = _p66._0.alias;
									if (_p67.ctor === 'Nothing') {
										return A2(_elm_lang$core$Basics_ops['++'], hint.moduleName, '.');
									} else {
										return A2(_elm_lang$core$Basics_ops['++'], _p67._0, '.');
									}
								}
							}();
				...
				_elm_lang$core$List$concat(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							packageDocsList,
							A2(_user$project$Indexer$getProjectModuleDocs, _p68._0.projectDirectory, fileContentsDict)))));
		}
	});
var _user$project$Indexer$update = F2(
	function (msg, model) {
		...
		switch (_p71.ctor) {
			...
			case 'DocsLoaded':
				...
				var missingPackageDocs = A2(
					...
					function (_p73) {
						var _p74 = _p73;
						return _elm_lang$core$Basics$not(
							A2(_elm_lang$core$List$member, _p74.sourcePath, existingPackages));
					},
					_p71._0);
			...
			case 'CursorMove':
				var updatedActiveHints = A2(_user$project$Indexer$getHintsForToken, _p71._0, model.activeTokens);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'UpdateActiveFile':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							activeFile: _p75,
							activeTokens: A3(_user$project$Indexer$toTokenDict, _p75, model.fileContentsDict, model.packageDocs)
						}),
					_1: _user$project$Indexer$activeFileChangedCmd(_p75)
				};
			case 'UpdateFileContents':
				var updatedFileContentsDict = A3(
					...
					_p71._0,
					_elm_lang$core$Basics$always(
						_elm_lang$core$Maybe$Just(_p71._1)),
			...
			case 'RemoveFileContents':
				var updatedFileContentsDict = A2(_elm_lang$core$Dict$remove, _p71._0, model.fileContentsDict);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'UpdatePackageDocs':
				...
				var missingPackages = A2(
					...
					A2(_elm_lang$core$List$map, _user$project$Indexer$toPackageUri, _p71._0));
				return {
					ctor: '_Tuple2',
					_0: model,
			...
			case 'GoToDefinition':
				var requests = A2(
					...
					A2(_user$project$Indexer$getHintsForToken, _p71._0, model.activeTokens));
				return {
					ctor: '_Tuple2',
					_0: model,
			...
			case 'GoToSymbol':
				...
				if (_p76.ctor === 'Nothing') {
					...
					var hints = A2(_user$project$Indexer$getHintsForToken, _p80, model.activeTokens);
						...
						_1: _user$project$Indexer$goToSymbolCmd(
							{
								...
								_2: A2(
									...
									A2(_user$project$Indexer$getProjectSymbols, _p76._0, model.fileContentsDict))
							})
					};
				}
					...
					_1: _user$project$Indexer$hintsForPartialReceivedCmd(
						{
							...
							_1: A2(
								...
								A5(_user$project$Indexer$getHintsForPartial, _p81, model.activeFile, model.fileContentsDict, model.packageDocs, model.activeTokens))
						})
				};
					...
					_1: _user$project$Indexer$suggestionsForImportReceivedCmd(
						{
							ctor: '_Tuple2',
							_0: _p82,
							_1: A4(_user$project$Indexer$getSuggestionsForImport, _p82, model.activeFile, model.fileContentsDict, model.packageDocs)
						})
				};
					...
					_1: _user$project$Indexer$canGoToDefinitionRepliedCmd(
						{
							ctor: '_Tuple2',
							_0: _p83,
							_1: A2(_elm_lang$core$Dict$member, _p83, model.activeTokens)
						})
				};
			default:
				var _p84 = _p71._0._0;
