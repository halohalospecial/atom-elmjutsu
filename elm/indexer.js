...
var _user$project$Indexer$areMatchingTypesRecur = F5(
	function (annotation1, annotation2, typeVariables1, typeVariables2, nextAnnotations) {
		...
		while (true) {
			var checkTypeVariables2 = F2(
				function (variable, annotation) {
					var _p101 = A2(_elm_lang$core$Dict$get, variable, typeVariables2);
					if (_p101.ctor === 'Nothing') {
						return {
							ctor: '_Tuple4',
							_0: true,
							_1: typeVariables1,
							_2: A3(_elm_lang$core$Dict$insert, variable, annotation, typeVariables2),
							_3: nextAnnotations
						};
					} else {
						return {
							...
							_3: A2(
								...
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: annotation, _1: _p101._0},
									_1: {ctor: '[]'}
								},
								nextAnnotations)
						};
			...
			var checkTypeVariables1 = F2(
				function (variable, annotation) {
					var _p102 = A2(_elm_lang$core$Dict$get, variable, typeVariables1);
					if (_p102.ctor === 'Nothing') {
						return {
							ctor: '_Tuple4',
							_0: true,
							_1: A3(_elm_lang$core$Dict$insert, variable, annotation, typeVariables1),
							_2: typeVariables2,
							_3: nextAnnotations
						};
					} else {
						return {
							...
							_3: A2(
								...
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: _p102._0, _1: annotation},
									_1: {ctor: '[]'}
								},
								nextAnnotations)
						};
				...
				if (_elm_lang$core$Native_Utils.eq(annotation1, annotation2)) {
					...
					do {
						...
						do {
								...
								if (_p104.ctor === '_Tuple2') {
									switch (_p104._0.ctor) {
										case 'TypeVariable':
											switch (_p104._1.ctor) {
												case 'TypeConstructor':
													if ((_p104._1._0.ctor === '::') && (_p104._1._0._1.ctor === '[]')) {
														switch (_p104._0._0) {
															case 'number':
																if (_p104._1._1.ctor === '[]') {
												...
												case 'TypeApplication':
													return {
														...
														_3: A2(
															...
															{
																ctor: '::',
																_0: {ctor: '_Tuple2', _0: _p104._0._0, _1: _p104._1._0},
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: _p104._0._1, _1: _p104._1._1},
																	_1: {ctor: '[]'}
																}
															},
															nextAnnotations)
										...
										case 'TypeConstructor':
											switch (_p104._1.ctor) {
												case 'TypeVariable':
													if ((_p104._0._0.ctor === '::') && (_p104._0._0._1.ctor === '[]')) {
														switch (_p104._1._0) {
															case 'number':
																if (_p104._0._1.ctor === '[]') {
												...
												case 'TypeConstructor':
													...
													var _p107 = _p104._0._1;
													return _elm_lang$core$Native_Utils.eq(_p104._0._0, _p104._1._0) ? (_elm_lang$core$Native_Utils.eq(
														_elm_lang$core$List$length(_p107),
														_elm_lang$core$List$length(_p108)) ? {
														ctor: '_Tuple4',
														_0: true,
														_1: typeVariables1,
														_2: typeVariables2,
							...
							return _user$project$Indexer$isTypeClass(_p105) ? {ctor: '_Tuple4', _0: false, _1: typeVariables1, _2: typeVariables2, _3: nextAnnotations} : A2(checkTypeVariables1, _p105, _p104._1);
						} while(false);
						var _p106 = _p104._1._0;
						return _user$project$Indexer$isTypeClass(_p106) ? {ctor: '_Tuple4', _0: false, _1: typeVariables1, _2: typeVariables2, _3: nextAnnotations} : A2(checkTypeVariables2, _p106, _p104._0);
					} while(false);
					return {ctor: '_Tuple4', _0: false, _1: typeVariables1, _2: typeVariables2, _3: nextAnnotations};
				}
			}();
			var continueChecking = _p103._0;
			var updatedTypeVariables1 = _p103._1;
			var updatedTypeVariables2 = _p103._2;
			var updatedNextAnnotations = _p103._3;
			if (continueChecking) {
				var _p109 = updatedNextAnnotations;
				if (_p109.ctor === '::') {
					var _v89 = _p109._0._0,
						_v90 = _p109._0._1,
...
var _user$project$Indexer$parseTipeString = function (tipeString) {
	...
	if (((((_p110.ctor === 'Ok') && (_p110._0.ctor === '_Tuple3')) && (_p110._0._0.ctor === '_Tuple0')) && (_p110._0._2.ctor === 'FunctionTypeDeclaration')) && (_p110._0._2._0 === 'x')) {
		return _elm_lang$core$Maybe$Just(_p110._0._2._1);
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
		...
		if (_p111._0.ctor === 'Nothing') {
			...
			if (_p111._1.ctor === 'Nothing') {
				...
				var _p112 = A5(
					...
					{ctor: '[]'});
				var result = _p112._0;
				var typeVariables1 = _p112._1;
				var typeVariables2 = _p112._2;
				return result;
			}
		}
	});
						...
						if (_elm_lang$core$Native_Utils.eq(numParts1, 1) && _elm_lang$core$Native_Utils.eq(numParts2, 1)) {
							...
							if (_elm_lang$core$Native_Utils.eq(numParts2, 1) && (_user$project$Indexer$isTipeVariable(tipe2) && (!_user$project$Indexer$isTypeClass(tipe2)))) {
								...
								if (((_p113.ctor === '_Tuple2') && (_p113._0.ctor === 'Just')) && (_p113._1.ctor === 'Just')) {
									if (_elm_lang$core$Native_Utils.eq(_p113._0._0, _p113._1._0)) {
										var _v97 = A2(
											_elm_lang$core$String$join,
											'',
											A2(
...
var _user$project$Indexer$getHintsForToken = F2(
	function (maybeToken, tokens) {
		var _p118 = maybeToken;
		if (_p118.ctor === 'Just') {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				{ctor: '[]'},
				A2(_elm_lang$core$Dict$get, _p118._0, tokens));
		} else {
			return {ctor: '[]'};
		}
	});
	...
	function (token, isCursorAtLastPartOfToken, maybeActiveFile, tokens, activeFileContents, projectFileContentsDict) {
		...
		if (_p119.ctor === 'Just') {
			...
			if (isImportAlias) {
				...
				var fileContentsDict = A2(_user$project$Indexer$getFileContentsOfProject, _p119._0.projectDirectory, projectFileContentsDict);
				var hints = A2(
				...
				return A2(
					...
					function (_p120) {
						var _p121 = _p120;
						var _p127 = _p121.moduleDocs;
						var _p126 = _p121.imports;
						var getSourcePathAndLocalNames = function (hint) {
							...
							var isHintThisModule = isHintAModule(hint) && _elm_lang$core$Native_Utils.eq(hint.name, _p127.name);
							var isHintAnImport = isHintAModule(hint) && (!_elm_lang$core$Native_Utils.eq(
								A2(_elm_lang$core$Dict$get, token, _p126),
								_elm_lang$core$Maybe$Nothing));
							if (isHintThisModule) {
								return _elm_lang$core$Maybe$Just(
									{
								...
								if (isHintAnImport) {
									...
									var _p122 = A2(_elm_lang$core$Dict$get, hint.moduleName, _p126);
									if (_p122.ctor === 'Just') {
										var _p125 = _p122._0.alias;
										var localNames = function () {
											var _p123 = {ctor: '_Tuple2', _0: _p125, _1: _p122._0.exposed};
											switch (_p123._1.ctor) {
												case 'None':
												...
												case 'All':
													return {
														...
														_1: {
															ctor: '::',
															_0: A3(_user$project$Indexer$getModuleLocalName, hint.moduleName, _p125, hint.name),
															_1: {ctor: '[]'}
														}
													};
												default:
													return A2(_elm_lang$core$Set$member, hint.name, _p123._1._0) ? {
														ctor: '::',
														_0: hint.name,
														_1: {
															ctor: '::',
										...
										if (_p124.ctor === '[]') {
											...
											return _elm_lang$core$Maybe$Just(
												{ctor: '_Tuple4', _0: _p127.sourcePath, _1: false, _2: false, _3: names});
										}
									} else {
										var isHintInThisModule = _elm_lang$core$Native_Utils.eq(hint.moduleName, _p127.name);
...
var _user$project$Indexer$constructCaseOf = F2(
	function (token, activeFileTokens) {
		...
		if (_p128.ctor === 'Just') {
			var _p136 = _p128._0;
			var _p129 = function () {
				var _p130 = _user$project$Indexer$typeConstructorToNameAndArgs(_p136.tipe);
				var name = _p130._0;
				var args = _p130._1;
				var _p131 = _elm_lang$core$List$head(args);
				if (_p131.ctor === 'Just') {
					if (_p131._0 === '->') {
						return {
							ctor: '_Tuple2',
							_0: _user$project$Indexer$getReturnTipe(_p136.tipe),
							_1: {ctor: '[]'}
						};
					} else {
			...
			var tokenTipeName = _p129._0;
			var tokenTipeArgs = _p129._1;
			var _p132 = function () {
				var _p133 = tokenTipeName;
				if (_p133 === 'Bool') {
					return {
						ctor: '_Tuple2',
						_0: {
					...
					if (A2(
						...
						if (A2(
							...
							if (_p134.ctor === 'Just') {
								var _p135 = _p134._0;
								return {ctor: '_Tuple2', _0: _p135.cases, _1: _p135.args};
							} else {
								return {
									ctor: '_Tuple2',
									_0: {ctor: '[]'},
			...
			var tipeCases = _p132._0;
			var tipeArgs = _p132._1;
			return (_elm_lang$core$Native_Utils.cmp(
...
var _user$project$Indexer$getProjectPackageDocs = F3(
	function (maybeActiveFile, projectDependencies, packageDocs) {
		var _p137 = maybeActiveFile;
		if (_p137.ctor === 'Just') {
			var _p138 = A2(_elm_lang$core$Dict$get, _p137._0.projectDirectory, projectDependencies);
			if (_p138.ctor === 'Just') {
				var packageUris = A2(_elm_lang$core$List$map, _user$project$Indexer$toPackageUri, _p138._0);
				return A2(
					_elm_lang$core$List$filter,
					function (moduleDocs) {
...
var _user$project$Indexer$moduleToHints = F2(
	function (moduleDocs, _p144) {
		var _p145 = _p144;
		var _p146 = moduleDocs;
		var name = _p146.name;
		var comment = _p146.comment;
		var sourcePath = _p146.sourcePath;
		var hint = {
			name: name,
			moduleName: '',
		...
		if (_p147.ctor === 'Just') {
			return {
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: _p147._0, _1: hint},
					_1: {ctor: '[]'}
				}
			};
		} else {
...
var _user$project$Indexer$unionTagsToHints = F4(
	function (moduleDocs, _p148, activeFilePath, tipe) {
		var _p149 = _p148;
		var _p150 = _p149.exposed;
		var addHints = F2(
			function (tipeCase, hints) {
				...
				var isInActiveModule = _elm_lang$core$Native_Utils.eq(activeFilePath, hint.sourcePath);
				var moduleLocalName = A3(_user$project$Indexer$getModuleLocalName, moduleDocs.name, _p149.alias, tag);
				return A2(
					_elm_lang$core$Basics_ops['++'],
					hints,
					isInActiveModule ? {
						...
						_1: {ctor: '[]'}
					} : ((A2(_user$project$Indexer$isExposed, tag, _p150) || A2(_user$project$Indexer$isExposed, tipe.name, _p150)) ? {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: moduleLocalName, _1: hint},
						_1: {
							ctor: '::',
			...
			if (_user$project$Indexer$isPrimitiveTipe(tipeString)) {
				...
				if (_user$project$Indexer$isRecordString(tipeString)) {
					...
					if (_user$project$Indexer$isTupleString(tipeString)) {
						...
						if (_p151.ctor === 'Just') {
							var _p152 = _p151._0;
							if (A2(_elm_lang$core$Set$member, _p152.tipe, visitedTipeAliases)) {
								return tipeString;
							} else {
								if (_elm_lang$core$Native_Utils.eq(_p152.kind, _user$project$Indexer$KindTypeAlias)) {
									var _v121 = tokens,
										_v122 = A2(_elm_lang$core$Set$insert, _p152.tipe, visitedTipeAliases),
										_v123 = _p152.tipe;
									tokens = _v121;
							...
							function (_p153) {
								...
								return A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										' = ',
										A3(_user$project$Indexer$getDefaultValueForTypeRecur, activeFileTokens, visitedTypes, _p154._1)));
							},
							_user$project$Indexer$getRecordTipeParts(tipeString)));
					return A2(
						_elm_lang$core$Basics_ops['++'],
								...
								switch (_p156) {
									...
									default:
										var _p157 = _elm_lang$core$List$head(
											A2(
												_user$project$Indexer$getHintsForToken,
												_elm_lang$core$Maybe$Just(_p162),
												activeFileTokens));
										if (_p157.ctor === 'Just') {
											var _p161 = _p157._0;
											if ((!_elm_lang$core$Native_Utils.eq(_p161.kind, _user$project$Indexer$KindType)) && ((!_elm_lang$core$Native_Utils.eq(_p161.tipe, _p162)) && ((!_elm_lang$core$Native_Utils.eq(_p161.kind, _user$project$Indexer$KindTypeAlias)) || (_elm_lang$core$Native_Utils.eq(_p161.kind, _user$project$Indexer$KindTypeAlias) && _elm_lang$core$Native_Utils.eq(
												_elm_lang$core$List$length(_p161.args),
												0))))) {
												if (A2(_elm_lang$core$Set$member, _p161.name, visitedTypes)) {
													return '_';
												} else {
													var _v128 = activeFileTokens,
														_v129 = A2(_elm_lang$core$Set$insert, _p161.name, visitedTypes),
														_v130 = _p161.tipe;
												...
												if (_elm_lang$core$Native_Utils.eq(_p161.kind, _user$project$Indexer$KindType)) {
													var _p158 = _elm_lang$core$List$head(_p161.cases);
													if (_p158.ctor === 'Just') {
														var _p160 = _p158._0;
														if (A2(_elm_lang$core$Set$member, _p161.name, visitedTypes)) {
															return '_';
														} else {
															var _p159 = _user$project$Indexer$typeConstructorToNameAndArgs(tipeString);
															var annotatedTipeArgs = _p159._1;
															var alignedArgs = A3(_user$project$Indexer$getTipeCaseAlignedArgTipes, _p161.args, annotatedTipeArgs, _p160.args);
															return A2(
																_elm_lang$core$Basics_ops['++'],
																_p160.name,
																A2(
																	...
																	A2(
																		...
																		A2(
																			...
																			A2(
																				_user$project$Indexer$getDefaultValueForTypeRecur,
																				activeFileTokens,
																				A2(_elm_lang$core$Set$insert, _p161.name, visitedTypes)),
																			alignedArgs))));
														}
													} else {
														return '_';
...
var _user$project$Indexer$constructDefaultArguments = F2(
	function (token, activeFileTokens) {
		...
		if (_p163.ctor === 'Just') {
			var _p164 = _p163._0;
			var parts = _user$project$Indexer$isRecordString(_p164.tipe) ? _user$project$Indexer$getRecordTipeFieldTipes(_p164.tipe) : _user$project$Helper$dropLast(
				_user$project$Indexer$getTipeParts(_p164.tipe));
			return _elm_lang$core$Maybe$Just(
				A2(
					_elm_lang$core$List$map,
					function (tipeString) {
...
var _user$project$Indexer$getProjectFileSymbols = F2(
	function (projectDirectory, projectFileContentsDict) {
		...
		var allFileSymbols = A2(
			...
			function (_p166) {
				var _p167 = _p166;
				return _user$project$Indexer$getModuleSymbols(_p167.moduleDocs);
			},
			_elm_lang$core$Dict$values(fileContentsDict));
		return A2(
			_elm_lang$core$List$filter,
			function (_p168) {
				var _p169 = _p168;
				return _user$project$Indexer$isProjectSourcePath(_p169.sourcePath);
			},
			allFileSymbols);
	});
var _user$project$Indexer$doShowGoToSymbolView = F3(
	function (maybeProjectDirectory, maybeToken, model) {
		var _p170 = maybeProjectDirectory;
		if (_p170.ctor === 'Just') {
			var hints = A2(_user$project$Indexer$getHintsForToken, maybeToken, model.activeFileTokens);
			var defaultSymbolName = function () {
				var _p171 = _elm_lang$core$List$head(hints);
				if (_p171.ctor === 'Just') {
					var _p173 = _p171._0;
					var _p172 = model.activeFile;
					if (_p172.ctor === 'Just') {
						return _elm_lang$core$Native_Utils.eq(_p172._0.filePath, _p173.sourcePath) ? _elm_lang$core$Maybe$Just(
							_user$project$Indexer$getLastName(_p173.name)) : _elm_lang$core$Maybe$Just(_p173.name);
					} else {
						return _elm_lang$core$Maybe$Just(_p173.name);
					}
				} else {
					return maybeToken;
				}
				...
				_1: _user$project$Indexer$showGoToSymbolViewCmd(
					{
						...
						_2: A2(
							...
							A2(_user$project$Indexer$getProjectFileSymbols, _p170._0, model.projectFileContentsDict))
					})
			};
		} else {
...
var _user$project$Indexer$getProjectSymbols = F4(
	function (maybeActiveFile, projectFileContentsDict, projectDependencies, packageDocs) {
		...
		if (_p174.ctor === 'Just') {
			return A2(
				_elm_lang$core$List$append,
				A2(_user$project$Indexer$getProjectFileSymbols, _p174._0.projectDirectory, projectFileContentsDict),
...
var _user$project$Indexer$doShowAddImportView = F3(
	function (filePath, maybeToken, model) {
		var defaultSymbolName = function () {
			var _p175 = maybeToken;
			if (_p175.ctor === 'Just') {
				var _p177 = _p175._0;
				var _p176 = _user$project$Indexer$getModuleName(_p177);
				if (_p176 === '') {
					return _elm_lang$core$Maybe$Just(
						_user$project$Indexer$getLastName(_p177));
				} else {
					return _elm_lang$core$Maybe$Just(
						_user$project$Indexer$getModuleName(_p177));
				}
			} else {
				return _elm_lang$core$Maybe$Nothing;
			}
		...
		var moduleAndSymbols = A2(
			...
			A2(
				...
				function (_p178) {
					var _p179 = _p178;
					return (!_elm_lang$core$Native_Utils.eq(_p179.sourcePath, filePath)) && (!_elm_lang$core$Native_Utils.eq(
						_user$project$Indexer$getLastName(_p179.fullName),
						''));
				},
		...
		var moduleAndSymbolsAndAllExposed = A2(
			...
			F2(
				function (_p184, _p183) {
					...
					var filterKey = F2(
						function (moduleName, symbolName) {
							return A2(
								...
								moduleName,
								function () {
									var _p187 = symbolName;
									if (_p187.ctor === 'Just') {
										return A2(_elm_lang$core$Basics_ops['++'], ' ', _p187._0);
									} else {
										return '';
									}
								}());
					...
					return A2(
						_elm_lang$core$Basics$compare,
						A2(filterKey, _p185._0, _p185._1),
						A2(filterKey, _p186._0, _p186._1));
				}),
			A2(
				_elm_lang$core$List$append,
				moduleAndSymbols,
...
var _user$project$Indexer$getHintsForUnexposedNames = F3(
	function (includeQualified, moduleDocs, unexposedNames) {
		var filter = function (_p190) {
			var _p191 = _p190;
			return A2(_elm_lang$core$Set$member, _p191.name, unexposedNames);
		};
		...
		var _p192 = A3(
			...
			F2(
				function (moduleDocs, _p193) {
					...
					var allNames = _elm_lang$core$Set$fromList(
						A2(
							...
							A2(
								...
								tipeCases)));
					var _p195 = function () {
						var _p196 = A2(_elm_lang$core$Dict$get, moduleDocs.name, imports);
						if (_p196.ctor === 'Just') {
							var exposed = A2(
								_elm_lang$core$List$map,
								function (_p197) {
									var _p198 = _p197;
									var _p199 = _p198._1;
									var moduleNameToShow = (_elm_lang$core$Native_Utils.eq(_p199.moduleName, '') || _elm_lang$core$Native_Utils.eq(activeFilePath, _p199.sourcePath)) ? '' : _p199.moduleName;
									return _elm_lang$core$Native_Utils.update(
										_p199,
										{moduleName: moduleNameToShow, name: _p198._0});
								},
								A3(_user$project$Indexer$getFilteredHints, activeFilePath, moduleDocs, _p196._0));
					...
					var exposedHints = _p195._0;
					var unexposedHints = _p195._1;
					return {
						ctor: '_Tuple2',
						_0: {ctor: '::', _0: exposedHints, _1: _p194._0},
						_1: {ctor: '::', _0: unexposedHints, _1: _p194._1}
					};
				}),
			{
				ctor: '_Tuple2',
			...
			moduleDocsList);
		var exposedLists = _p192._0;
		var unexposedLists = _p192._1;
		return {
			ctor: '_Tuple2',
...
var _user$project$Indexer$getExternalHints = F4(
	function (isGlobal, filePath, activeFileContents, allModuleDocs) {
		var moduleDocsToCheck = isGlobal ? A2(
			...
			allModuleDocs);
		var _p200 = A4(_user$project$Indexer$getExposedAndUnexposedHints, isGlobal, filePath, activeFileContents.imports, moduleDocsToCheck);
		var importedHints = _p200._0;
		var unimportedHints = _p200._1;
...
var _user$project$Indexer$toImport = function (_p202) {
	var _p203 = _p202;
	var exposedSet = function () {
		var _p204 = _p203.exposed;
		if (_p204.ctor === 'Just') {
			if (((_p204._0.ctor === '::') && (_p204._0._0 === '..')) && (_p204._0._1.ctor === '[]')) {
				return _user$project$Indexer$All;
			} else {
				return _user$project$Indexer$Some(
					_elm_lang$core$Set$fromList(_p204._0));
			}
		} else {
	...
	return {
		ctor: '_Tuple2',
		_0: _p203.name,
		_1: A2(_user$project$Indexer$Import, _p203.alias, exposedSet)
	};
};
...
var _user$project$Indexer$getActiveFileContents = F2(
	function (maybeActiveFile, fileContentsDict) {
		...
		if (_p205.ctor === 'Just') {
			var _p206 = A2(_elm_lang$core$Dict$get, _p205._0.filePath, fileContentsDict);
			if (_p206.ctor === 'Just') {
				return _p206._0;
			} else {
...
var _user$project$Indexer$doGetImporterSourcePathsForToken = F4(
	function (maybeProjectDirectory, maybeToken, maybeIsCursorAtLastPartOfToken, model) {
		var _p207 = {ctor: '_Tuple3', _0: maybeProjectDirectory, _1: maybeToken, _2: maybeIsCursorAtLastPartOfToken};
		if ((((_p207.ctor === '_Tuple3') && (_p207._0.ctor === 'Just')) && (_p207._1.ctor === 'Just')) && (_p207._2.ctor === 'Just')) {
			var _p211 = _p207._1._0;
			var _p210 = _p207._0._0;
			var _p209 = _p207._2._0;
			var fileContentsDict = A2(_user$project$Indexer$getFileContentsOfProject, _p210, model.projectFileContentsDict);
			var activeFileContents = A2(_user$project$Indexer$getActiveFileContents, model.activeFile, fileContentsDict);
			var _p208 = _elm_lang$core$Native_Utils.eq(_p211, activeFileContents.moduleDocs.name) ? {ctor: '_Tuple2', _0: _p211, _1: true} : ((!_elm_lang$core$Native_Utils.eq(
				A2(_elm_lang$core$Dict$get, _p211, activeFileContents.imports),
				_elm_lang$core$Maybe$Nothing)) ? {ctor: '_Tuple2', _0: _p211, _1: true} : (_p209 ? {ctor: '_Tuple2', _0: _p211, _1: false} : {
				ctor: '_Tuple2',
				_0: _user$project$Indexer$getModuleName(_p211),
				_1: false
			}));
			var token = _p208._0;
			var willUseFullToken = _p208._1;
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _user$project$Indexer$importersForTokenReceivedCmd(
					{
						...
						_2: willUseFullToken,
						_3: _p209,
						_4: A6(_user$project$Indexer$getImportersForToken, token, _p209, model.activeFile, model.activeFileTokens, activeFileContents, model.projectFileContentsDict)
					})
			};
		} else {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$Indexer$getExternalAndLocalHints = F8(
	function (isGlobal, maybeActiveFile, projectFileContentsDict, projectDependencies, packageDocs, maybeCachedExternal, maybeCachedLocal, activeFileTokens) {
		var _p212 = maybeActiveFile;
		if (_p212.ctor === 'Just') {
			var _p216 = _p212._0.projectDirectory;
			var _p215 = _p212._0.filePath;
			var fileContentsDict = A2(_user$project$Indexer$getFileContentsOfProject, _p216, projectFileContentsDict);
			var activeFileContents = A2(_user$project$Indexer$getActiveFileContents, maybeActiveFile, fileContentsDict);
			var local = function () {
				var _p213 = maybeCachedLocal;
				if (_p213.ctor === 'Just') {
					return _p213._0;
				} else {
					return A3(_user$project$Indexer$getLocalHints, _p215, activeFileContents, activeFileTokens);
				}
			}();
			...
			var allModuleDocs = A2(
				_elm_lang$core$Basics_ops['++'],
				projectPackageDocs,
				A2(_user$project$Indexer$getProjectModuleDocs, _p216, projectFileContentsDict));
			var external = function () {
				var _p214 = maybeCachedExternal;
				if (_p214.ctor === 'Just') {
					return _p214._0;
				} else {
					return A4(_user$project$Indexer$getExternalHints, isGlobal, _p215, activeFileContents, allModuleDocs);
				}
			}();
			return {
											...
											return function (maybeHintsCache) {
												return function (activeFileTokens) {
													...
													if (_p217.ctor === 'Just') {
														...
														var _p218 = function () {
															var _p219 = maybeHintsCache;
															if (_p219.ctor === 'Just') {
																var _p221 = _p219._0;
																var _p220 = {ctor: '_Tuple2', _0: _p221.external, _1: _p221.local};
																if ((_p220._0.ctor === 'Just') && (_p220._1.ctor === 'Just')) {
																	return _p221;
																} else {
																	return A8(_user$project$Indexer$getExternalAndLocalHints, isGlobal, maybeActiveFile, projectFileContentsDict, projectDependencies, packageDocs, _p220._0, _p220._1, activeFileTokens);
																}
															} else {
														...
														var external = _p218.external;
														var local = _p218.local;
														var _p222 = function () {
															var _p223 = {ctor: '_Tuple2', _0: external, _1: local};
															if (((_p223.ctor === '_Tuple2') && (_p223._0.ctor === 'Just')) && (_p223._1.ctor === 'Just')) {
																var _p225 = _p223._1._0;
																var _p224 = _p223._0._0;
																return {
																	ctor: '_Tuple3',
																	_0: A2(_elm_lang$core$Basics_ops['++'], _p224.importedHints, _p225.topLevelHints),
																	_1: _p224.unimportedHints,
																	_2: _p225.variableHints
																};
															} else {
																return {
																	ctor: '_Tuple3',
														...
														var exposedAndTopLevelHints = _p222._0;
														var unexposedHints = _p222._1;
														var variableHints = _p222._2;
														...
														var hints = function () {
															var _p226 = maybeInferredTipe;
															if (_p226.ctor === 'Just') {
																var _p231 = _p226._0;
																var partitionHints = function (hints) {
																	return A2(
																		_elm_lang$core$List$partition,
																		A2(_user$project$Indexer$partitionByTipe, _p231, preceedingToken),
																		hints);
																};
																var _p227 = partitionHints(filteredVariableHints);
																var variableHintsCompatible = _p227._0;
																var variableHintsNotCompatible = _p227._1;
																var _p228 = partitionHints(filteredDefaultHints);
																var defaultHintsCompatible = _p228._0;
																var defaultHintsNotCompatible = _p228._1;
																var _p229 = partitionHints(filteredExposedHints);
																var exposedHintsCompatible = _p229._0;
																var exposedHintsNotCompatible = _p229._1;
																var _p230 = partitionHints(filteredUnexposedHints);
																var unexposedHintsCompatible = _p230._0;
																var unexposedHintsNotCompatible = _p230._1;
																return A2(
																	_elm_lang$core$Basics_ops['++'],
																	A3(_user$project$Indexer$sortHintsByScore, _p231, preceedingToken, variableHintsCompatible),
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A3(_user$project$Indexer$sortHintsByScore, _p231, preceedingToken, defaultHintsCompatible),
																		A2(
																			_elm_lang$core$Basics_ops['++'],
																			A3(_user$project$Indexer$sortHintsByScore, _p231, preceedingToken, exposedHintsCompatible),
																			A2(
																				_elm_lang$core$Basics_ops['++'],
																				A3(_user$project$Indexer$sortHintsByScore, _p231, preceedingToken, unexposedHintsCompatible),
																				A2(
																					_elm_lang$core$Basics_ops['++'],
...
var _user$project$Indexer$doGetHintsForPartial = F8(
	function (partial, maybeInferredTipe, preceedingToken, isRegex, isTypeSignature, isFiltered, isGlobal, model) {
		var _p232 = _user$project$Indexer$getHintsForPartial(partial)(maybeInferredTipe)(preceedingToken)(isRegex)(isTypeSignature)(isFiltered)(isGlobal)(model.activeFile)(model.projectFileContentsDict)(model.projectDependencies)(model.packageDocs)(model.hintsCache)(model.activeFileTokens);
		var hints = _p232._0;
		var updatedHintsCache = _p232._1;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
...
var _user$project$Indexer$getActiveFileTokens = F5(
	function (maybeActiveFile, maybeActiveTopLevel, projectFileContentsDict, projectDependencies, packageDocs) {
		...
		if (_p233.ctor === 'Just') {
			var _p240 = _p233._0.projectDirectory;
			var _p239 = _p233._0.filePath;
			var insert = F2(
				function (_p234, dict) {
					var _p235 = _p234;
					return A3(
			...
			var fileContentsDict = A2(_user$project$Indexer$getFileContentsOfProject, _p240, projectFileContentsDict);
			var getHints = function (moduleDocs) {
				return A2(
					_elm_lang$core$Maybe$map,
					A2(_user$project$Indexer$getFilteredHints, _p239, moduleDocs),
					A2(
				...
				_elm_lang$core$List$concat(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							projectPackageDocs,
							A2(_user$project$Indexer$getProjectModuleDocs, _p240, projectFileContentsDict)))));
...
var _user$project$Indexer$topLevelArgToHints = F4(
	function (parentSourcePath, _p242, topLevelTokens, _p241) {
		var _p243 = _p242;
		var _p255 = _p243._1;
		var _p254 = _p243._2;
		var _p253 = _p243._3;
			...
			var getRecordFields = function (tipeString) {
				return _elm_lang$core$List$concat(
					A2(
							...
							return A2(
								...
								function (tipeString) {
									return A5(
										...
										tipeString,
										parentSourcePath,
										{ctor: '_Tuple4', _0: _p252, _1: _p255, _2: _p254, _3: _p253},
										topLevelTokens);
								},
								A2(
									_elm_lang$core$Dict$get,
						...
						_user$project$Indexer$getRecordArgParts(_p250)));
			};
			var _p245 = {
				ctor: '_Tuple2',
				_0: _user$project$Indexer$isRecordString(_p250),
				_1: _user$project$Indexer$isRecordString(_p251)
			};
			if (_p245._0 === true) {
				if (_p245._1 === true) {
					return getRecordFields(_p251);
				} else {
					var _p246 = _elm_lang$core$List$head(
						A2(
							_user$project$Indexer$getHintsForToken,
							_elm_lang$core$Maybe$Just(_p251),
							topLevelTokens));
					if (_p246.ctor === 'Just') {
						return getRecordFields(_p246._0.tipe);
					} else {
						return {ctor: '[]'};
					}
				}
		...
		var getHint = function (_p247) {
			...
			return {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: _p249, _1: hint},
				_1: {ctor: '[]'}
			};
		};
...
var _user$project$Indexer$getRecordFieldTokens = F5(
	function (name, tipeString, parentSourcePath, _p256, topLevelTokens) {
		var _p257 = _p256;
		return A8(
			...
			tipeString,
			parentSourcePath,
			{ctor: '_Tuple4', _0: _p257._0, _1: _p257._1, _2: _p257._2, _3: _p257._3},
			topLevelTokens,
			true,
			_elm_lang$core$Maybe$Nothing,
...
var _user$project$Indexer$getRecordFieldTokensRecur = F8(
	function (name, tipeString, parentSourcePath, _p258, topLevelTokens, shouldAddSelf, maybeRootTipeString, visitedSourcePaths) {
		var _p259 = _p258;
		var _p274 = _p259._1;
		var _p273 = _p259._2;
		var _p272 = _p259._3;
			...
			function () {
				if (_user$project$Indexer$isRecordString(name)) {
					...
					if (_user$project$Indexer$isRecordString(tipeString)) {
						...
						var _p260 = _elm_lang$core$List$head(
							A2(
								_user$project$Indexer$getHintsForToken,
								_elm_lang$core$Maybe$Just(tipeString),
								topLevelTokens));
						if (_p260.ctor === 'Just') {
							return getRecordFields(_p260._0.tipe);
						} else {
							return {ctor: '[]'};
						}
					}
					...
					if (_user$project$Indexer$isRecordString(tipeString)) {
							...
							function (_p261) {
								...
								return A8(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										name,
										A2(_elm_lang$core$Basics_ops['++'], '.', _p262._0)),
									_p262._1,
									parentSourcePath,
									{ctor: '_Tuple4', _0: _p271, _1: _p274, _2: _p273, _3: _p272},
									topLevelTokens,
						...
						if (_user$project$Indexer$isTupleString(name) && _user$project$Indexer$isTupleString(tipeString)) {
							...
							var _p266 = _elm_lang$core$List$head(
								A2(
							...
							if (_p266.ctor === 'Just') {
								var _p270 = _p266._0;
								if ((!_elm_lang$core$Native_Utils.eq(_p270.kind, _user$project$Indexer$KindType)) && ((!_elm_lang$core$Native_Utils.eq(_p270.tipe, tipeString)) && (!A2(_elm_lang$core$Set$member, _p270.sourcePath, visitedSourcePaths)))) {
									var updatedVisitedSourcePaths = A2(_elm_lang$core$Set$insert, _p270.sourcePath, visitedSourcePaths);
									...
									var _p268 = {
										ctor: '_Tuple2',
										_0: _p270.sourcePath,
										_1: ((!_elm_lang$core$Native_Utils.eq(_p270.sourcePath, parentSourcePath)) && _user$project$Indexer$isProjectSourcePath(_p270.sourcePath)) ? A5(_user$project$Indexer$getActiveFileTokens, maybeNewActiveFile, _elm_lang$core$Maybe$Nothing, _p274, _p273, _p272) : topLevelTokens
									};
									var newParentSourcePath = _p268._0;
									var newTokens = _p268._1;
									var _p269 = maybeRootTipeString;
									if (_p269.ctor === 'Just') {
										return (!_elm_lang$core$Native_Utils.eq(_p270.name, _p269._0)) ? A8(
											_user$project$Indexer$getRecordFieldTokensRecur,
											name,
											_p270.tipe,
											newParentSourcePath,
											{ctor: '_Tuple4', _0: maybeNewActiveFile, _1: _p274, _2: _p273, _3: _p272},
											newTokens,
											false,
											_elm_lang$core$Maybe$Just(_p270.name),
...
var _user$project$Indexer$doGetTokenInfo = F5(
	function (maybeProjectDirectory, maybeFilePath, maybeActiveTopLevel, maybeToken, model) {
		var _p277 = {ctor: '_Tuple2', _0: maybeProjectDirectory, _1: maybeFilePath};
		if (((_p277.ctor === '_Tuple2') && (_p277._0.ctor === 'Just')) && (_p277._1.ctor === 'Just')) {
			var _p280 = _p277._0._0;
			var _p279 = _p277._1._0;
			var fileTokens = function () {
				var _p278 = model.activeFile;
				if (_p278.ctor === 'Just') {
					return (_elm_lang$core$Native_Utils.eq(_p278._0.filePath, _p279) && _elm_lang$core$Native_Utils.eq(model.activeTopLevel, maybeActiveTopLevel)) ? model.activeFileTokens : A5(
						_user$project$Indexer$getActiveFileTokens,
						_elm_lang$core$Maybe$Just(
							{filePath: _p279, projectDirectory: _p280}),
						maybeActiveTopLevel,
						model.projectFileContentsDict,
						model.projectDependencies,
						model.packageDocs);
...
var _user$project$Indexer$doUpdateFileContents = F4(
	function (filePath, projectDirectory, fileContents, model) {
		...
		var updatedHintsCache = function () {
			var _p281 = model.hintsCache;
			if (_p281.ctor === 'Just') {
				var _p285 = _p281._0;
				var _p282 = _p285.external;
				if (_p282.ctor === 'Just') {
					var _p283 = model.activeFile;
					if (_p283.ctor === 'Just') {
						var _p284 = _p283._0;
						var newFileContentsDict = A2(_user$project$Indexer$getFileContentsOfProject, _p284.projectDirectory, updatedProjectFileContentsDict);
						var newActiveFileContents = A2(_user$project$Indexer$getActiveFileContents, model.activeFile, newFileContentsDict);
						var oldFileContentsDict = A2(_user$project$Indexer$getFileContentsOfProject, _p284.projectDirectory, model.projectFileContentsDict);
						...
						return (_elm_lang$core$Native_Utils.eq(_p284.filePath, filePath) && (!_elm_lang$core$Native_Utils.eq(oldActiveFileContents.imports, newActiveFileContents.imports))) ? _elm_lang$core$Maybe$Just(
							_elm_lang$core$Native_Utils.update(
								_p285,
...
var _user$project$Indexer$addLoadedPackageDocs = F2(
	function (loadedPackageDocs, model) {
		...
		var missingPackageDocs = A2(
			...
			function (_p287) {
				var _p288 = _p287;
				return !A2(_elm_lang$core$List$member, _p288.sourcePath, existingPackages);
			},
			loadedPackageDocs);
	...
	function (tipeString, maybeProjectDirectory, maybeFilePath, projectFileContentsDict, projectDependencies, packageDocs) {
		...
		if (((_p289.ctor === '_Tuple2') && (_p289._0.ctor === 'Just')) && (_p289._1.ctor === 'Just')) {
			var activeFile = _elm_lang$core$Maybe$Just(
				{projectDirectory: _p289._0._0, filePath: _p289._1._0});
			...
			var _p290 = A8(_user$project$Indexer$getExternalAndLocalHints, true, activeFile, projectFileContentsDict, projectDependencies, packageDocs, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, activeFileTokens);
			var external = _p290.external;
			var local = _p290.local;
			var _p291 = function () {
				var _p292 = {ctor: '_Tuple2', _0: external, _1: local};
				if (((_p292.ctor === '_Tuple2') && (_p292._0.ctor === 'Just')) && (_p292._1.ctor === 'Just')) {
					var _p294 = _p292._1._0;
					var _p293 = _p292._0._0;
					return {
						ctor: '_Tuple3',
						_0: A2(_elm_lang$core$Basics_ops['++'], _p293.importedHints, _p294.topLevelHints),
						_1: _p293.unimportedHints,
						_2: _p294.variableHints
					};
				} else {
					return {
						ctor: '_Tuple3',
			...
			var exposedAndTopLevelHints = _p291._0;
			var unexposedHints = _p291._1;
			var variableHints = _p291._2;
			return A2(
				_elm_lang$core$List$filter,
				function (hint) {
...
var _user$project$Indexer$getSourcePathOfRecordFieldTokenRecur = F7(
	function (parentPartName, parentName, parentSourcePath, tailParts, _p295, rootTokens, tokens) {
		...
		while (true) {
			...
			var _p313 = _p296._3;
			var _p312 = _p296._0;
			var _p297 = _elm_lang$core$List$head(tailParts);
			if (_p297.ctor === 'Just') {
				var _p311 = _p297._0;
				...
				var newPrefixSourcePath = function () {
					var _p298 = _elm_lang$core$List$head(
						A2(
							_user$project$Indexer$getHintsForToken,
					...
					if (_p298.ctor === 'Just') {
						var _p301 = _p298._0;
						if (_user$project$Indexer$isRecordString(_p301.tipe)) {
							return A2(
								_elm_lang$core$Basics_ops['++'],
								parentSourcePath,
								A2(_elm_lang$core$Basics_ops['++'], _user$project$Indexer$filePathSeparator, parentPartName));
						} else {
							var _p299 = _elm_lang$core$List$head(
								A2(
									_user$project$Indexer$getHintsForToken,
									_elm_lang$core$Maybe$Just(_p301.tipe),
									tokens));
							if (_p299.ctor === 'Just') {
								var _p300 = _p299._0;
								return (!_elm_lang$core$Native_Utils.eq(_p300.sourcePath, parentSourcePath)) ? A2(
									_elm_lang$core$Basics_ops['++'],
									_p300.sourcePath,
									A2(_elm_lang$core$Basics_ops['++'], _user$project$Indexer$filePathSeparator, _p300.name)) : doDefault(_p301);
							} else {
								return doDefault(_p301);
							}
						}
					} else {
						var _p302 = _elm_lang$core$List$head(
							A2(
								_user$project$Indexer$getHintsForToken,
								_elm_lang$core$Maybe$Just(parentName),
								rootTokens));
						if (_p302.ctor === 'Just') {
							var _p305 = _p302._0;
							var _p303 = _elm_lang$core$List$head(
								A2(
									_user$project$Indexer$getHintsForToken,
									_elm_lang$core$Maybe$Just(_p305.tipe),
									tokens));
							if (_p303.ctor === 'Just') {
								var _p304 = _p303._0;
								return (!_elm_lang$core$Native_Utils.eq(_p304.sourcePath, parentSourcePath)) ? A2(
									_elm_lang$core$Basics_ops['++'],
									_p304.sourcePath,
									A2(_elm_lang$core$Basics_ops['++'], _user$project$Indexer$filePathSeparator, _p304.name)) : doDefault(_p305);
							} else {
								return doDefault(_p305);
							}
						} else {
				...
				var _p306 = function () {
					...
					if (((_p307.ctor === '_Tuple2') && (_p307._0.ctor === 'Just')) && (_p307._1.ctor === 'Just')) {
						var _p310 = _p307._1._0;
						var maybeNewActiveFile = function () {
							var _p308 = _p312;
							if (_p308.ctor === 'Just') {
								return _elm_lang$core$Maybe$Just(
						...
						var _p309 = maybeNewActiveFile;
						if (_p309.ctor === 'Just') {
							return ((!_elm_lang$core$Native_Utils.eq(_p307._0._0, _p310)) && _user$project$Indexer$isProjectSourcePath(_p310)) ? {
								ctor: '_Tuple2',
								_0: maybeNewActiveFile,
								_1: A5(_user$project$Indexer$getActiveFileTokens, maybeNewActiveFile, _elm_lang$core$Maybe$Nothing, _p315, _p314, _p313)
							} : {ctor: '_Tuple2', _0: _p312, _1: tokens};
						} else {
							return {ctor: '_Tuple2', _0: _p312, _1: tokens};
						}
					} else {
						return {ctor: '_Tuple2', _0: _p312, _1: tokens};
					}
				}();
				var updatedActiveFile = _p306._0;
				var updatedTokens = _p306._1;
				var _v201 = _p311,
					_v202 = A2(
					_elm_lang$core$Basics_ops['++'],
					parentName,
					...
					_v205 = {ctor: '_Tuple4', _0: updatedActiveFile, _1: _p315, _2: _p314, _3: _p313},
					_v206 = rootTokens,
					_v207 = updatedTokens;
...
var _user$project$Indexer$getSourcePathOfRecordFieldToken = F5(
	function (name, filePath, maybeActiveTopLevel, _p316, tokens) {
		var _p317 = _p316;
		var parts = A2(_elm_lang$core$String$split, '.', name);
		if (_elm_lang$core$Native_Utils.eq(
			_elm_lang$core$List$length(parts),
			1)) {
			var _p318 = maybeActiveTopLevel;
			if (_p318.ctor === 'Just') {
				return A2(
					_elm_lang$core$Basics_ops['++'],
					filePath,
					A2(_elm_lang$core$Basics_ops['++'], _user$project$Indexer$filePathSeparator, _p318._0));
			} else {
				return '';
			}
		} else {
			var _p319 = _elm_lang$core$List$head(parts);
			if (_p319.ctor === 'Just') {
				var _p320 = _p319._0;
				return A7(
					...
					A2(
						...
						{ctor: '[]'},
						_elm_lang$core$List$tail(parts)),
					{ctor: '_Tuple4', _0: _p317._0, _1: _p317._1, _2: _p317._2, _3: _p317._3},
					tokens,
					tokens);
			} else {
				return '';
								...
								return _elm_lang$core$Native_Utils.eq(hint.kind, _user$project$Indexer$KindVariable) ? _elm_lang$core$Native_Utils.update(
									hint,
									{
										sourcePath: A5(
											...
											_p323._0.filePath,
											_p322._1,
											{ctor: '_Tuple4', _0: _p325, _1: _p322._2, _2: _p322._3, _3: _p322._4},
											tokens)
									}) : hint;
							},
							hints);
...
var _user$project$Indexer$getTokenAndActiveFileTokensForGoToDefinition = F3(
	function (maybeActiveTopLevel, maybeToken, model) {
		...
		var tokenToCheck = function () {
			var _p326 = {ctor: '_Tuple2', _0: maybeToken, _1: model.activeFile};
			if (_p326._0.ctor === 'Just') {
				if (_p326._1.ctor === 'Just') {
					var _p327 = _p326._0._0;
					var fileContentsDict = A2(_user$project$Indexer$getFileContentsOfProject, _p326._1._0.projectDirectory, model.projectFileContentsDict);
					var activeFileContents = A2(_user$project$Indexer$getActiveFileContents, model.activeFile, fileContentsDict);
					return _elm_lang$core$Native_Utils.eq(
						activeFileContents.moduleDocs.name,
						_user$project$Indexer$getModuleName(_p327)) ? _elm_lang$core$Maybe$Just(
						_user$project$Indexer$getLastName(_p327)) : _elm_lang$core$Maybe$Just(_p327);
				} else {
					return _elm_lang$core$Maybe$Just(_p326._0._0);
				}
			} else {
				return _elm_lang$core$Maybe$Nothing;
			}
...
var _user$project$Indexer$doGoToDefinition = F3(
	function (maybeActiveTopLevel, maybeToken, model) {
		var _p328 = A3(_user$project$Indexer$getTokenAndActiveFileTokensForGoToDefinition, maybeActiveTopLevel, maybeToken, model);
		var tokenToCheck = _p328._0;
		var activeFileTokens = _p328._1;
		var requests = A2(
			_elm_lang$core$List$map,
			function (hint) {
				var symbol = {
...
var _user$project$Indexer$doAskCanGoToDefinition = F3(
	function (maybeActiveTopLevel, token, model) {
		var _p329 = A3(
			...
			_elm_lang$core$Maybe$Just(token),
			model);
		var tokenToCheck = _p329._0;
		var activeFileTokens = _p329._1;
		var _p330 = tokenToCheck;
				...
				_1: _user$project$Indexer$canGoToDefinitionRepliedCmd(
					{
						ctor: '_Tuple2',
						_0: token,
						_1: A2(_elm_lang$core$Dict$member, _p330._0, activeFileTokens)
					})
			};
		}
	});
			...
			A2(
				...
				function (_p331) {
					...
					var formatExposedSymbol = function (token) {
						...
						var _p334 = _elm_lang$core$List$head(hints);
						if (_p334.ctor === 'Just') {
							var _p335 = _p334._0.caseTipe;
							if (_p335.ctor === 'Just') {
								return A2(
									_elm_lang$core$Basics_ops['++'],
									_p335._0,
							...
							default:
								var nonDefaultExposedSymbols = A2(
									...
									function (exposedSymbolName) {
										var _p337 = A2(_elm_lang$core$Dict$get, _p340, _user$project$Indexer$defaultImports);
										if (_p337.ctor === 'Just') {
											var _p338 = _p337._0.exposed;
											if (_p338.ctor === 'Some') {
												return !A2(_elm_lang$core$Set$member, exposedSymbolName, _p338._0);
											} else {
												return true;
											}
										} else {
						...
						if (_p339.ctor === 'Just') {
							return A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_p340,
									A2(_elm_lang$core$Basics_ops['++'], ' as ', _p339._0)));
						} else {
							return A2(_elm_lang$core$Basics_ops['++'], 'import ', _p340);
						}
					}();
...
var _user$project$Indexer$doAddImport = F5(
	function (filePath, projectDirectory, moduleName, maybeSymbolName, model) {
		...
		var updatedImports = A2(
			...
			function () {
				var _p341 = A2(_elm_lang$core$Dict$get, moduleName, fileContents.imports);
				if (_p341.ctor === 'Just') {
					var _p348 = _p341._0;
					var _p342 = maybeSymbolName;
					if (_p342.ctor === 'Just') {
						var _p347 = _p342._0;
						var _p343 = _p348.exposed;
						switch (_p343.ctor) {
							case 'All':
								return fileContents.imports;
							case 'Some':
								return _elm_lang$core$Native_Utils.eq(_p347, '..') ? A3(
									_elm_lang$core$Dict$update,
									moduleName,
									function (_p344) {
										return _elm_lang$core$Maybe$Just(
											...
											_elm_lang$core$Native_Utils.update(
												_p348,
												{
													exposed: _user$project$Indexer$Some(
														A2(_elm_lang$core$Set$insert, _p347, _p343._0))
												}));
									},
									fileContents.imports);
							default:
									...
									function (_p346) {
										return _elm_lang$core$Maybe$Just(
											_elm_lang$core$Native_Utils.update(
												...
												{
													exposed: _user$project$Indexer$Some(
														_elm_lang$core$Set$singleton(_p347))
												}));
									},
									fileContents.imports);
						}
					...
					var importToAdd = function () {
						var _p349 = maybeSymbolName;
						if (_p349.ctor === 'Just') {
							return {
								alias: _elm_lang$core$Maybe$Nothing,
								exposed: _user$project$Indexer$Some(
									_elm_lang$core$Set$singleton(_p349._0))
							};
						} else {
	...
	function (msg, model) {
		...
		switch (_p350.ctor) {
			case 'MaybeDocsDownloaded':
				if (_p350._1.ctor === 'Err') {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Indexer$downloadDocsFailedCmd(
							_elm_lang$core$Basics$toString(_p350._1._0))
					};
				} else {
					var _p351 = A3(
						_elm_lang$core$List$foldl,
						F2(
							function (_p353, _p352) {
								var _p354 = _p353;
								var _p362 = _p354._0;
								var _p355 = _p352;
								var _p361 = _p355._0;
								...
								if (_p356.ctor === 'Ok') {
										...
										_0: A2(
											...
											_p361,
											{
												...
												_0: {
													ctor: '_Tuple2',
													_0: _p356._0._1,
													_1: {ctor: '_Tuple2', _0: _p362, _1: _p356._0._0}
												},
												_1: {ctor: '[]'}
											}),
										_1: _p360
									...
									var errorDetails = function () {
										...
										switch (_p357.ctor) {
											case 'BadUrl':
												return A2(_elm_lang$core$Basics_ops['++'], 'BadUrl ', _p357._0);
											case 'Timeout':
												return 'Timeout';
											case 'NetworkError':
												return 'NetworkError';
											case 'BadStatus':
												var _p358 = _p357._0.status;
												return A2(
													_elm_lang$core$Basics_ops['++'],
													'BadStatus ',
													A2(
														_elm_lang$core$Basics_ops['++'],
														_elm_lang$core$Basics$toString(_p358.code),
														A2(_elm_lang$core$Basics_ops['++'], ' ', _p358.message)));
											default:
												var _p359 = _p357._1.status;
												return A2(
													_elm_lang$core$Basics_ops['++'],
													'BadPayload ',
													A2(
														_elm_lang$core$Basics_ops['++'],
														_elm_lang$core$Basics$toString(_p359.code),
														A2(_elm_lang$core$Basics_ops['++'], ' ', _p359.message)));
										}
									}();
									return {
										ctor: '_Tuple2',
										...
										_1: A2(
											...
											{
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: _p362, _1: errorDetails},
												_1: {ctor: '[]'}
											})
									};
								}
						...
						A3(
							...
							_p350._0,
							_p350._1._0));
					var successes = _p351._0;
					var failures = _p351._1;
											...
											A2(
												...
												A2(
													...
													function (_p363) {
														...
														return A2(
															_elm_lang$core$Basics_ops['++'],
															_user$project$Indexer$toPackageUri(_p364._0),
															A2(
																_elm_lang$core$Basics_ops['++'],
																'documentation.json (',
																A2(_elm_lang$core$Basics_ops['++'], _p364._1, ')')));
													},
													failures))),
										_1: {ctor: '[]'}
									},
									function () {
										...
										var notFoundDependencies = A2(
											...
											A2(
												...
												function (_p365) {
													var _p366 = _p365;
													return _elm_lang$core$Native_Utils.eq(_p366._1, 'BadStatus 404 Not found');
												},
												failures));
										return (_elm_lang$core$Native_Utils.cmp(
				...
				var loadedPackageDocs = A2(
					...
					function (_p367) {
						...
						return A2(
							...
							_user$project$Indexer$toPackageUri(_p368._0),
							_p368._1);
					},
					_p350._0);
				return {
			...
			case 'UpdateActiveTokenHints':
				return A3(_user$project$Indexer$doUpdateActiveTokenHints, _p350._0._0, _p350._0._1, model);
			case 'UpdateActiveFile':
				return A4(_user$project$Indexer$doUpdateActiveFile, _p350._0._0, _p350._0._1, _p350._0._2, model);
			case 'UpdateFileContents':
				return A4(_user$project$Indexer$doUpdateFileContents, _p350._0, _p350._1, _p350._2, model);
			case 'RemoveFileContents':
				return A3(_user$project$Indexer$doRemoveFileContents, _p350._0._0, _p350._0._1, model);
			case 'UpdateProjectDependencies':
				return A3(_user$project$Indexer$doUpdateProjectDependencies, _p350._0._0, _p350._0._1, model);
			case 'DownloadMissingPackageDocs':
				return A2(_user$project$Indexer$doDownloadMissingPackageDocs, _p350._0, model);
			case 'GoToDefinition':
				return A3(_user$project$Indexer$doGoToDefinition, _p350._0._0, _p350._0._1, model);
			case 'AskCanGoToDefinition':
				return A3(_user$project$Indexer$doAskCanGoToDefinition, _p350._0._0, _p350._0._1, model);
			case 'ShowGoToSymbolView':
				return A3(_user$project$Indexer$doShowGoToSymbolView, _p350._0._0, _p350._0._1, model);
			case 'GetHintsForPartial':
				return A8(_user$project$Indexer$doGetHintsForPartial, _p350._0._0, _p350._0._1, _p350._0._2, _p350._0._3, _p350._0._4, _p350._0._5, _p350._0._6, model);
			case 'GetSuggestionsForImport':
				return A3(_user$project$Indexer$doGetSuggestionsForImport, _p350._0._0, _p350._0._1, model);
			case 'GetImporterSourcePathsForToken':
				return A4(_user$project$Indexer$doGetImporterSourcePathsForToken, _p350._0._0, _p350._0._1, _p350._0._2, model);
			case 'ShowAddImportView':
				return A3(_user$project$Indexer$doShowAddImportView, _p350._0._0, _p350._0._1, model);
			case 'AddImport':
				return A5(_user$project$Indexer$doAddImport, _p350._0._0, _p350._0._1, _p350._0._2, _p350._0._3, model);
			case 'ConstructFromTypeAnnotation':
				return A2(_user$project$Indexer$doConstructFromTypeAnnotation, _p350._0, model);
			case 'ConstructCaseOf':
				return A2(_user$project$Indexer$doConstructCaseOf, _p350._0, model);
			case 'ConstructDefaultValueForType':
				return A2(_user$project$Indexer$doConstructDefaultValueForType, _p350._0, model);
			case 'ConstructDefaultArguments':
				return A2(_user$project$Indexer$doConstructDefaultArguments, _p350._0, model);
					...
					_1: _user$project$Indexer$activeTokenHintsChangedCmd(
						{
							...
							_1: A2(
								_elm_lang$core$List$map,
								A2(_user$project$Indexer$encodeHint, model.config.showAliasesOfType, model.activeFileTokens),
								_user$project$Indexer$inferenceToHints(_p369))
						})
				};
			case 'ConfigChanged':
				return {
			...
			case 'GetAliasesOfType':
				return A2(_user$project$Indexer$doGetAliasesOfType, _p350._0, model);
				...
				_1: {
					...
					_0: _user$project$Indexer$fileContentsChangedSub(
						function (_p371) {
							var _p372 = _p371;
							var _p373 = _p372._2;
							var encodedValues = _p373.values;
							...
							return A3(
								...
								A2(
									...
									moduleDocs,
									_user$project$Indexer$toImportDict(_p372._3)));
						}),
					_1: {
						ctor: '::',
