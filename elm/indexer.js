...
var _user$project$Indexer$moduleToHints = F2(
	function (_p24, _p23) {
		...
		var _p28 = _p25.name;
		var _p26 = _p23;
		var hint = {name: _p28, moduleName: '', sourcePath: _p25.sourcePath, comment: _p25.comment, tipe: '', caseTipe: _elm_lang$core$Maybe$Nothing, kind: _user$project$Indexer$KindModule};
		var _p27 = _p26.alias;
		if (_p27.ctor === 'Nothing') {
			return _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: _p28, _1: hint}
				]);
		} else {
			return _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: _p28, _1: hint},
					{ctor: '_Tuple2', _0: _p27._0, _1: hint}
				]);
		}
	});
var _user$project$Indexer$KindTypeCase = {ctor: 'KindTypeCase'};
var _user$project$Indexer$unionTagsToHints = F3(
	function (moduleDocs, _p30, _p29) {
		var _p31 = _p30;
		var _p32 = _p29;
		var _p33 = _p32.name;
		var addHints = F2(
			function (tag, hints) {
				var localName = A3(_user$project$Indexer$getLocalName, moduleDocs.name, _p31.alias, tag);
				var hint = {
					name: tag,
					moduleName: moduleDocs.name,
					sourcePath: A2(_user$project$Indexer$formatSourcePath, moduleDocs, _p33),
					comment: _p32.comment,
					tipe: _p32.tipe,
					caseTipe: _elm_lang$core$Maybe$Just(_p33),
				...
				return (A2(_elm_lang$core$Set$member, _p33, _user$project$Indexer$defaultTypes) || A2(_user$project$Indexer$isExposed, tag, _p31.exposed)) ? A2(
					_elm_lang$core$List_ops['::'],
...
var _user$project$Indexer$getProjectSymbols = F2(
	function (projectDirectory, fileContentsDict) {
		var allFileSymbols = A2(
			...
			function (_p34) {
				var _p35 = _p34;
				var _p37 = _p35.moduleDocs;
				var _p36 = _p37;
				var sourcePath = _p36.sourcePath;
				var values = _p36.values;
				var moduleDocsSymbol = {fullName: _p37.name, sourcePath: sourcePath, caseTipe: _elm_lang$core$Maybe$Nothing, kind: _user$project$Indexer$KindModule};
				var valueSymbols = A2(
					_elm_lang$core$List$map,
					function (value) {
						...
						return {
							...
							sourcePath: A2(_user$project$Indexer$formatSourcePath, _p37, value.name),
							caseTipe: _elm_lang$core$Maybe$Nothing,
							kind: kind
						};
					},
				...
				var tipeSymbols = A2(
					...
					function (tipe) {
						return {
							...
							sourcePath: A2(_user$project$Indexer$formatSourcePath, _p37, tipe.name),
							caseTipe: _elm_lang$core$Maybe$Nothing,
						...
						return A2(
							...
							function (caseName) {
								return {
									...
									sourcePath: A2(_user$project$Indexer$formatSourcePath, _p37, caseName),
		...
		return A2(
			...
			function (_p38) {
				var _p39 = _p38;
				var _p40 = _p39.sourcePath;
				return _elm_lang$core$Basics$not(
					A2(_elm_lang$core$String$startsWith, _user$project$Indexer$packageDocsPrefix, _p40)) && A2(_user$project$Indexer$isSourcePathInProjectDirectory, projectDirectory, _p40);
			},
			allFileSymbols);
	});
...
var _user$project$Indexer$toImport = function (_p41) {
	var _p42 = _p41;
	var exposedSet = function () {
		var _p43 = _p42.exposed;
		if (_p43.ctor === 'Nothing') {
			return _user$project$Indexer$None;
		} else {
			if (((_p43._0.ctor === '::') && (_p43._0._0 === '..')) && (_p43._0._1.ctor === '[]')) {
				return _user$project$Indexer$All;
			} else {
				return _user$project$Indexer$Some(
					_elm_lang$core$Set$fromList(_p43._0));
			}
		}
	}();
	return {
		ctor: '_Tuple2',
		_0: _p42.name,
		_1: A2(_user$project$Indexer$Import, _p42.alias, exposedSet)
	};
};
...
var _user$project$Indexer$getActiveFileContents = F2(
	function (maybeActiveFile, fileContentsDict) {
		var _p44 = maybeActiveFile;
		if (_p44.ctor === 'Nothing') {
			return _user$project$Indexer$emptyFileContents;
		} else {
			var _p45 = A2(_elm_lang$core$Dict$get, _p44._0.filePath, fileContentsDict);
			if (_p45.ctor === 'Just') {
				return _p45._0;
			} else {
				return _user$project$Indexer$emptyFileContents;
...
var _user$project$Indexer$getImportersForToken = F5(
	function (rawToken, isCursorAtLastPartOfToken, maybeActiveFile, tokens, fileContentsDict) {
		...
		if (_p46.ctor === 'Just') {
			...
			var _p47 = _elm_lang$core$Native_Utils.eq(rawToken, activeFileContents.moduleDocs.name) ? {ctor: '_Tuple2', _0: rawToken, _1: true} : ((!_elm_lang$core$Native_Utils.eq(
				...
				_elm_lang$core$Maybe$Nothing)) ? {ctor: '_Tuple2', _0: rawToken, _1: true} : (isCursorAtLastPartOfToken ? {ctor: '_Tuple2', _0: rawToken, _1: false} : {
				ctor: '_Tuple2',
				_0: _user$project$Indexer$getModuleName(rawToken),
				_1: false
			}));
			var token = _p47._0;
			var willUseFullToken = _p47._1;
			var _p48 = A2(_elm_lang$core$Debug$log, 'token', token);
			var hints = A2(
			...
			return A2(
				...
				function (_p49) {
					var _p50 = _p49;
					var _p56 = _p50.moduleDocs;
					var _p55 = _p50.imports;
					var getSourcePathAndLocalNames = function (hint) {
						...
						if (isHintAModule(hint) && (!_elm_lang$core$Native_Utils.eq(
							A2(_elm_lang$core$Dict$get, token, _p55),
							_elm_lang$core$Maybe$Nothing))) {
							return _elm_lang$core$Maybe$Just(
								{
									ctor: '_Tuple3',
							...
							var _p51 = A2(_elm_lang$core$Dict$get, hint.moduleName, _p55);
							if (_p51.ctor === 'Nothing') {
								var isHintThisModule = isHintAModule(hint) && _elm_lang$core$Native_Utils.eq(hint.name, _p56.name);
								var isHintInThisModule = _elm_lang$core$Native_Utils.eq(hint.moduleName, _p56.name);
								return isHintInThisModule ? _elm_lang$core$Maybe$Just(
									{
										...
										_2: _elm_lang$core$Native_List.fromArray(
											[hint.name])
									}) : (isHintThisModule ? _elm_lang$core$Maybe$Just(
									{
										ctor: '_Tuple3',
										_0: _p56.sourcePath,
										_1: willUseFullToken,
								...
								var _p54 = _p51._0.alias;
								var localNames = function () {
									var _p52 = {ctor: '_Tuple2', _0: _p54, _1: _p51._0.exposed};
									switch (_p52._1.ctor) {
										case 'None':
											if (_p52._0.ctor === 'Nothing') {
												return _elm_lang$core$Native_List.fromArray(
													[
														A2(
														_elm_lang$core$Basics_ops['++'],
										...
										case 'All':
											return _elm_lang$core$Native_List.fromArray(
												[
													hint.name,
													A3(_user$project$Indexer$getLocalName, hint.moduleName, _p54, hint.name)
												]);
										default:
											return A2(_elm_lang$core$Set$member, hint.name, _p52._1._0) ? _elm_lang$core$Native_List.fromArray(
												[
													hint.name,
													A3(_user$project$Indexer$getLocalName, hint.moduleName, _p54, hint.name)
												]) : _elm_lang$core$Native_List.fromArray(
								...
								if (_p53.ctor === '[]') {
									...
									return _elm_lang$core$Maybe$Just(
										{ctor: '_Tuple3', _0: _p56.sourcePath, _1: willUseFullToken, _2: names});
								}
							}
						}
					};
		...
		if (_p57.ctor === 'Nothing') {
			...
			var importedModuleDocs = A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					packageDocs,
					A2(_user$project$Indexer$getProjectModuleDocs, _p57._0.projectDirectory, fileContentsDict)));
				...
				A2(
					...
					function (moduleDocs) {
						var exposed = function () {
							var _p58 = A2(_elm_lang$core$Dict$get, moduleDocs.name, importsPlusActiveModule);
							if (_p58.ctor === 'Nothing') {
								return _user$project$Indexer$None;
							} else {
								return _p58._0.exposed;
							}
						}();
						return A2(
							_elm_lang$core$List$map,
							...
							A2(
								...
								A2(
									...
									A2(
										...
										function (_p59) {
											var _p60 = _p59;
											return A2(_user$project$Indexer$isExposed, _p60.name, exposed);
										},
										A2(
											_elm_lang$core$Basics_ops['++'],
											moduleDocs.values.aliases,
								...
								A2(
									...
									function (_p61) {
										...
										return A2(
											_elm_lang$core$List$filter,
											function (kase) {
												return A2(_elm_lang$core$Set$member, _p62.name, _user$project$Indexer$defaultTypes) || A2(_user$project$Indexer$isExposed, kase, exposed);
											},
											_p62.cases);
									},
									moduleDocs.values.tipes)));
		...
		var importAliases = A2(
			...
			function (_p65) {
				...
				if (_p67.ctor === 'Nothing') {
					...
					var _p68 = _p67._0;
					return A2(_elm_lang$core$String$startsWith, partial, _p68) ? _elm_lang$core$Maybe$Just(
						_elm_lang$core$Native_Utils.update(
							_user$project$Indexer$emptyHint,
							{name: _p68})) : _elm_lang$core$Maybe$Nothing;
				}
			},
					...
					if (_elm_lang$core$Native_Utils.eq(hint.moduleName, '')) {
						...
						if (A2(
							...
							var moduleNamePrefix = function () {
								var _p69 = A2(_elm_lang$core$Dict$get, hint.moduleName, activeFileContents.imports);
								if (_p69.ctor === 'Nothing') {
									return '';
								} else {
									var _p70 = _p69._0.alias;
									if (_p70.ctor === 'Nothing') {
										return A2(_elm_lang$core$Basics_ops['++'], hint.moduleName, '.');
									} else {
										return A2(_elm_lang$core$Basics_ops['++'], _p70._0, '.');
									}
								}
							}();
			...
			var getMaybeHints = function (moduleDocs) {
				return A2(
					...
					A2(
						...
						moduleDocs.name,
						A2(_user$project$Indexer$getImportsPlusActiveModuleForActiveFile, activeFile, fileContentsDict)));
			};
			return A3(
				_elm_lang$core$List$foldl,
				insert,
				...
				_elm_lang$core$List$concat(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							packageDocsList,
							A2(_user$project$Indexer$getProjectModuleDocs, _p71._0.projectDirectory, fileContentsDict)))));
		}
	});
var _user$project$Indexer$update = F2(
	function (msg, model) {
		...
		switch (_p74.ctor) {
			...
			case 'DocsLoaded':
				...
				var missingPackageDocs = A2(
					...
					function (_p76) {
						var _p77 = _p76;
						return _elm_lang$core$Basics$not(
							A2(_elm_lang$core$List$member, _p77.sourcePath, existingPackages));
					},
					_p74._0);
			...
			case 'CursorMove':
				var updatedActiveHints = A2(_user$project$Indexer$getHintsForToken, _p74._0, model.activeTokens);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'UpdateActiveFile':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							activeFile: _p78,
							activeTokens: A3(_user$project$Indexer$toTokenDict, _p78, model.fileContentsDict, model.packageDocs)
						}),
					_1: _user$project$Indexer$activeFileChangedCmd(_p78)
				};
			case 'UpdateFileContents':
				var updatedFileContentsDict = A3(
					...
					_p74._0,
					_elm_lang$core$Basics$always(
						_elm_lang$core$Maybe$Just(_p74._1)),
			...
			case 'RemoveFileContents':
				var updatedFileContentsDict = A2(_elm_lang$core$Dict$remove, _p74._0, model.fileContentsDict);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'UpdatePackageDocs':
				...
				var missingPackages = A2(
					...
					A2(_elm_lang$core$List$map, _user$project$Indexer$toPackageUri, _p74._0));
				return {
					ctor: '_Tuple2',
					_0: model,
			...
			case 'GoToDefinition':
				var requests = A2(
					...
					A2(_user$project$Indexer$getHintsForToken, _p74._0, model.activeTokens));
				return {
					ctor: '_Tuple2',
					_0: model,
			...
			case 'GoToSymbol':
				...
				if (_p79.ctor === 'Nothing') {
					...
					var hints = A2(_user$project$Indexer$getHintsForToken, _p83, model.activeTokens);
					var defaultSymbolName = function () {
						var _p80 = _elm_lang$core$List$head(hints);
						if (_p80.ctor === 'Nothing') {
							return _p83;
						} else {
							var _p82 = _p80._0;
							var _p81 = model.activeFile;
							if (_p81.ctor === 'Nothing') {
								return _elm_lang$core$Maybe$Just(_p82.name);
							} else {
								return _elm_lang$core$Native_Utils.eq(_p81._0.filePath, _p82.sourcePath) ? _elm_lang$core$Maybe$Just(
									_user$project$Indexer$getLastName(_p82.name)) : _elm_lang$core$Maybe$Just(_p82.name);
							}
						}
					}();
					return {
						...
						_1: _user$project$Indexer$goToSymbolCmd(
							{
								...
								_2: A2(
									...
									A2(_user$project$Indexer$getProjectSymbols, _p79._0, model.fileContentsDict))
							})
					};
				}
					...
					_1: _user$project$Indexer$hintsForPartialReceivedCmd(
						{
							...
							_1: A2(
								...
								A5(_user$project$Indexer$getHintsForPartial, _p84, model.activeFile, model.fileContentsDict, model.packageDocs, model.activeTokens))
						})
				};
					...
					_1: _user$project$Indexer$suggestionsForImportReceivedCmd(
						{
							ctor: '_Tuple2',
							_0: _p85,
							_1: A4(_user$project$Indexer$getSuggestionsForImport, _p85, model.activeFile, model.fileContentsDict, model.packageDocs)
						})
				};
					...
					_1: _user$project$Indexer$canGoToDefinitionRepliedCmd(
						{
							ctor: '_Tuple2',
							_0: _p86,
							_1: A2(_elm_lang$core$Dict$member, _p86, model.activeTokens)
						})
				};
			default:
				var _p87 = {ctor: '_Tuple3', _0: _p74._0._0, _1: _p74._0._1, _2: _p74._0._2};
				if ((((_p87.ctor === '_Tuple3') && (_p87._0.ctor === 'Just')) && (_p87._1.ctor === 'Just')) && (_p87._2.ctor === 'Just')) {
					var _p89 = _p87._1._0;
					var _p88 = _p87._2._0;
					return {
						ctor: '_Tuple2',
						...
						_1: _user$project$Indexer$importersForTokenReceivedCmd(
							{
								...
								_1: _p89,
								_2: _p88,
								_3: A5(_user$project$Indexer$getImportersForToken, _p89, _p88, model.activeFile, model.activeTokens, model.fileContentsDict)
							})
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				...
				function (_p90) {
					...
					return A2(
						...
						A2(
							...
							_p91._1,
							_user$project$Indexer$toImportDict(_p91._2)));
				}),
