	...
	function (maybeToken, maybeActiveFile, tokens, fileContentsDict) {
		...
		if (((_p23.ctor === '_Tuple2') && (_p23._0.ctor === 'Just')) && (_p23._1.ctor === 'Just')) {
			...
			return A2(
				...
				function (_p24) {
					var _p25 = _p24;
					var _p29 = _p25.moduleDocs;
					var _p26 = _elm_lang$core$List$head(hints);
					if (_p26.ctor === 'Nothing') {
						return _elm_lang$core$Maybe$Nothing;
					} else {
						var _p28 = _p26._0;
						if (_elm_lang$core$Native_Utils.eq(_p28.moduleName, _p29.name)) {
							return _elm_lang$core$Maybe$Just(
								{ctor: '_Tuple2', _0: _p29.sourcePath, _1: _p28.name});
						} else {
							var _p27 = A2(_elm_lang$core$Dict$get, _p28.moduleName, _p25.imports);
							if (_p27.ctor === 'Nothing') {
								return _elm_lang$core$Maybe$Nothing;
							} else {
								return A2(_user$project$Indexer$isExposed, _p28.name, _p27._0.exposed) ? _elm_lang$core$Maybe$Just(
									{
										ctor: '_Tuple2',
										_0: _p29.sourcePath,
										_1: A3(_user$project$Indexer$getLocalName, _p29.name, _p27._0.alias, _p28.name)
									}) : _elm_lang$core$Maybe$Nothing;
							}
						}
					}
				},
				A2(_user$project$Indexer$getProjectFileContents, _p23._1._0.projectDirectory, fileContentsDict));
		} else {
			return _elm_lang$core$Native_List.fromArray(
				[]);
		}
...
var _user$project$Indexer$moduleToHints = F2(
	function (_p31, _p30) {
		...
		var _p35 = _p32.name;
		var _p33 = _p30;
		var hint = {name: _p35, moduleName: '', sourcePath: _p32.sourcePath, comment: _p32.comment, tipe: '', caseTipe: _elm_lang$core$Maybe$Nothing, kind: _user$project$Indexer$KindModule};
		var _p34 = _p33.alias;
		if (_p34.ctor === 'Nothing') {
			return _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: _p35, _1: hint}
				]);
		} else {
			return _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: _p35, _1: hint},
					{ctor: '_Tuple2', _0: _p34._0, _1: hint}
				]);
		}
	});
var _user$project$Indexer$KindTypeCase = {ctor: 'KindTypeCase'};
var _user$project$Indexer$unionTagsToHints = F3(
	function (moduleDocs, _p37, _p36) {
		var _p38 = _p37;
		var _p39 = _p36;
		var _p40 = _p39.name;
		var addHints = F2(
			function (tag, hints) {
				var localName = A3(_user$project$Indexer$getLocalName, moduleDocs.name, _p38.alias, tag);
				var hint = {
					name: tag,
					moduleName: moduleDocs.name,
					...
					tipe: _p39.tipe,
					caseTipe: _elm_lang$core$Maybe$Just(_p40),
				...
				return (A2(_elm_lang$core$Set$member, _p40, _user$project$Indexer$defaultTypes) || A2(_user$project$Indexer$isExposed, tag, _p38.exposed)) ? A2(
					_elm_lang$core$List_ops['::'],
...
var _user$project$Indexer$getProjectSymbols = F2(
	function (projectDirectory, fileContentsDict) {
		var allFileSymbols = A2(
			...
			function (_p41) {
				var _p42 = _p41;
				var _p44 = _p42.moduleDocs;
				var _p43 = _p44;
				var sourcePath = _p43.sourcePath;
				var values = _p43.values;
				var moduleDocsSymbol = {fullName: _p44.name, sourcePath: sourcePath, caseTipe: _elm_lang$core$Maybe$Nothing, kind: _user$project$Indexer$KindModule};
				var valueSymbols = A2(
					_elm_lang$core$List$map,
					function (value) {
						...
						return {
							...
							sourcePath: A2(_user$project$Indexer$formatSourcePath, _p44, value.name),
							caseTipe: _elm_lang$core$Maybe$Nothing,
							kind: kind
						};
					},
				...
				var tipeSymbols = A2(
					...
					function (tipe) {
						return {
							...
							sourcePath: A2(_user$project$Indexer$formatSourcePath, _p44, tipe.name),
							caseTipe: _elm_lang$core$Maybe$Nothing,
						...
						return A2(
							...
							function (caseName) {
								return {
									...
									sourcePath: A2(_user$project$Indexer$formatSourcePath, _p44, caseName),
		...
		return A2(
			...
			function (_p45) {
				var _p46 = _p45;
				var _p47 = _p46.sourcePath;
				return _elm_lang$core$Basics$not(
					A2(_elm_lang$core$String$startsWith, _user$project$Indexer$packageDocsPrefix, _p47)) && A2(_user$project$Indexer$isSourcePathInProjectDirectory, projectDirectory, _p47);
			},
			allFileSymbols);
	});
...
var _user$project$Indexer$toImport = function (_p48) {
	var _p49 = _p48;
	var exposedSet = function () {
		var _p50 = _p49.exposed;
		if (_p50.ctor === 'Nothing') {
			return _user$project$Indexer$None;
		} else {
			if (((_p50._0.ctor === '::') && (_p50._0._0 === '..')) && (_p50._0._1.ctor === '[]')) {
				return _user$project$Indexer$All;
			} else {
				return _user$project$Indexer$Some(
					_elm_lang$core$Set$fromList(_p50._0));
			}
		}
	}();
	return {
		ctor: '_Tuple2',
		_0: _p49.name,
		_1: A2(_user$project$Indexer$Import, _p49.alias, exposedSet)
	};
};
...
var _user$project$Indexer$getActiveFileContents = F2(
	function (maybeActiveFile, fileContentsDict) {
		...
		if (_p51.ctor === 'Nothing') {
			...
			var _p52 = A2(_elm_lang$core$Dict$get, _p51._0.filePath, fileContentsDict);
			if (_p52.ctor === 'Just') {
				return _p52._0;
			} else {
				return _user$project$Indexer$emptyFileContents;
		...
		if (_p53.ctor === 'Nothing') {
			...
			var importedModuleDocs = A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					packageDocs,
					A2(_user$project$Indexer$getProjectModuleDocs, _p53._0.projectDirectory, fileContentsDict)));
				...
				A2(
					...
					function (moduleDocs) {
						var exposed = function () {
							var _p54 = A2(_elm_lang$core$Dict$get, moduleDocs.name, importsPlusActiveModule);
							if (_p54.ctor === 'Nothing') {
								return _user$project$Indexer$None;
							} else {
								return _p54._0.exposed;
							}
						}();
						return A2(
							_elm_lang$core$List$map,
							...
							A2(
								...
								A2(
									...
									A2(
										...
										function (_p55) {
											var _p56 = _p55;
											return A2(_user$project$Indexer$isExposed, _p56.name, exposed);
										},
										A2(
											_elm_lang$core$Basics_ops['++'],
											moduleDocs.values.aliases,
								...
								A2(
									...
									function (_p57) {
										...
										return A2(
											_elm_lang$core$List$filter,
											function (kase) {
												return A2(_elm_lang$core$Set$member, _p58.name, _user$project$Indexer$defaultTypes) || A2(_user$project$Indexer$isExposed, kase, exposed);
											},
											_p58.cases);
									},
									moduleDocs.values.tipes)));
...
var _user$project$Indexer$getHintsForPartial = F5(
	function (partial, activeFile, fileContentsDict, packageDocs, tokens) {
		var defaultHints = A2(
			...
			function (_p59) {
				var _p60 = _p59;
				return A2(_elm_lang$core$String$startsWith, partial, _p60.name);
			},
		...
		var importAliases = A2(
			...
			function (_p61) {
				...
				if (_p63.ctor === 'Nothing') {
					...
					var _p64 = _p63._0;
					return A2(_elm_lang$core$String$startsWith, partial, _p64) ? _elm_lang$core$Maybe$Just(
						_elm_lang$core$Native_Utils.update(
							_user$project$Indexer$emptyHint,
							{name: _p64})) : _elm_lang$core$Maybe$Nothing;
				}
			},
					...
					if (_elm_lang$core$Native_Utils.eq(hint.moduleName, '')) {
						...
						if (A2(
							...
							var moduleNamePrefix = function () {
								var _p65 = A2(_elm_lang$core$Dict$get, hint.moduleName, activeFileContents.imports);
								if (_p65.ctor === 'Nothing') {
									return '';
								} else {
									var _p66 = _p65._0.alias;
									if (_p66.ctor === 'Nothing') {
										return A2(_elm_lang$core$Basics_ops['++'], hint.moduleName, '.');
									} else {
										return A2(_elm_lang$core$Basics_ops['++'], _p66._0, '.');
									}
								}
							}();
				...
				_elm_lang$core$List$concat(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							packageDocsList,
							A2(_user$project$Indexer$getProjectModuleDocs, _p67._0.projectDirectory, fileContentsDict)))));
		}
	});
var _user$project$Indexer$update = F2(
	function (msg, model) {
		...
		switch (_p70.ctor) {
			...
			case 'DocsLoaded':
				var truncateComment = function (moduleDocs) {
					var truncatedComment = function () {
						var _p71 = _elm_lang$core$List$head(
				...
				var missingPackageDocs = A2(
					...
					function (_p72) {
						var _p73 = _p72;
						return _elm_lang$core$Basics$not(
							A2(_elm_lang$core$List$member, _p73.sourcePath, existingPackages));
					},
					_p70._0);
			...
			case 'CursorMove':
				var updatedActiveHints = A2(_user$project$Indexer$getHintsForToken, _p70._0, model.activeTokens);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'UpdateActiveFile':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							activeFile: _p74,
							activeTokens: A3(_user$project$Indexer$toTokenDict, _p74, model.fileContentsDict, model.packageDocs)
						}),
					_1: _user$project$Indexer$activeFileChangedCmd(_p74)
				};
			case 'UpdateFileContents':
				var updatedFileContentsDict = A3(
					...
					_p70._0,
					_elm_lang$core$Basics$always(
						_elm_lang$core$Maybe$Just(_p70._1)),
			...
			case 'RemoveFileContents':
				var updatedFileContentsDict = A2(_elm_lang$core$Dict$remove, _p70._0, model.fileContentsDict);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'UpdatePackageDocs':
				...
				var missingPackages = A2(
					...
					A2(_elm_lang$core$List$map, _user$project$Indexer$toPackageUri, _p70._0));
				return {
					ctor: '_Tuple2',
					_0: model,
			...
			case 'GoToDefinition':
				var requests = A2(
					...
					A2(_user$project$Indexer$getHintsForToken, _p70._0, model.activeTokens));
				return {
					ctor: '_Tuple2',
					_0: model,
			...
			case 'GoToSymbol':
				...
				if (_p75.ctor === 'Nothing') {
					...
					var hints = A2(_user$project$Indexer$getHintsForToken, _p79, model.activeTokens);
					var defaultSymbolName = function () {
						var _p76 = _elm_lang$core$List$head(hints);
						if (_p76.ctor === 'Nothing') {
							return _p79;
						} else {
							var _p78 = _p76._0;
							var _p77 = model.activeFile;
							if (_p77.ctor === 'Nothing') {
								return _elm_lang$core$Maybe$Just(_p78.name);
							} else {
								return _elm_lang$core$Native_Utils.eq(_p77._0.filePath, _p78.sourcePath) ? _elm_lang$core$Maybe$Just(
									_user$project$Indexer$getLastName(_p78.name)) : _elm_lang$core$Maybe$Just(_p78.name);
							}
						}
					}();
					return {
						...
						_1: _user$project$Indexer$goToSymbolCmd(
							{
								...
								_2: A2(
									...
									A2(_user$project$Indexer$getProjectSymbols, _p75._0, model.fileContentsDict))
							})
					};
				}
					...
					_1: _user$project$Indexer$hintsForPartialReceivedCmd(
						{
							...
							_1: A2(
								...
								A5(_user$project$Indexer$getHintsForPartial, _p80, model.activeFile, model.fileContentsDict, model.packageDocs, model.activeTokens))
						})
				};
					...
					_1: _user$project$Indexer$suggestionsForImportReceivedCmd(
						{
							ctor: '_Tuple2',
							_0: _p81,
							_1: A4(_user$project$Indexer$getSuggestionsForImport, _p81, model.activeFile, model.fileContentsDict, model.packageDocs)
						})
				};
					...
					_1: _user$project$Indexer$canGoToDefinitionRepliedCmd(
						{
							ctor: '_Tuple2',
							_0: _p82,
							_1: A2(_elm_lang$core$Dict$member, _p82, model.activeTokens)
						})
				};
			default:
				var _p84 = _p70._0._1;
						...
						_1: _user$project$Indexer$importersForTokenReceivedCmd(
							{
								ctor: '_Tuple2',
								_0: _p84,
								_1: A4(_user$project$Indexer$getImportersForToken, _p84, model.activeFile, model.activeTokens, model.fileContentsDict)
							})
					};
				}
		}
