					...
					if (_user$project$Indexer$isRecordString(tipeString)) {
						var fieldAndValues = A2(
							...
							A2(
								...
								_user$project$Indexer$getRecordTipeParts(tipeString)));
						var _p161 = A2(_elm_lang$core$Debug$log, 'isRecordString', tipeString);
						return A2(
							_elm_lang$core$Basics_ops['++'],
							'{ ',
							A2(_elm_lang$core$Basics_ops['++'], fieldAndValues, ' }'));
												...
												if ((!_elm_lang$core$Native_Utils.eq(_p168.kind, _user$project$Indexer$KindType)) && ((!_elm_lang$core$Native_Utils.eq(_p168.tipe, _p169)) && ((!_elm_lang$core$Native_Utils.eq(_p168.kind, _user$project$Indexer$KindTypeAlias)) || (_elm_lang$core$Native_Utils.eq(_p168.kind, _user$project$Indexer$KindTypeAlias) && _elm_lang$core$Native_Utils.eq(
													...
													if (A2(_elm_lang$core$Set$member, _p168.name, visitedTypes)) {
														...
														var _v135 = activeFileTokens,
															_v136 = A2(_elm_lang$core$Set$insert, _p168.name, visitedTypes),
															_v137 = _p168.tipe;
									...
									A2(
										...
										F2(
											function (index, _p173) {
												var _p174 = _p173;
												var _p175 = _p174._0;
												var prefix = _elm_lang$core$Native_Utils.eq(index, 0) ? '[ ' : A2(
													_elm_lang$core$Basics_ops['++'],
													_user$project$Helper$indent(1),
													', ');
												return A2(
						...
						if (_p176.ctor === 'Just') {
							...
							switch (_p177) {
								...
								default:
									var _p180 = _p177;
									if (_elm_lang$core$Native_Utils.eq(
										_user$project$Indexer$getLastName(_p180),
										'Value') && (_elm_lang$core$Native_Utils.eq(
										_user$project$Indexer$getModuleName(_p180),
										encoderModuleName) || _elm_lang$core$Native_Utils.eq(
										A2(
											_elm_lang$core$Basics_ops['++'],
											_user$project$Indexer$getModuleName(_p180),
											'.'),
										...
										var _p178 = _elm_lang$core$List$head(
											A2(
												_user$project$Indexer$getHintsForToken,
												_elm_lang$core$Maybe$Just(_p180),
												activeFileTokens));
										if (_p178.ctor === 'Just') {
											var _p179 = _p178._0;
											if ((!_elm_lang$core$Native_Utils.eq(_p179.kind, _user$project$Indexer$KindType)) && ((!_elm_lang$core$Native_Utils.eq(_p179.tipe, _p180)) && ((!_elm_lang$core$Native_Utils.eq(_p179.kind, _user$project$Indexer$KindTypeAlias)) || (_elm_lang$core$Native_Utils.eq(_p179.kind, _user$project$Indexer$KindTypeAlias) && _elm_lang$core$Native_Utils.eq(
												_elm_lang$core$List$length(_p179.args),
												0))))) {
												if (A2(_elm_lang$core$Set$member, _p179.name, visitedTypes)) {
													return '_';
												} else {
													var _v145 = activeFileTokens,
														_v146 = A2(_elm_lang$core$Set$insert, _p179.name, visitedTypes),
														_v147 = encoderModuleName,
														_v148 = _elm_lang$core$Maybe$Just(_p179.name),
														_v149 = _p179.tipe;
													activeFileTokens = _v145;
													visitedTypes = _v146;
													encoderModuleName = _v147;
													maybeObjectName = _v148;
													tipeString = _v149;
													continue getDefaultEncoderRecur;
												}
											} else {
												if (_elm_lang$core$Native_Utils.eq(_p179.kind, _user$project$Indexer$KindType)) {
													return A2(
														_elm_lang$core$Basics_ops['++'],
														A2(
															_elm_lang$core$Basics_ops['++'],
				...
				A2(
					...
					A2(
						...
						A2(
							...
							_user$project$Helper$indent(1),
							function () {
								var _p181 = _elm_lang$core$List$head(parameterTipes);
								if (_p181.ctor === 'Just') {
...
var _user$project$Indexer$getModuleSymbols = function (moduleDocs) {
	var _p182 = moduleDocs;
	var sourcePath = _p182.sourcePath;
	var values = _p182.values;
...
var _user$project$Indexer$getProjectFileSymbols = F2(
	function (projectDirectory, projectFileContentsDict) {
		...
		var allFileSymbols = A2(
			...
			function (_p183) {
				var _p184 = _p183;
				return _user$project$Indexer$getModuleSymbols(_p184.moduleDocs);
			},
			_elm_lang$core$Dict$values(fileContentsDict));
		return A2(
			_elm_lang$core$List$filter,
			function (_p185) {
				var _p186 = _p185;
				return _user$project$Indexer$isProjectSourcePath(_p186.sourcePath);
			},
			allFileSymbols);
	});
var _user$project$Indexer$doShowGoToSymbolView = F3(
	function (maybeProjectDirectory, maybeToken, model) {
		var _p187 = maybeProjectDirectory;
		if (_p187.ctor === 'Just') {
			var hints = A2(_user$project$Indexer$getHintsForToken, maybeToken, model.activeFileTokens);
			var defaultSymbolName = function () {
				var _p188 = _elm_lang$core$List$head(hints);
				if (_p188.ctor === 'Just') {
					var _p190 = _p188._0;
					var _p189 = model.activeFile;
					if (_p189.ctor === 'Just') {
						return _elm_lang$core$Native_Utils.eq(_p189._0.filePath, _p190.sourcePath) ? _elm_lang$core$Maybe$Just(
							_user$project$Indexer$getLastName(_p190.name)) : _elm_lang$core$Maybe$Just(_p190.name);
					} else {
						return _elm_lang$core$Maybe$Just(_p190.name);
					}
				} else {
					return maybeToken;
				}
				...
				_1: _user$project$Indexer$showGoToSymbolViewCmd(
					{
						...
						_2: A2(
							...
							A2(_user$project$Indexer$getProjectFileSymbols, _p187._0, model.projectFileContentsDict))
					})
			};
		} else {
...
var _user$project$Indexer$getProjectSymbols = F4(
	function (maybeActiveFile, projectFileContentsDict, projectDependencies, packageDocs) {
		var _p191 = maybeActiveFile;
		if (_p191.ctor === 'Just') {
			return A2(
				_elm_lang$core$List$append,
				A2(_user$project$Indexer$getProjectFileSymbols, _p191._0.projectDirectory, projectFileContentsDict),
...
var _user$project$Indexer$doShowAddImportView = F3(
	function (filePath, maybeToken, model) {
		var defaultSymbolName = function () {
			var _p192 = maybeToken;
			if (_p192.ctor === 'Just') {
				var _p194 = _p192._0;
				var _p193 = _user$project$Indexer$getModuleName(_p194);
				if (_p193 === '') {
					return _elm_lang$core$Maybe$Just(
						_user$project$Indexer$getLastName(_p194));
				} else {
					return _elm_lang$core$Maybe$Just(
						_user$project$Indexer$getModuleName(_p194));
				}
			} else {
				return _elm_lang$core$Maybe$Nothing;
			}
		...
		var moduleAndSymbols = A2(
			...
			A2(
				...
				function (_p195) {
					var _p196 = _p195;
					return (!_elm_lang$core$Native_Utils.eq(_p196.sourcePath, filePath)) && (!_elm_lang$core$Native_Utils.eq(
						_user$project$Indexer$getLastName(_p196.fullName),
						''));
				},
		...
		var moduleAndSymbolsAndAllExposed = A2(
			...
			F2(
				function (_p201, _p200) {
					...
					var filterKey = F2(
						function (moduleName, symbolName) {
							return A2(
								...
								moduleName,
								function () {
									var _p204 = symbolName;
									if (_p204.ctor === 'Just') {
										return A2(_elm_lang$core$Basics_ops['++'], ' ', _p204._0);
									} else {
										return '';
									}
								}());
					...
					return A2(
						_elm_lang$core$Basics$compare,
						A2(filterKey, _p202._0, _p202._1),
...
var _user$project$Indexer$getHintsForUnexposedNames = F3(
	function (includeQualified, moduleDocs, unexposedNames) {
		var filter = function (_p207) {
			var _p208 = _p207;
			return A2(_elm_lang$core$Set$member, _p208.name, unexposedNames);
		};
		...
		var _p209 = A3(
			...
			F2(
				function (moduleDocs, _p210) {
					...
					var allNames = _elm_lang$core$Set$fromList(
						A2(
							...
							A2(
								...
								tipeCases)));
					var _p212 = function () {
						var _p213 = A2(_elm_lang$core$Dict$get, moduleDocs.name, imports);
						if (_p213.ctor === 'Just') {
							var exposed = A2(
								_elm_lang$core$List$map,
								function (_p214) {
									var _p215 = _p214;
									var _p216 = _p215._1;
									var moduleNameToShow = (_elm_lang$core$Native_Utils.eq(_p216.moduleName, '') || _elm_lang$core$Native_Utils.eq(activeFilePath, _p216.sourcePath)) ? '' : _p216.moduleName;
									return _elm_lang$core$Native_Utils.update(
										_p216,
										{moduleName: moduleNameToShow, name: _p215._0});
								},
								A3(_user$project$Indexer$getFilteredHints, activeFilePath, moduleDocs, _p213._0));
					...
					var exposedHints = _p212._0;
					var unexposedHints = _p212._1;
					return {
						ctor: '_Tuple2',
						_0: {ctor: '::', _0: exposedHints, _1: _p211._0},
						_1: {ctor: '::', _0: unexposedHints, _1: _p211._1}
					};
				}),
			{
				ctor: '_Tuple2',
			...
			moduleDocsList);
		var exposedLists = _p209._0;
		var unexposedLists = _p209._1;
		return {
			ctor: '_Tuple2',
...
var _user$project$Indexer$getExternalHints = F4(
	function (isGlobal, filePath, activeFileContents, allModuleDocs) {
		var moduleDocsToCheck = isGlobal ? A2(
			...
			allModuleDocs);
		var _p217 = A4(_user$project$Indexer$getExposedAndUnexposedHints, isGlobal, filePath, activeFileContents.imports, moduleDocsToCheck);
		var importedHints = _p217._0;
		var unimportedHints = _p217._1;
...
var _user$project$Indexer$toImport = function (_p219) {
	var _p220 = _p219;
	var exposedSet = function () {
		var _p221 = _p220.exposed;
		if (_p221.ctor === 'Just') {
			if (((_p221._0.ctor === '::') && (_p221._0._0 === '..')) && (_p221._0._1.ctor === '[]')) {
				return _user$project$Indexer$All;
			} else {
				return _user$project$Indexer$Some(
					_elm_lang$core$Set$fromList(_p221._0));
			}
		} else {
	...
	return {
		ctor: '_Tuple2',
		_0: _p220.name,
		_1: A2(_user$project$Indexer$Import, _p220.alias, exposedSet)
	};
};
...
var _user$project$Indexer$getActiveFileContents = F2(
	function (maybeActiveFile, fileContentsDict) {
		var _p222 = maybeActiveFile;
		if (_p222.ctor === 'Just') {
			var _p223 = A2(_elm_lang$core$Dict$get, _p222._0.filePath, fileContentsDict);
			if (_p223.ctor === 'Just') {
				return _p223._0;
			} else {
...
var _user$project$Indexer$doGetImporterSourcePathsForToken = F4(
	function (maybeProjectDirectory, maybeToken, maybeIsCursorAtLastPartOfToken, model) {
		var _p224 = {ctor: '_Tuple3', _0: maybeProjectDirectory, _1: maybeToken, _2: maybeIsCursorAtLastPartOfToken};
		if ((((_p224.ctor === '_Tuple3') && (_p224._0.ctor === 'Just')) && (_p224._1.ctor === 'Just')) && (_p224._2.ctor === 'Just')) {
			var _p228 = _p224._1._0;
			var _p227 = _p224._0._0;
			var _p226 = _p224._2._0;
			var fileContentsDict = A2(_user$project$Indexer$getFileContentsOfProject, _p227, model.projectFileContentsDict);
			var activeFileContents = A2(_user$project$Indexer$getActiveFileContents, model.activeFile, fileContentsDict);
			var _p225 = _elm_lang$core$Native_Utils.eq(_p228, activeFileContents.moduleDocs.name) ? {ctor: '_Tuple2', _0: _p228, _1: true} : ((!_elm_lang$core$Native_Utils.eq(
				A2(_elm_lang$core$Dict$get, _p228, activeFileContents.imports),
				_elm_lang$core$Maybe$Nothing)) ? {ctor: '_Tuple2', _0: _p228, _1: true} : (_p226 ? {ctor: '_Tuple2', _0: _p228, _1: false} : {
				ctor: '_Tuple2',
				_0: _user$project$Indexer$getModuleName(_p228),
				_1: false
			}));
			var token = _p225._0;
			var willUseFullToken = _p225._1;
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _user$project$Indexer$importersForTokenReceivedCmd(
					{
						...
						_2: willUseFullToken,
						_3: _p226,
						_4: A6(_user$project$Indexer$getImportersForToken, token, _p226, model.activeFile, model.activeFileTokens, activeFileContents, model.projectFileContentsDict)
					})
			};
		} else {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$Indexer$getExternalAndLocalHints = F8(
	function (isGlobal, maybeActiveFile, projectFileContentsDict, projectDependencies, packageDocs, maybeCachedExternal, maybeCachedLocal, activeFileTokens) {
		var _p229 = maybeActiveFile;
		if (_p229.ctor === 'Just') {
			var _p233 = _p229._0.projectDirectory;
			var _p232 = _p229._0.filePath;
			var fileContentsDict = A2(_user$project$Indexer$getFileContentsOfProject, _p233, projectFileContentsDict);
			var activeFileContents = A2(_user$project$Indexer$getActiveFileContents, maybeActiveFile, fileContentsDict);
			var local = function () {
				var _p230 = maybeCachedLocal;
				if (_p230.ctor === 'Just') {
					return _p230._0;
				} else {
					return A3(_user$project$Indexer$getLocalHints, _p232, activeFileContents, activeFileTokens);
				}
			}();
			...
			var allModuleDocs = A2(
				_elm_lang$core$Basics_ops['++'],
				projectPackageDocs,
				A2(_user$project$Indexer$getProjectModuleDocs, _p233, projectFileContentsDict));
			var external = function () {
				var _p231 = maybeCachedExternal;
				if (_p231.ctor === 'Just') {
					return _p231._0;
				} else {
					return A4(_user$project$Indexer$getExternalHints, isGlobal, _p232, activeFileContents, allModuleDocs);
				}
			}();
			return {
											...
											return function (maybeHintsCache) {
												return function (activeFileTokens) {
													...
													if (_p234.ctor === 'Just') {
														...
														var _p235 = function () {
															var _p236 = maybeHintsCache;
															if (_p236.ctor === 'Just') {
																var _p238 = _p236._0;
																var _p237 = {ctor: '_Tuple2', _0: _p238.external, _1: _p238.local};
																if ((_p237._0.ctor === 'Just') && (_p237._1.ctor === 'Just')) {
																	return _p238;
																} else {
																	return A8(_user$project$Indexer$getExternalAndLocalHints, isGlobal, maybeActiveFile, projectFileContentsDict, projectDependencies, packageDocs, _p237._0, _p237._1, activeFileTokens);
																}
															} else {
														...
														var external = _p235.external;
														var local = _p235.local;
														var _p239 = function () {
															var _p240 = {ctor: '_Tuple2', _0: external, _1: local};
															if (((_p240.ctor === '_Tuple2') && (_p240._0.ctor === 'Just')) && (_p240._1.ctor === 'Just')) {
																var _p242 = _p240._1._0;
																var _p241 = _p240._0._0;
																return {
																	ctor: '_Tuple3',
																	_0: A2(_elm_lang$core$Basics_ops['++'], _p241.importedHints, _p242.topLevelHints),
																	_1: _p241.unimportedHints,
																	_2: _p242.variableHints
																};
															} else {
																return {
																	ctor: '_Tuple3',
														...
														var exposedAndTopLevelHints = _p239._0;
														var unexposedHints = _p239._1;
														var variableHints = _p239._2;
														...
														var hints = function () {
															var _p243 = maybeInferredTipe;
															if (_p243.ctor === 'Just') {
																var _p248 = _p243._0;
																var partitionHints = function (hints) {
																	return A2(
																		_elm_lang$core$List$partition,
																		A2(_user$project$Indexer$partitionByTipe, _p248, preceedingToken),
																		hints);
																};
																var _p244 = partitionHints(filteredVariableHints);
																var variableHintsCompatible = _p244._0;
																var variableHintsNotCompatible = _p244._1;
																var _p245 = partitionHints(filteredDefaultHints);
																var defaultHintsCompatible = _p245._0;
																var defaultHintsNotCompatible = _p245._1;
																var _p246 = partitionHints(filteredExposedHints);
																var exposedHintsCompatible = _p246._0;
																var exposedHintsNotCompatible = _p246._1;
																var _p247 = partitionHints(filteredUnexposedHints);
																var unexposedHintsCompatible = _p247._0;
																var unexposedHintsNotCompatible = _p247._1;
																return A2(
																	_elm_lang$core$Basics_ops['++'],
																	A3(_user$project$Indexer$sortHintsByScore, _p248, preceedingToken, variableHintsCompatible),
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A3(_user$project$Indexer$sortHintsByScore, _p248, preceedingToken, defaultHintsCompatible),
																		A2(
																			_elm_lang$core$Basics_ops['++'],
																			A3(_user$project$Indexer$sortHintsByScore, _p248, preceedingToken, exposedHintsCompatible),
																			A2(
																				_elm_lang$core$Basics_ops['++'],
																				A3(_user$project$Indexer$sortHintsByScore, _p248, preceedingToken, unexposedHintsCompatible),
																				A2(
																					_elm_lang$core$Basics_ops['++'],
...
var _user$project$Indexer$doGetHintsForPartial = F8(
	function (partial, maybeInferredTipe, preceedingToken, isRegex, isTypeSignature, isFiltered, isGlobal, model) {
		var _p249 = _user$project$Indexer$getHintsForPartial(partial)(maybeInferredTipe)(preceedingToken)(isRegex)(isTypeSignature)(isFiltered)(isGlobal)(model.activeFile)(model.projectFileContentsDict)(model.projectDependencies)(model.packageDocs)(model.hintsCache)(model.activeFileTokens);
		var hints = _p249._0;
		var updatedHintsCache = _p249._1;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
...
var _user$project$Indexer$getActiveFileTokens = F5(
	function (maybeActiveFile, maybeActiveTopLevel, projectFileContentsDict, projectDependencies, packageDocs) {
		var _p250 = maybeActiveFile;
		if (_p250.ctor === 'Just') {
			var _p257 = _p250._0.projectDirectory;
			var _p256 = _p250._0.filePath;
			var insert = F2(
				function (_p251, dict) {
					var _p252 = _p251;
					return A3(
			...
			var fileContentsDict = A2(_user$project$Indexer$getFileContentsOfProject, _p257, projectFileContentsDict);
			var getHints = function (moduleDocs) {
				return A2(
					_elm_lang$core$Maybe$map,
					A2(_user$project$Indexer$getFilteredHints, _p256, moduleDocs),
					A2(
				...
				_elm_lang$core$List$concat(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							projectPackageDocs,
							A2(_user$project$Indexer$getProjectModuleDocs, _p257, projectFileContentsDict)))));
...
var _user$project$Indexer$topLevelArgToHints = F4(
	function (parentSourcePath, _p259, topLevelTokens, _p258) {
		var _p260 = _p259;
		var _p272 = _p260._1;
		var _p271 = _p260._2;
		var _p270 = _p260._3;
			...
			var getRecordFields = function (tipeString) {
				return _elm_lang$core$List$concat(
					A2(
							...
							return A2(
								...
								function (tipeString) {
									return A5(
										...
										tipeString,
										parentSourcePath,
										{ctor: '_Tuple4', _0: _p269, _1: _p272, _2: _p271, _3: _p270},
										topLevelTokens);
								},
								A2(
									_elm_lang$core$Dict$get,
						...
						_user$project$Indexer$getRecordArgParts(_p267)));
			};
			var _p262 = {
				ctor: '_Tuple2',
				_0: _user$project$Indexer$isRecordString(_p267),
				_1: _user$project$Indexer$isRecordString(_p268)
			};
			if (_p262._0 === true) {
				if (_p262._1 === true) {
					return getRecordFields(_p268);
				} else {
					var _p263 = _elm_lang$core$List$head(
						A2(
							_user$project$Indexer$getHintsForToken,
							_elm_lang$core$Maybe$Just(_p268),
							topLevelTokens));
					if (_p263.ctor === 'Just') {
						return getRecordFields(_p263._0.tipe);
					} else {
						return {ctor: '[]'};
					}
				}
		...
		var getHint = function (_p264) {
			...
			return {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: _p266, _1: hint},
				_1: {ctor: '[]'}
			};
		};
...
var _user$project$Indexer$getRecordFieldTokens = F5(
	function (name, tipeString, parentSourcePath, _p273, topLevelTokens) {
		var _p274 = _p273;
		return A8(
			...
			tipeString,
			parentSourcePath,
			{ctor: '_Tuple4', _0: _p274._0, _1: _p274._1, _2: _p274._2, _3: _p274._3},
			topLevelTokens,
			true,
			_elm_lang$core$Maybe$Nothing,
			_elm_lang$core$Set$empty);
...
var _user$project$Indexer$getRecordFieldTokensRecur = F8(
	function (name, tipeString, parentSourcePath, _p275, topLevelTokens, shouldAddSelf, maybeRootTipeString, visitedSourcePaths) {
		var _p276 = _p275;
		var _p291 = _p276._1;
		var _p290 = _p276._2;
		var _p289 = _p276._3;
			...
			function () {
				if (_user$project$Indexer$isRecordString(name)) {
									...
									return A2(
										...
										function (tipeString) {
											return A8(
												...
												tipeString,
												parentSourcePath,
												{ctor: '_Tuple4', _0: _p288, _1: _p291, _2: _p290, _3: _p289},
												topLevelTokens,
												true,
												maybeRootTipeString,
												visitedSourcePaths);
					...
					if (_user$project$Indexer$isRecordString(tipeString)) {
						...
						var _p277 = _elm_lang$core$List$head(
							A2(
								_user$project$Indexer$getHintsForToken,
								_elm_lang$core$Maybe$Just(tipeString),
								topLevelTokens));
						if (_p277.ctor === 'Just') {
							return getRecordFields(_p277._0.tipe);
						} else {
							return {ctor: '[]'};
						}
					}
					...
					if (_user$project$Indexer$isRecordString(tipeString)) {
							...
							function (_p278) {
								...
								return A8(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										name,
										A2(_elm_lang$core$Basics_ops['++'], '.', _p279._0)),
									_p279._1,
									parentSourcePath,
									{ctor: '_Tuple4', _0: _p288, _1: _p291, _2: _p290, _3: _p289},
									topLevelTokens,
						...
						if (_user$project$Indexer$isTupleString(name) && _user$project$Indexer$isTupleString(tipeString)) {
							...
							if (_p283.ctor === 'Just') {
								var _p287 = _p283._0;
								if ((!_elm_lang$core$Native_Utils.eq(_p287.kind, _user$project$Indexer$KindType)) && ((!_elm_lang$core$Native_Utils.eq(_p287.tipe, tipeString)) && (!A2(_elm_lang$core$Set$member, _p287.sourcePath, visitedSourcePaths)))) {
									var updatedVisitedSourcePaths = A2(_elm_lang$core$Set$insert, _p287.sourcePath, visitedSourcePaths);
									...
									var _p285 = {
										ctor: '_Tuple2',
										_0: _p287.sourcePath,
										_1: ((!_elm_lang$core$Native_Utils.eq(_p287.sourcePath, parentSourcePath)) && _user$project$Indexer$isProjectSourcePath(_p287.sourcePath)) ? A5(_user$project$Indexer$getActiveFileTokens, maybeNewActiveFile, _elm_lang$core$Maybe$Nothing, _p291, _p290, _p289) : topLevelTokens
									};
									var newParentSourcePath = _p285._0;
									var newTokens = _p285._1;
									var _p286 = maybeRootTipeString;
									if (_p286.ctor === 'Just') {
										return (!_elm_lang$core$Native_Utils.eq(_p287.name, _p286._0)) ? A8(
											_user$project$Indexer$getRecordFieldTokensRecur,
											name,
											_p287.tipe,
											newParentSourcePath,
											{ctor: '_Tuple4', _0: maybeNewActiveFile, _1: _p291, _2: _p290, _3: _p289},
											newTokens,
											false,
											_elm_lang$core$Maybe$Just(_p287.name),
...
var _user$project$Indexer$doGetTokenInfo = F5(
	function (maybeProjectDirectory, maybeFilePath, maybeActiveTopLevel, maybeToken, model) {
		var _p294 = {ctor: '_Tuple2', _0: maybeProjectDirectory, _1: maybeFilePath};
		if (((_p294.ctor === '_Tuple2') && (_p294._0.ctor === 'Just')) && (_p294._1.ctor === 'Just')) {
			var _p297 = _p294._0._0;
			var _p296 = _p294._1._0;
			var fileTokens = function () {
				var _p295 = model.activeFile;
				if (_p295.ctor === 'Just') {
					return (_elm_lang$core$Native_Utils.eq(_p295._0.filePath, _p296) && _elm_lang$core$Native_Utils.eq(model.activeTopLevel, maybeActiveTopLevel)) ? model.activeFileTokens : A5(
						_user$project$Indexer$getActiveFileTokens,
						_elm_lang$core$Maybe$Just(
							{filePath: _p296, projectDirectory: _p297}),
						maybeActiveTopLevel,
						model.projectFileContentsDict,
						model.projectDependencies,
						model.packageDocs);
...
var _user$project$Indexer$doUpdateFileContents = F4(
	function (filePath, projectDirectory, fileContents, model) {
		...
		var updatedHintsCache = function () {
			var _p298 = model.hintsCache;
			if (_p298.ctor === 'Just') {
				var _p302 = _p298._0;
				var _p299 = _p302.external;
				if (_p299.ctor === 'Just') {
					var _p300 = model.activeFile;
					if (_p300.ctor === 'Just') {
						var _p301 = _p300._0;
						var newFileContentsDict = A2(_user$project$Indexer$getFileContentsOfProject, _p301.projectDirectory, updatedProjectFileContentsDict);
						var newActiveFileContents = A2(_user$project$Indexer$getActiveFileContents, model.activeFile, newFileContentsDict);
						var oldFileContentsDict = A2(_user$project$Indexer$getFileContentsOfProject, _p301.projectDirectory, model.projectFileContentsDict);
						...
						return (_elm_lang$core$Native_Utils.eq(_p301.filePath, filePath) && (!_elm_lang$core$Native_Utils.eq(oldActiveFileContents.imports, newActiveFileContents.imports))) ? _elm_lang$core$Maybe$Just(
							_elm_lang$core$Native_Utils.update(
								_p302,
...
var _user$project$Indexer$addLoadedPackageDocs = F2(
	function (loadedPackageDocs, model) {
		...
		var missingPackageDocs = A2(
			...
			function (_p304) {
				var _p305 = _p304;
				return !A2(_elm_lang$core$List$member, _p305.sourcePath, existingPackages);
			},
			loadedPackageDocs);
...
var _user$project$Indexer$getFunctionsMatchingType = F6(
	function (tipeString, maybeProjectDirectory, maybeFilePath, projectFileContentsDict, projectDependencies, packageDocs) {
		var _p306 = {ctor: '_Tuple2', _0: maybeProjectDirectory, _1: maybeFilePath};
		if (((_p306.ctor === '_Tuple2') && (_p306._0.ctor === 'Just')) && (_p306._1.ctor === 'Just')) {
			var activeFile = _elm_lang$core$Maybe$Just(
				{projectDirectory: _p306._0._0, filePath: _p306._1._0});
			...
			var _p307 = A8(_user$project$Indexer$getExternalAndLocalHints, true, activeFile, projectFileContentsDict, projectDependencies, packageDocs, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, activeFileTokens);
			var external = _p307.external;
			var local = _p307.local;
			var _p308 = function () {
				var _p309 = {ctor: '_Tuple2', _0: external, _1: local};
				if (((_p309.ctor === '_Tuple2') && (_p309._0.ctor === 'Just')) && (_p309._1.ctor === 'Just')) {
					var _p311 = _p309._1._0;
					var _p310 = _p309._0._0;
					return {
						ctor: '_Tuple3',
						_0: A2(_elm_lang$core$Basics_ops['++'], _p310.importedHints, _p311.topLevelHints),
						_1: _p310.unimportedHints,
						_2: _p311.variableHints
					};
				} else {
					return {
						ctor: '_Tuple3',
			...
			var exposedAndTopLevelHints = _p308._0;
			var unexposedHints = _p308._1;
			var variableHints = _p308._2;
			return A2(
				_elm_lang$core$List$filter,
				function (hint) {
...
var _user$project$Indexer$getSourcePathOfRecordFieldTokenRecur = F7(
	function (parentPartName, parentName, parentSourcePath, tailParts, _p312, rootTokens, tokens) {
		...
		while (true) {
			...
			var _p330 = _p313._3;
			var _p329 = _p313._0;
			var _p314 = _elm_lang$core$List$head(tailParts);
			if (_p314.ctor === 'Just') {
				var _p328 = _p314._0;
				...
				var newPrefixSourcePath = function () {
					var _p315 = _elm_lang$core$List$head(
						A2(
							_user$project$Indexer$getHintsForToken,
					...
					if (_p315.ctor === 'Just') {
						var _p318 = _p315._0;
						if (_user$project$Indexer$isRecordString(_p318.tipe)) {
							return A2(
								_elm_lang$core$Basics_ops['++'],
								parentSourcePath,
							...
							var _p316 = _elm_lang$core$List$head(
								A2(
									_user$project$Indexer$getHintsForToken,
									_elm_lang$core$Maybe$Just(_p318.tipe),
									tokens));
							if (_p316.ctor === 'Just') {
								var _p317 = _p316._0;
								return (!_elm_lang$core$Native_Utils.eq(_p317.sourcePath, parentSourcePath)) ? A2(
									_elm_lang$core$Basics_ops['++'],
									_p317.sourcePath,
									A2(_elm_lang$core$Basics_ops['++'], _user$project$Indexer$filePathSeparator, _p317.name)) : doDefault(_p318);
							} else {
								return doDefault(_p318);
							}
						}
					} else {
						...
						if (_p319.ctor === 'Just') {
							...
							var _p320 = _elm_lang$core$List$head(
								A2(
									_user$project$Indexer$getHintsForToken,
									_elm_lang$core$Maybe$Just(_p322.tipe),
									tokens));
							if (_p320.ctor === 'Just') {
								var _p321 = _p320._0;
								return (!_elm_lang$core$Native_Utils.eq(_p321.sourcePath, parentSourcePath)) ? A2(
									_elm_lang$core$Basics_ops['++'],
									_p321.sourcePath,
									A2(_elm_lang$core$Basics_ops['++'], _user$project$Indexer$filePathSeparator, _p321.name)) : doDefault(_p322);
							} else {
								return doDefault(_p322);
							}
						} else {
				...
				var _p323 = function () {
					...
					if (((_p324.ctor === '_Tuple2') && (_p324._0.ctor === 'Just')) && (_p324._1.ctor === 'Just')) {
						var _p327 = _p324._1._0;
						var maybeNewActiveFile = function () {
							var _p325 = _p329;
							if (_p325.ctor === 'Just') {
								return _elm_lang$core$Maybe$Just(
						...
						var _p326 = maybeNewActiveFile;
						if (_p326.ctor === 'Just') {
							return ((!_elm_lang$core$Native_Utils.eq(_p324._0._0, _p327)) && _user$project$Indexer$isProjectSourcePath(_p327)) ? {
								ctor: '_Tuple2',
								_0: maybeNewActiveFile,
								_1: A5(_user$project$Indexer$getActiveFileTokens, maybeNewActiveFile, _elm_lang$core$Maybe$Nothing, _p332, _p331, _p330)
							} : {ctor: '_Tuple2', _0: _p329, _1: tokens};
						} else {
							return {ctor: '_Tuple2', _0: _p329, _1: tokens};
						}
					} else {
						return {ctor: '_Tuple2', _0: _p329, _1: tokens};
					}
				}();
				var updatedActiveFile = _p323._0;
				var updatedTokens = _p323._1;
				var _v219 = _p328,
					_v220 = A2(
					_elm_lang$core$Basics_ops['++'],
					parentName,
					A2(_elm_lang$core$Basics_ops['++'], '.', _p328)),
					_v221 = newPrefixSourcePath,
					_v222 = A2(
					_elm_lang$core$Maybe$withDefault,
					{ctor: '[]'},
					_elm_lang$core$List$tail(tailParts)),
					_v223 = {ctor: '_Tuple4', _0: updatedActiveFile, _1: _p332, _2: _p331, _3: _p330},
					_v224 = rootTokens,
					_v225 = updatedTokens;
				parentPartName = _v219;
				parentName = _v220;
				parentSourcePath = _v221;
				tailParts = _v222;
				_p312 = _v223;
				rootTokens = _v224;
				tokens = _v225;
...
var _user$project$Indexer$getSourcePathOfRecordFieldToken = F5(
	function (name, filePath, maybeActiveTopLevel, _p333, tokens) {
		var _p334 = _p333;
		var parts = A2(_elm_lang$core$String$split, '.', name);
		if (_elm_lang$core$Native_Utils.eq(
			_elm_lang$core$List$length(parts),
			1)) {
			var _p335 = maybeActiveTopLevel;
			if (_p335.ctor === 'Just') {
				return A2(
					_elm_lang$core$Basics_ops['++'],
					filePath,
					A2(_elm_lang$core$Basics_ops['++'], _user$project$Indexer$filePathSeparator, _p335._0));
			} else {
				return '';
			}
		} else {
			var _p336 = _elm_lang$core$List$head(parts);
			if (_p336.ctor === 'Just') {
				var _p337 = _p336._0;
				return A7(
					...
					A2(
						...
						{ctor: '[]'},
						_elm_lang$core$List$tail(parts)),
					{ctor: '_Tuple4', _0: _p334._0, _1: _p334._1, _2: _p334._2, _3: _p334._3},
					tokens,
					tokens);
			} else {
				return '';
								...
								return _elm_lang$core$Native_Utils.eq(hint.kind, _user$project$Indexer$KindVariable) ? _elm_lang$core$Native_Utils.update(
									hint,
									{
										sourcePath: A5(
											...
											_p340._0.filePath,
											_p339._1,
											{ctor: '_Tuple4', _0: _p342, _1: _p339._2, _2: _p339._3, _3: _p339._4},
											tokens)
									}) : hint;
							},
							hints);
...
var _user$project$Indexer$getTokenAndActiveFileTokensForGoToDefinition = F3(
	function (maybeActiveTopLevel, maybeToken, model) {
		...
		var tokenToCheck = function () {
			var _p343 = {ctor: '_Tuple2', _0: maybeToken, _1: model.activeFile};
			if (_p343._0.ctor === 'Just') {
				if (_p343._1.ctor === 'Just') {
					var _p344 = _p343._0._0;
					var fileContentsDict = A2(_user$project$Indexer$getFileContentsOfProject, _p343._1._0.projectDirectory, model.projectFileContentsDict);
					var activeFileContents = A2(_user$project$Indexer$getActiveFileContents, model.activeFile, fileContentsDict);
					return _elm_lang$core$Native_Utils.eq(
						activeFileContents.moduleDocs.name,
						_user$project$Indexer$getModuleName(_p344)) ? _elm_lang$core$Maybe$Just(
						_user$project$Indexer$getLastName(_p344)) : _elm_lang$core$Maybe$Just(_p344);
				} else {
					return _elm_lang$core$Maybe$Just(_p343._0._0);
				}
			} else {
				return _elm_lang$core$Maybe$Nothing;
			}
...
var _user$project$Indexer$doGoToDefinition = F3(
	function (maybeActiveTopLevel, maybeToken, model) {
		var _p345 = A3(_user$project$Indexer$getTokenAndActiveFileTokensForGoToDefinition, maybeActiveTopLevel, maybeToken, model);
		var tokenToCheck = _p345._0;
		var activeFileTokens = _p345._1;
		var requests = A2(
			_elm_lang$core$List$map,
			function (hint) {
				var symbol = {
...
var _user$project$Indexer$doAskCanGoToDefinition = F3(
	function (maybeActiveTopLevel, token, model) {
		...
		var _p347 = tokenToCheck;
		if (_p347.ctor === 'Nothing') {
			return {
				ctor: '_Tuple2',
				_0: model,
				...
				_1: _user$project$Indexer$canGoToDefinitionRepliedCmd(
					{
						ctor: '_Tuple2',
						_0: token,
						_1: A2(_elm_lang$core$Dict$member, _p347._0, activeFileTokens)
					})
			};
		}
	});
			...
			A2(
				...
				function (_p348) {
					...
					var formatExposedSymbol = function (token) {
						...
						var _p351 = _elm_lang$core$List$head(hints);
						if (_p351.ctor === 'Just') {
							var _p352 = _p351._0.caseTipe;
							if (_p352.ctor === 'Just') {
								return A2(
									_elm_lang$core$Basics_ops['++'],
									_p352._0,
							...
							default:
								var nonDefaultExposedSymbols = A2(
									...
									function (exposedSymbolName) {
										var _p354 = A2(_elm_lang$core$Dict$get, _p357, _user$project$Indexer$defaultImports);
										if (_p354.ctor === 'Just') {
											var _p355 = _p354._0.exposed;
											if (_p355.ctor === 'Some') {
												return !A2(_elm_lang$core$Set$member, exposedSymbolName, _p355._0);
											} else {
												return true;
											}
										} else {
						...
						if (_p356.ctor === 'Just') {
							return A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_p357,
									A2(_elm_lang$core$Basics_ops['++'], ' as ', _p356._0)));
						} else {
							return A2(_elm_lang$core$Basics_ops['++'], 'import ', _p357);
						}
					}();
...
var _user$project$Indexer$doAddImport = F5(
	function (filePath, projectDirectory, moduleName, maybeSymbolName, model) {
		...
		var updatedImports = A2(
			...
			function () {
				var _p358 = A2(_elm_lang$core$Dict$get, moduleName, fileContents.imports);
				if (_p358.ctor === 'Just') {
					var _p365 = _p358._0;
					var _p359 = maybeSymbolName;
					if (_p359.ctor === 'Just') {
						var _p364 = _p359._0;
						var _p360 = _p365.exposed;
						switch (_p360.ctor) {
							case 'All':
								return fileContents.imports;
							case 'Some':
								return _elm_lang$core$Native_Utils.eq(_p364, '..') ? A3(
									_elm_lang$core$Dict$update,
									moduleName,
									function (_p361) {
										return _elm_lang$core$Maybe$Just(
											...
											_elm_lang$core$Native_Utils.update(
												_p365,
												{
													exposed: _user$project$Indexer$Some(
														A2(_elm_lang$core$Set$insert, _p364, _p360._0))
												}));
									},
									fileContents.imports);
							default:
									...
									function (_p363) {
										return _elm_lang$core$Maybe$Just(
											_elm_lang$core$Native_Utils.update(
												...
												{
													exposed: _user$project$Indexer$Some(
														_elm_lang$core$Set$singleton(_p364))
												}));
									},
									fileContents.imports);
						}
					...
					var importToAdd = function () {
						var _p366 = maybeSymbolName;
						if (_p366.ctor === 'Just') {
							return {
								alias: _elm_lang$core$Maybe$Nothing,
								exposed: _user$project$Indexer$Some(
									_elm_lang$core$Set$singleton(_p366._0))
							};
						} else {
	...
	function (msg, model) {
		...
		switch (_p367.ctor) {
			case 'MaybeDocsDownloaded':
				if (_p367._1.ctor === 'Err') {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Indexer$downloadDocsFailedCmd(
							_elm_lang$core$Basics$toString(_p367._1._0))
					};
				} else {
					var _p368 = A3(
						_elm_lang$core$List$foldl,
						F2(
							function (_p370, _p369) {
								var _p371 = _p370;
								var _p379 = _p371._0;
								var _p372 = _p369;
								var _p378 = _p372._0;
								...
								if (_p373.ctor === 'Ok') {
										...
										_0: A2(
											...
											_p378,
											{
												...
												_0: {
													ctor: '_Tuple2',
													_0: _p373._0._1,
													_1: {ctor: '_Tuple2', _0: _p379, _1: _p373._0._0}
												},
												_1: {ctor: '[]'}
											}),
										_1: _p377
									...
									var errorDetails = function () {
										...
										switch (_p374.ctor) {
											case 'BadUrl':
												return A2(_elm_lang$core$Basics_ops['++'], 'BadUrl ', _p374._0);
											case 'Timeout':
												return 'Timeout';
											case 'NetworkError':
												return 'NetworkError';
											case 'BadStatus':
												var _p375 = _p374._0.status;
												return A2(
													_elm_lang$core$Basics_ops['++'],
													'BadStatus ',
													A2(
														_elm_lang$core$Basics_ops['++'],
														_elm_lang$core$Basics$toString(_p375.code),
														A2(_elm_lang$core$Basics_ops['++'], ' ', _p375.message)));
											default:
												var _p376 = _p374._1.status;
												return A2(
													_elm_lang$core$Basics_ops['++'],
													'BadPayload ',
													A2(
									...
									return {
										...
										_1: A2(
											...
											{
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: _p379, _1: errorDetails},
												_1: {ctor: '[]'}
											})
									};
								}
						...
						A3(
							...
							_p367._0,
							_p367._1._0));
					var successes = _p368._0;
					var failures = _p368._1;
											...
											A2(
												...
												A2(
													...
													function (_p380) {
														...
														return A2(
															_elm_lang$core$Basics_ops['++'],
															_user$project$Indexer$toPackageUri(_p381._0),
															A2(
																_elm_lang$core$Basics_ops['++'],
																'documentation.json (',
																A2(_elm_lang$core$Basics_ops['++'], _p381._1, ')')));
													},
													failures))),
										_1: {ctor: '[]'}
									},
									function () {
										...
										var notFoundDependencies = A2(
											...
											A2(
												...
												function (_p382) {
													var _p383 = _p382;
													return _elm_lang$core$Native_Utils.eq(_p383._1, 'BadStatus 404 Not found');
												},
												failures));
										return (_elm_lang$core$Native_Utils.cmp(
				...
				var loadedPackageDocs = A2(
					...
					function (_p384) {
						...
						return A2(
							...
							_user$project$Indexer$toPackageUri(_p385._0),
							_p385._1);
					},
					_p367._0);
				return {
			...
			case 'UpdateActiveTokenHints':
				return A3(_user$project$Indexer$doUpdateActiveTokenHints, _p367._0._0, _p367._0._1, model);
			case 'UpdateActiveFile':
				return A4(_user$project$Indexer$doUpdateActiveFile, _p367._0._0, _p367._0._1, _p367._0._2, model);
			case 'UpdateFileContents':
				return A4(_user$project$Indexer$doUpdateFileContents, _p367._0, _p367._1, _p367._2, model);
			case 'RemoveFileContents':
				return A3(_user$project$Indexer$doRemoveFileContents, _p367._0._0, _p367._0._1, model);
			case 'UpdateProjectDependencies':
				return A3(_user$project$Indexer$doUpdateProjectDependencies, _p367._0._0, _p367._0._1, model);
			case 'DownloadMissingPackageDocs':
				return A2(_user$project$Indexer$doDownloadMissingPackageDocs, _p367._0, model);
			case 'GoToDefinition':
				return A3(_user$project$Indexer$doGoToDefinition, _p367._0._0, _p367._0._1, model);
			case 'AskCanGoToDefinition':
				return A3(_user$project$Indexer$doAskCanGoToDefinition, _p367._0._0, _p367._0._1, model);
			case 'ShowGoToSymbolView':
				return A3(_user$project$Indexer$doShowGoToSymbolView, _p367._0._0, _p367._0._1, model);
			case 'GetHintsForPartial':
				return A8(_user$project$Indexer$doGetHintsForPartial, _p367._0._0, _p367._0._1, _p367._0._2, _p367._0._3, _p367._0._4, _p367._0._5, _p367._0._6, model);
			case 'GetSuggestionsForImport':
				return A3(_user$project$Indexer$doGetSuggestionsForImport, _p367._0._0, _p367._0._1, model);
			case 'GetImporterSourcePathsForToken':
				return A4(_user$project$Indexer$doGetImporterSourcePathsForToken, _p367._0._0, _p367._0._1, _p367._0._2, model);
			case 'ShowAddImportView':
				return A3(_user$project$Indexer$doShowAddImportView, _p367._0._0, _p367._0._1, model);
			case 'AddImport':
				return A5(_user$project$Indexer$doAddImport, _p367._0._0, _p367._0._1, _p367._0._2, _p367._0._3, model);
			case 'ConstructFromTypeAnnotation':
				return A2(_user$project$Indexer$doConstructFromTypeAnnotation, _p367._0, model);
			case 'ConstructCaseOf':
				return A2(_user$project$Indexer$doConstructCaseOf, _p367._0, model);
			case 'ConstructDefaultValueForType':
				return A2(_user$project$Indexer$doConstructDefaultValueForType, _p367._0, model);
			case 'ConstructDefaultArguments':
				return A2(_user$project$Indexer$doConstructDefaultArguments, _p367._0, model);
					...
					_1: _user$project$Indexer$activeTokenHintsChangedCmd(
						{
							...
							_1: A2(
								_elm_lang$core$List$map,
								A2(_user$project$Indexer$encodeHint, model.config.showAliasesOfType, model.activeFileTokens),
								_user$project$Indexer$inferenceToHints(_p386))
						})
				};
			case 'ConfigChanged':
				return {
			...
			case 'GetAliasesOfType':
				return A2(_user$project$Indexer$doGetAliasesOfType, _p367._0, model);
			...
			case 'GetTokenInfo':
				return A5(_user$project$Indexer$doGetTokenInfo, _p367._0._0, _p367._0._1, _p367._0._2, _p367._0._3, model);
			default:
				return A4(_user$project$Indexer$doGetFunctionsMatchingType, _p367._0._0, _p367._0._1, _p367._0._2, model);
		}
	});
				...
				_1: {
					...
					_0: _user$project$Indexer$fileContentsChangedSub(
						function (_p388) {
							var _p389 = _p388;
							var _p390 = _p389._2;
							var encodedValues = _p390.values;
							...
							return A3(
								...
								A2(
									...
									moduleDocs,
									_user$project$Indexer$toImportDict(_p389._3)));
						}),
					_1: {
						ctor: '::',
