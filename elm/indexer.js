		...
		switch (_p79.ctor) {
			...
			case 'DocsDownloaded':
				...
				var loadedDependenciesAndJson = A2(
					...
					function (_p80) {
						var _p81 = _p80;
						return {ctor: '_Tuple2', _0: _p81._0, _1: _p81._1};
					},
					_p84);
				...
				var loadedPackageDocs = A2(
					...
					function (_p85) {
						...
						return A2(
							...
							_user$project$Indexer$toPackageUri(_p86._0),
							_p86._1);
					},
					_p79._0);
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							activeTokens: A3(
								...
								_p87,
								model.fileContentsDict,
								A3(_user$project$Indexer$getProjectPackageDocs, _p87, model.projectDependencies, model.packageDocs))
						}),
					_1: _user$project$Indexer$activeFileChangedCmd(_p87)
				};
			case 'UpdateFileContents':
				var updatedFileContentsDict = A3(
					...
					_p79._0,
					_elm_lang$core$Basics$always(
						_elm_lang$core$Maybe$Just(_p79._1)),
					model.fileContentsDict);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'RemoveFileContents':
				var updatedFileContentsDict = A2(_elm_lang$core$Dict$remove, _p79._0, model.fileContentsDict);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							projectDependencies: A3(
								...
								_p79._0._0,
								_elm_lang$core$Basics$always(
									_elm_lang$core$Maybe$Just(_p88)),
			...
			case 'GoToDefinition':
				var requests = A2(
					...
					A2(_user$project$Indexer$getHintsForToken, _p79._0, model.activeTokens));
				return {
					ctor: '_Tuple2',
					_0: model,
			...
			case 'GoToSymbol':
				...
				if (_p89.ctor === 'Nothing') {
					...
					var hints = A2(_user$project$Indexer$getHintsForToken, _p93, model.activeTokens);
					var defaultSymbolName = function () {
						var _p90 = _elm_lang$core$List$head(hints);
						if (_p90.ctor === 'Nothing') {
							return _p93;
						} else {
							var _p92 = _p90._0;
							var _p91 = model.activeFile;
							if (_p91.ctor === 'Nothing') {
								return _elm_lang$core$Maybe$Just(_p92.name);
							} else {
								return _elm_lang$core$Native_Utils.eq(_p91._0.filePath, _p92.sourcePath) ? _elm_lang$core$Maybe$Just(
									_user$project$Indexer$getLastName(_p92.name)) : _elm_lang$core$Maybe$Just(_p92.name);
							}
						}
					}();
					return {
						...
						_1: _user$project$Indexer$goToSymbolCmd(
							{
								...
								_2: A2(
									...
									A2(_user$project$Indexer$getProjectSymbols, _p89._0, model.fileContentsDict))
							})
					};
				}
					...
					_1: _user$project$Indexer$canGoToDefinitionRepliedCmd(
						{
							ctor: '_Tuple2',
							_0: _p96,
							_1: A2(_elm_lang$core$Dict$member, _p96, model.activeTokens)
						})
				};
			default:
				var _p97 = {ctor: '_Tuple3', _0: _p79._0._0, _1: _p79._0._1, _2: _p79._0._2};
				if ((((_p97.ctor === '_Tuple3') && (_p97._0.ctor === 'Just')) && (_p97._1.ctor === 'Just')) && (_p97._2.ctor === 'Just')) {
					...
					var _p98 = _elm_lang$core$Native_Utils.eq(_p100, activeFileContents.moduleDocs.name) ? {ctor: '_Tuple2', _0: _p100, _1: true} : ((!_elm_lang$core$Native_Utils.eq(
						A2(_elm_lang$core$Dict$get, _p100, activeFileContents.imports),
						_elm_lang$core$Maybe$Nothing)) ? {ctor: '_Tuple2', _0: _p100, _1: true} : (_p99 ? {ctor: '_Tuple2', _0: _p100, _1: false} : {
						ctor: '_Tuple2',
						_0: _user$project$Indexer$getModuleName(_p100),
						_1: false
					}));
					var token = _p98._0;
					var willUseFullToken = _p98._1;
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Indexer$importersForTokenReceivedCmd(
							{
								...
								_2: willUseFullToken,
								_3: _p99,
								_4: A6(_user$project$Indexer$getImportersForToken, token, _p99, model.activeFile, model.activeTokens, activeFileContents, model.fileContentsDict)
							})
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				...
				function (_p101) {
					...
					return A2(
						...
						A2(
							...
							_p102._1,
							_user$project$Indexer$toImportDict(_p102._2)));
				}),
