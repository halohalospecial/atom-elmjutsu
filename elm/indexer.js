		...
		var importAliases = A2(
			...
			function (_p53) {
				...
				if (_p55.ctor === 'Nothing') {
					...
					var _p56 = _p55._0;
					return A2(_elm_lang$core$String$startsWith, partial, _p56) ? _elm_lang$core$Maybe$Just(
						_elm_lang$core$Native_Utils.update(
							_user$project$Indexer$emptyHint,
							{name: _p56})) : _elm_lang$core$Maybe$Nothing;
				}
			},
					...
					if (_elm_lang$core$Native_Utils.eq(hint.moduleName, '')) {
						...
						if (A2(
							...
							var moduleNamePrefix = function () {
								var _p57 = A2(_elm_lang$core$Dict$get, hint.moduleName, fileContents.imports);
								if (_p57.ctor === 'Nothing') {
									return '';
								} else {
									var _p58 = _p57._0.alias;
									if (_p58.ctor === 'Nothing') {
										return A2(_elm_lang$core$Basics_ops['++'], hint.moduleName, '.');
									} else {
										return A2(_elm_lang$core$Basics_ops['++'], _p58._0, '.');
									}
								}
							}();
				...
				_elm_lang$core$List$concat(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							packageDocsList,
							A2(_user$project$Indexer$projectModuleDocs, _p59._0.projectDirectory, fileContentsDict)))));
		}
	});
var _user$project$Indexer$update = F2(
	function (msg, model) {
		...
		switch (_p62.ctor) {
			...
			case 'DocsLoaded':
				var truncateComment = function (moduleDocs) {
					var truncatedComment = function () {
						var _p63 = _elm_lang$core$List$head(
				...
				var missingPackageDocs = A2(
					...
					function (_p64) {
						var _p65 = _p64;
						return _elm_lang$core$Basics$not(
							A2(_elm_lang$core$List$member, _p65.sourcePath, existingPackages));
					},
					_p62._0);
			...
			case 'CursorMove':
				var updatedActiveHints = A2(_user$project$Indexer$hintsForToken, _p62._0, model.activeTokens);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'UpdateActiveFile':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							activeFile: _p66,
							activeTokens: A3(_user$project$Indexer$toTokenDict, _p66, model.fileContentsDict, model.packageDocs)
						}),
					_1: _user$project$Indexer$activeFileChangedCmd(_p66)
				};
			case 'UpdateFileContents':
				var updatedFileContentsDict = A3(
					...
					_p62._0,
					_elm_lang$core$Basics$always(
						_elm_lang$core$Maybe$Just(_p62._1)),
			...
			case 'RemoveFileContents':
				var updatedFileContentsDict = A2(_elm_lang$core$Dict$remove, _p62._0, model.fileContentsDict);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'UpdatePackageDocs':
				...
				var missingPackages = A2(
					...
					A2(_elm_lang$core$List$map, _user$project$Indexer$toPackageUri, _p62._0));
				return {
					ctor: '_Tuple2',
					_0: model,
			...
			case 'GoToDefinition':
				var requests = A2(
					...
					A2(_user$project$Indexer$hintsForToken, _p62._0, model.activeTokens));
				return {
					ctor: '_Tuple2',
					_0: model,
			...
			case 'GoToSymbol':
				...
				if (_p67.ctor === 'Nothing') {
					...
					var hints = A2(_user$project$Indexer$hintsForToken, _p71, model.activeTokens);
					var defaultSymbolName = function () {
						var _p68 = _elm_lang$core$List$head(hints);
						if (_p68.ctor === 'Nothing') {
							return _p71;
						} else {
							var _p70 = _p68._0;
							var _p69 = model.activeFile;
							if (_p69.ctor === 'Nothing') {
								return _elm_lang$core$Maybe$Just(_p70.name);
							} else {
								return _elm_lang$core$Native_Utils.eq(_p69._0.filePath, _p70.sourcePath) ? _elm_lang$core$Maybe$Just(
									_user$project$Indexer$lastName(_p70.name)) : _elm_lang$core$Maybe$Just(_p70.name);
							}
						}
					}();
					return {
						...
						_1: _user$project$Indexer$goToSymbolCmd(
							{
								...
								_2: A2(
									...
									A2(_user$project$Indexer$projectSymbols, _p67._0, model.fileContentsDict))
							})
					};
				}
					...
					_1: _user$project$Indexer$hintsForPartialReceivedCmd(
						{
							...
							_1: A2(
								...
								A5(_user$project$Indexer$hintsForPartial, _p72, model.activeFile, model.fileContentsDict, model.packageDocs, model.activeTokens))
						})
				};
					...
					_1: _user$project$Indexer$suggestionsForImportReceivedCmd(
						{
							ctor: '_Tuple2',
							_0: _p73,
							_1: A4(_user$project$Indexer$suggestionsForImport, _p73, model.activeFile, model.fileContentsDict, model.packageDocs)
						})
				};
			default:
				var _p74 = _p62._0;
					...
					_1: _user$project$Indexer$canGoToDefinitionRepliedCmd(
						{
							ctor: '_Tuple2',
							_0: _p74,
							_1: A2(_elm_lang$core$Dict$member, _p74, model.activeTokens)
						})
				};
		}
	});
				...
				function (_p75) {
					...
					return A2(
						...
						A2(
							...
							_p76._1,
							_user$project$Indexer$toImportDict(_p76._2)));
				}),
