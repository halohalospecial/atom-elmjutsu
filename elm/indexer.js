...
var _user$project$Indexer$urlTo = F2(
	function (_p3, valueName) {
		var _p4 = _p3;
		var _p5 = _p4.packageUri;
		var uri = A2(_elm_lang$core$String$startsWith, _user$project$Indexer$packageDocsPrefix, _p5) ? A2(
			_elm_lang$core$Basics_ops['++'],
			_p5,
			_user$project$Indexer$dotToHyphen(_p4.name)) : _p5;
		return A2(
			_elm_lang$core$Basics_ops['++'],
			uri,
...
var _user$project$Indexer$activeHintsChangedCmd = _elm_lang$core$Native_Platform.outgoingPort(
	...
	function (v) {
		return _elm_lang$core$Native_List.toArray(v).map(
			function (v) {
				return {name: v.name, uri: v.uri, comment: v.comment, tipe: v.tipe};
			});
	});
...
var _user$project$Indexer$Hint = F4(
	function (a, b, c, d) {
		return {name: a, uri: b, comment: c, tipe: d};
	});
var _user$project$Indexer$nameToHints = F3(
	function (moduleDocs, _p7, _p6) {
		var _p8 = _p7;
		var _p9 = _p6;
		var _p10 = _p9.name;
		var localName = A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$Maybe$withDefault, moduleDocs.name, _p8.alias),
		...
		var hint = A4(
			...
			fullName,
			A2(_user$project$Indexer$urlTo, moduleDocs, _p10),
			_p9.comment,
			_p9.tipe);
		return A2(_user$project$Indexer$isExposed, _p10, _p8.exposed) ? _elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: _p10, _1: hint},
		...
		var addHints = F2(
			function (tag, hints) {
				...
				var hint = A4(
					_user$project$Indexer$Hint,
					fullName,
					A2(_user$project$Indexer$urlTo, moduleDocs, _p15),
					_p14.comment,
					_p14.tipe);
				return (A2(_elm_lang$core$List$member, _p15, _user$project$Indexer$defaultTypes) || A2(_user$project$Indexer$isExposed, tag, _p13.exposed)) ? A2(
					_elm_lang$core$List_ops['::'],
...
var _user$project$Indexer$filteredHints = F2(
	function (moduleDocs, importData) {
		var allValues = A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_elm_lang$core$List$map, _user$project$Indexer$tipeToValue, moduleDocs.values.types),
...
var _user$project$Indexer$getActiveSourceFile = F2(
	function (activeFilePath, sourceFileDict) {
		var _p21 = activeFilePath;
		if (_p21.ctor === 'Nothing') {
			return _user$project$Indexer$emptySourceFile;
		} else {
			var _p22 = A2(_elm_lang$core$Dict$get, _p21._0, sourceFileDict);
			if (_p22.ctor === 'Just') {
				return _p22._0;
			} else {
				return _user$project$Indexer$emptySourceFile;
		...
		switch (_p23.ctor) {
			...
			case 'DocsLoaded':
				...
				var missingPackageDocs = A2(
					...
					function (_p24) {
						var _p25 = _p24;
						return _elm_lang$core$Basics$not(
							A2(_elm_lang$core$List$member, _p25.packageUri, existingPackages));
					},
					_p23._0);
			...
			case 'CursorMove':
				if (_p23._0.ctor === 'Nothing') {
					...
					var updatedHints = A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[]),
						A2(_elm_lang$core$Dict$get, _p23._0._0, model.tokens));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							tokens: A3(
								_user$project$Indexer$toTokenDict,
								A2(_user$project$Indexer$getActiveSourceFile, _p26, model.sourceFileDict),
								model.sourceFileDict,
								model.packageDocs)
						}),
					_1: _user$project$Indexer$activeModuleNameChangedCmd(
						A2(_user$project$Indexer$activeFileModuleName, _p26, model.sourceFileDict))
				};
			case 'UpdateSourceFile':
				var updatedSourceFileDict = A3(
					...
					_p23._0,
					_elm_lang$core$Basics$always(
						_elm_lang$core$Maybe$Just(_p23._1)),
					model.sourceFileDict);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'UpdatePackageDocs':
				...
				var missingPackages = A2(
					...
					A2(_elm_lang$core$List$map, _user$project$Indexer$toPackageUri, _p23._0));
				return {
					ctor: '_Tuple2',
					_0: model,
						...
						return {
							...
							_1: _elm_lang$core$Platform_Cmd$batch(
								A2(
									_elm_lang$core$List$map,
									function (hint) {
										return _user$project$Indexer$goToDefinitionCmd(hint.uri);
									},
									hints))
						};
					}
				...
				function (_p28) {
					...
					return A2(
						...
						A2(
							...
							_p29._1,
							_user$project$Indexer$toImportDict(_p29._2)));
				}),
