...
var _user$project$Indexer$getImportersForToken = F4(
	function (maybeToken, maybeActiveFile, tokens, fileContentsDict) {
		var _p23 = {ctor: '_Tuple2', _0: maybeToken, _1: maybeActiveFile};
		if (((_p23.ctor === '_Tuple2') && (_p23._0.ctor === 'Just')) && (_p23._1.ctor === 'Just')) {
			var projectFileContents = A2(_user$project$Indexer$getProjectFileContents, _p23._1._0.projectDirectory, fileContentsDict);
			var hints = A2(_user$project$Indexer$getHintsForToken, maybeToken, tokens);
			return A2(
				...
				function (_p24) {
					...
					var getSourcePathAndLocalNames = function (hint) {
						...
						if (isHintAModule(hint) && (!_elm_lang$core$Native_Utils.eq(
							A2(_elm_lang$core$Dict$get, hint.name, _p30),
							_elm_lang$core$Maybe$Nothing))) {
							return _elm_lang$core$Maybe$Just(
								{
									ctor: '_Tuple2',
							...
							if (_p26.ctor === 'Nothing') {
								...
								return (isHintInThisModule || isHintThisModule) ? _elm_lang$core$Maybe$Just(
									{
										ctor: '_Tuple2',
										_0: _p31.sourcePath,
										_1: _elm_lang$core$Native_List.fromArray(
								...
								if (_p28.ctor === '[]') {
									...
									return _elm_lang$core$Maybe$Just(
										{ctor: '_Tuple2', _0: _p31.sourcePath, _1: names});
								}
							}
						}
					};
						...
						_1: _user$project$Indexer$importersForTokenReceivedCmd(
							{
								ctor: '_Tuple2',
								_0: _p85._0,
								_1: A4(_user$project$Indexer$getImportersForToken, _p72._0._1, model.activeFile, model.activeTokens, model.fileContentsDict)
							})
					};
				}
		}
