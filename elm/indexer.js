...
var _user$project$Indexer$nameToHints = F4(
	function (moduleDocs, _p8, kind, _p7) {
		...
		var _p10 = _p7;
		var _p11 = _p10.name;
		var localName = A3(_user$project$Indexer$getLocalName, moduleDocs.name, _p9.alias, _p11);
		var hint = {
			name: _p11,
...
var _user$project$Indexer$getSuggestionsForImport = F4(
	function (partial, maybeActiveFile, fileContentsDict, packageDocs) {
		...
		if (_p15.ctor === 'Nothing') {
			...
			var suggestions = A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_user$project$Indexer$getProjectModuleDocs, _p15._0.projectDirectory, fileContentsDict),
					packageDocs));
			return A2(
	...
	function (token, isCursorAtLastPartOfToken, maybeActiveFile, tokens, activeFileContents, fileContentsDict) {
		...
		if (_p23.ctor === 'Just') {
			...
			if (isImportAlias) {
				...
				var projectFileContents = A2(_user$project$Indexer$getProjectFileContents, _p23._0.projectDirectory, fileContentsDict);
				var hints = A2(
...
var _user$project$Indexer$moduleToHints = F2(
	function (_p33, _p32) {
		...
		var _p37 = _p34.name;
		var _p35 = _p32;
		var hint = {name: _p37, moduleName: '', sourcePath: _p34.sourcePath, comment: _p34.comment, tipe: '', caseTipe: _elm_lang$core$Maybe$Nothing, kind: _user$project$Indexer$KindModule};
		var _p36 = _p35.alias;
		if (_p36.ctor === 'Nothing') {
			return _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: _p37, _1: hint}
				]);
		} else {
			return _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: _p37, _1: hint},
					{ctor: '_Tuple2', _0: _p36._0, _1: hint}
				]);
		}
	});
var _user$project$Indexer$KindTypeCase = {ctor: 'KindTypeCase'};
var _user$project$Indexer$unionTagsToHints = F3(
	function (moduleDocs, _p39, _p38) {
		var _p40 = _p39;
		var _p41 = _p38;
		var _p42 = _p41.name;
		var addHints = F2(
			function (tag, hints) {
				var localName = A3(_user$project$Indexer$getLocalName, moduleDocs.name, _p40.alias, tag);
				var hint = {
					name: tag,
					moduleName: moduleDocs.name,
					sourcePath: A2(_user$project$Indexer$formatSourcePath, moduleDocs, _p42),
					comment: _p41.comment,
					tipe: _p41.tipe,
					caseTipe: _elm_lang$core$Maybe$Just(_p42),
				...
				return (A2(_elm_lang$core$Set$member, _p42, _user$project$Indexer$defaultTypes) || A2(_user$project$Indexer$isExposed, tag, _p40.exposed)) ? A2(
					_elm_lang$core$List_ops['::'],
...
var _user$project$Indexer$getProjectSymbols = F2(
	function (projectDirectory, fileContentsDict) {
		var allFileSymbols = A2(
			...
			function (_p43) {
				var _p44 = _p43;
				var _p46 = _p44.moduleDocs;
				var _p45 = _p46;
				var sourcePath = _p45.sourcePath;
				var values = _p45.values;
				var moduleDocsSymbol = {fullName: _p46.name, sourcePath: sourcePath, caseTipe: _elm_lang$core$Maybe$Nothing, kind: _user$project$Indexer$KindModule};
				var valueSymbols = A2(
					_elm_lang$core$List$map,
					function (value) {
						...
						return {
							...
							sourcePath: A2(_user$project$Indexer$formatSourcePath, _p46, value.name),
							caseTipe: _elm_lang$core$Maybe$Nothing,
							kind: kind
						};
					},
				...
				var tipeSymbols = A2(
					...
					function (tipe) {
						return {
							...
							sourcePath: A2(_user$project$Indexer$formatSourcePath, _p46, tipe.name),
							caseTipe: _elm_lang$core$Maybe$Nothing,
						...
						return A2(
							...
							function (caseName) {
								return {
									...
									sourcePath: A2(_user$project$Indexer$formatSourcePath, _p46, caseName),
		...
		return A2(
			...
			function (_p47) {
				var _p48 = _p47;
				var _p49 = _p48.sourcePath;
				return _elm_lang$core$Basics$not(
					A2(_elm_lang$core$String$startsWith, _user$project$Indexer$packageDocsPrefix, _p49)) && A2(_user$project$Indexer$isSourcePathInProjectDirectory, projectDirectory, _p49);
			},
			allFileSymbols);
	});
...
var _user$project$Indexer$toImport = function (_p50) {
	var _p51 = _p50;
	var exposedSet = function () {
		var _p52 = _p51.exposed;
		if (_p52.ctor === 'Nothing') {
			return _user$project$Indexer$None;
		} else {
			if (((_p52._0.ctor === '::') && (_p52._0._0 === '..')) && (_p52._0._1.ctor === '[]')) {
				return _user$project$Indexer$All;
			} else {
				return _user$project$Indexer$Some(
					_elm_lang$core$Set$fromList(_p52._0));
			}
		}
	}();
	return {
		ctor: '_Tuple2',
		_0: _p51.name,
		_1: A2(_user$project$Indexer$Import, _p51.alias, exposedSet)
	};
};
...
var _user$project$Indexer$getActiveFileContents = F2(
	function (maybeActiveFile, fileContentsDict) {
		...
		if (_p53.ctor === 'Nothing') {
			...
			var _p54 = A2(_elm_lang$core$Dict$get, _p53._0.filePath, fileContentsDict);
			if (_p54.ctor === 'Just') {
				return _p54._0;
			} else {
				return _user$project$Indexer$emptyFileContents;
		...
		if (_p55.ctor === 'Nothing') {
			...
			var importedModuleDocs = A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					packageDocs,
					A2(_user$project$Indexer$getProjectModuleDocs, _p55._0.projectDirectory, fileContentsDict)));
				...
				A2(
					...
					function (moduleDocs) {
						var exposed = function () {
							var _p56 = A2(_elm_lang$core$Dict$get, moduleDocs.name, importsPlusActiveModule);
							if (_p56.ctor === 'Nothing') {
								return _user$project$Indexer$None;
							} else {
								return _p56._0.exposed;
							}
						}();
						return A2(
							_elm_lang$core$List$map,
							...
							A2(
								...
								A2(
									...
									A2(
										...
										function (_p57) {
											var _p58 = _p57;
											return A2(_user$project$Indexer$isExposed, _p58.name, exposed);
										},
										A2(
											_elm_lang$core$Basics_ops['++'],
											moduleDocs.values.aliases,
								...
								A2(
									...
									function (_p59) {
										...
										return A2(
											_elm_lang$core$List$filter,
											function (kase) {
												return A2(_elm_lang$core$Set$member, _p60.name, _user$project$Indexer$defaultTypes) || A2(_user$project$Indexer$isExposed, kase, exposed);
											},
											_p60.cases);
									},
									moduleDocs.values.tipes)));
...
var _user$project$Indexer$getHintsForPartial = F5(
	function (partial, activeFile, fileContentsDict, packageDocs, tokens) {
		var defaultHints = A2(
			...
			function (_p61) {
				var _p62 = _p61;
				return A2(_elm_lang$core$String$startsWith, partial, _p62.name);
			},
		...
		var importAliases = A2(
			...
			function (_p63) {
				...
				if (_p65.ctor === 'Nothing') {
					...
					var _p66 = _p65._0;
					return A2(_elm_lang$core$String$startsWith, partial, _p66) ? _elm_lang$core$Maybe$Just(
						_elm_lang$core$Native_Utils.update(
							_user$project$Indexer$emptyHint,
							{name: _p66})) : _elm_lang$core$Maybe$Nothing;
				}
			},
			_elm_lang$core$Dict$values(activeFileContents.imports));
		var exposedSet = A3(_user$project$Indexer$getExposedHints, activeFile, fileContentsDict, packageDocs);
					...
					if (_elm_lang$core$Native_Utils.eq(hint.moduleName, '')) {
						...
						if (A2(
							...
							var moduleNamePrefix = function () {
								var _p67 = A2(_elm_lang$core$Dict$get, hint.moduleName, activeFileContents.imports);
								if (_p67.ctor === 'Nothing') {
									return '';
								} else {
									var _p68 = _p67._0.alias;
									if (_p68.ctor === 'Nothing') {
										return A2(_elm_lang$core$Basics_ops['++'], hint.moduleName, '.');
									} else {
										return A2(_elm_lang$core$Basics_ops['++'], _p68._0, '.');
									}
								}
							}();
...
var _user$project$Indexer$toTokenDict = F3(
	function (maybeActiveFile, fileContentsDict, packageDocsList) {
				...
				_elm_lang$core$List$concat(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							packageDocsList,
							A2(_user$project$Indexer$getProjectModuleDocs, _p69._0.projectDirectory, fileContentsDict)))));
		}
	});
var _user$project$Indexer$update = F2(
	function (msg, model) {
		...
		switch (_p72.ctor) {
			...
			case 'DocsLoaded':
				var truncateComment = function (moduleDocs) {
					var truncatedComment = function () {
						var _p73 = _elm_lang$core$List$head(
				...
				var missingPackageDocs = A2(
					...
					function (_p74) {
						var _p75 = _p74;
						return _elm_lang$core$Basics$not(
							A2(_elm_lang$core$List$member, _p75.sourcePath, existingPackages));
					},
					_p72._0);
			...
			case 'CursorMove':
				var updatedActiveHints = A2(_user$project$Indexer$getHintsForToken, _p72._0, model.activeTokens);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'UpdateActiveFile':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							activeFile: _p76,
							activeTokens: A3(_user$project$Indexer$toTokenDict, _p76, model.fileContentsDict, model.packageDocs)
						}),
					_1: _user$project$Indexer$activeFileChangedCmd(_p76)
				};
			case 'UpdateFileContents':
				var updatedFileContentsDict = A3(
					...
					_p72._0,
					_elm_lang$core$Basics$always(
						_elm_lang$core$Maybe$Just(_p72._1)),
			...
			case 'RemoveFileContents':
				var updatedFileContentsDict = A2(_elm_lang$core$Dict$remove, _p72._0, model.fileContentsDict);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'UpdatePackageDocs':
				...
				var missingPackages = A2(
					...
					A2(_elm_lang$core$List$map, _user$project$Indexer$toPackageUri, _p72._0));
				return {
					ctor: '_Tuple2',
					_0: model,
			...
			case 'GoToDefinition':
				var requests = A2(
					...
					A2(_user$project$Indexer$getHintsForToken, _p72._0, model.activeTokens));
				return {
					ctor: '_Tuple2',
					_0: model,
			...
			case 'GoToSymbol':
				...
				if (_p77.ctor === 'Nothing') {
					...
					var hints = A2(_user$project$Indexer$getHintsForToken, _p81, model.activeTokens);
						...
						_1: _user$project$Indexer$goToSymbolCmd(
							{
								...
								_2: A2(
									...
									A2(_user$project$Indexer$getProjectSymbols, _p77._0, model.fileContentsDict))
							})
					};
				}
					...
					_1: _user$project$Indexer$hintsForPartialReceivedCmd(
						{
							...
							_1: A2(
								...
								A5(_user$project$Indexer$getHintsForPartial, _p82, model.activeFile, model.fileContentsDict, model.packageDocs, model.activeTokens))
						})
				};
					...
					_1: _user$project$Indexer$suggestionsForImportReceivedCmd(
						{
							ctor: '_Tuple2',
							_0: _p83,
							_1: A4(_user$project$Indexer$getSuggestionsForImport, _p83, model.activeFile, model.fileContentsDict, model.packageDocs)
						})
				};
					...
					_1: _user$project$Indexer$canGoToDefinitionRepliedCmd(
						{
							ctor: '_Tuple2',
							_0: _p84,
							_1: A2(_elm_lang$core$Dict$member, _p84, model.activeTokens)
						})
				};
			default:
				var _p85 = {ctor: '_Tuple3', _0: _p72._0._0, _1: _p72._0._1, _2: _p72._0._2};
				if ((((_p85.ctor === '_Tuple3') && (_p85._0.ctor === 'Just')) && (_p85._1.ctor === 'Just')) && (_p85._2.ctor === 'Just')) {
					var _p88 = _p85._1._0;
					var _p87 = _p85._2._0;
					var activeFileContents = A2(_user$project$Indexer$getActiveFileContents, model.activeFile, model.fileContentsDict);
					var _p86 = _elm_lang$core$Native_Utils.eq(_p88, activeFileContents.moduleDocs.name) ? {ctor: '_Tuple2', _0: _p88, _1: true} : ((!_elm_lang$core$Native_Utils.eq(
						A2(_elm_lang$core$Dict$get, _p88, activeFileContents.imports),
						_elm_lang$core$Maybe$Nothing)) ? {ctor: '_Tuple2', _0: _p88, _1: true} : (_p87 ? {ctor: '_Tuple2', _0: _p88, _1: false} : {
						ctor: '_Tuple2',
						_0: _user$project$Indexer$getModuleName(_p88),
						_1: false
					}));
					var token = _p86._0;
					var willUseFullToken = _p86._1;
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Indexer$importersForTokenReceivedCmd(
							{
								...
								_2: willUseFullToken,
								_3: _p87,
								_4: A6(_user$project$Indexer$getImportersForToken, token, _p87, model.activeFile, model.activeTokens, activeFileContents, model.fileContentsDict)
							})
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				...
				function (_p89) {
					...
					return A2(
						...
						A2(
							...
							_p90._1,
							_user$project$Indexer$toImportDict(_p90._2)));
				}),
