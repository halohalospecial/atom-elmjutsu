		...
		return [
			...
			function (v) {
				return {
					fullName: v.fullName,
					uri: v.uri,
					caseOf: (v.caseOf.ctor === 'Nothing') ? null : v.caseOf._0
				};
			})
		];
	});
...
var _user$project$Indexer$Symbol = F3(
	function (a, b, c) {
		return {fullName: a, uri: b, caseOf: c};
	});
...
var _user$project$Indexer$nameToHints = F3(
	function (moduleDocs, _p8, _p7) {
		...
		var hint = A4(
			...
			fullName,
			A2(_user$project$Indexer$urlTo, moduleDocs, _p11),
			_p10.comment,
			_p10.tipe);
		...
		var addHints = F2(
			function (tag, hints) {
				...
				var hint = A4(
					_user$project$Indexer$Hint,
					fullName,
					A2(_user$project$Indexer$urlTo, moduleDocs, _p16),
					_p15.comment,
					_p15.tipe);
			...
			case 'DocsLoaded':
				...
				var missingPackageDocs = A2(
					...
					function (_p25) {
						var _p26 = _p25;
						return _elm_lang$core$Basics$not(
							A2(_elm_lang$core$List$member, _p26.packageUri, existingPackages));
					},
					_p24._0);
							...
							var valueSymbols = A2(
								...
								function (value) {
									return A3(
										...
										A2(_user$project$Indexer$urlTo, _p33, value.name),
										_elm_lang$core$Maybe$Nothing);
								},
								values.values);
							var tipeSymbols = A2(
								...
								function (tipe) {
									return A3(
										...
										A2(_user$project$Indexer$urlTo, _p33, tipe.name),
										_elm_lang$core$Maybe$Nothing);
								},
								values.types);
									...
									return A2(
										...
										function (caseName) {
											return A3(
												...
												A2(_user$project$Indexer$urlTo, _p33, caseName),
