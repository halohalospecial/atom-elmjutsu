...
var _user$project$FindUsages$usageView = function (_p0) {
	var _p1 = _p0;
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(_p1.lineText)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
...
var _user$project$FindUsages$view = function (_p2) {
	var _p3 = _p2;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
...
var _user$project$FindUsages$emptyModel = {
	usages: _elm_lang$core$Native_List.fromArray(
		[
			{
			sourcePath: '~/test.elm',
			lineText: 'foo + foo',
...
var _user$project$FindUsages$Model = function (a) {
	return {usages: a};
};
...
var _user$project$FindUsages$NoOp = {ctor: 'NoOp'};
