...
var _user$project$Usages$emptyModel = {usages: _elm_lang$core$Array$empty, token: '', projectDirectory: '', selectedIndex: 0, willShowRenamePanel: false};
										...
										A2(
											...
											function (sourcePath) {
												return A2(
													...
													A2(_elm_lang$core$Json_Decode$field, 'lineText', _elm_lang$core$Json_Decode$string));
											},
...
var _user$project$Usages$selectDelta = F2(
	function (delta, model) {
		var updatedSelectedIndex = A2(_user$project$Usages$normalizeIndex, model.selectedIndex + delta, model.usages);
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{selectedIndex: updatedSelectedIndex}),
			_1: (!_elm_lang$core$Native_Utils.eq(model.selectedIndex, updatedSelectedIndex)) ? A2(_user$project$Usages$maybeViewInEditor, updatedSelectedIndex, model.usages) : _elm_lang$core$Platform_Cmd$none
		};
	});
...
var _user$project$Usages$usageView = F5(
	function (projectDirectory, selectedIndex, willShowRenamePanel, index, usage) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(listItemClass),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$Basics_ops['++'],
...
var _user$project$Usages$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Usages$setContentsSub(_user$project$Usages$SetContents),
			_1: {
				ctor: '::',
...
var _user$project$Usages$main = _elm_lang$html$Html$program(
...
if (typeof _user$project$Usages$main !== 'undefined') {
    _user$project$Usages$main(Elm['Usages'], 'Usages', undefined);
}
